 ...
 */
class UpdateUserAccessRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'updateUserAccessRequest';
    ...
    protected static $setters = [
        'users_accesses' => 'setUsersAccesses'
    ];
    ...
    protected static $getters = [
        'users_accesses' => 'getUsersAccesses'
    ];
    ...
    {
        $this->setIfExists('users_accesses', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['users_accesses'] === null) {
            $invalidProperties[] = "'users_accesses' can't be null";
        }
    ...
    {
        return $this->container['users_accesses'];
    }
     ...
     * @return self
     */
    public function setUsersAccesses($users_accesses)
    {
        if (is_null($users_accesses)) {
            throw new \InvalidArgumentException('non-nullable users_accesses cannot be null');
        }
        $this->container['users_accesses'] = $users_accesses;
