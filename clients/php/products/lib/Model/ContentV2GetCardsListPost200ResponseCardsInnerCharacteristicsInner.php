...
/**
 * ContentV2GetCardsListPost200ResponseCardsInnerCharacteristicsInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Products
 * @author   OpenAPI Generator team
 ...
 */
class ContentV2GetCardsListPost200ResponseCardsInnerCharacteristicsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_content_v2_get_cards_list_post_200_response_cards_inner_characteristics_inner';
     ...
     * Sets id
     *
     * @param int|null $id ID характеристики
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param mixed|null $value Значение характеристики. Тип значения зависит от типа характеристики
     *
     * @return self
     */
