...
class ContentV2CardsUploadPostRequestInnerVariantsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets description
     *
     * @param string|null $description Описание товара.<br> Максимальное количество символов зависит от категории товара<br> Стандарт — 2000, минимум — 1000, максимум — 5000<br> Подробно о правилах описания в **Правилах заполнения карточки товара** в разделе в [Справочном центре](https://seller.wildberries.ru/help-center/article/A-113) на портале продавцов
     *
     * @return self
     */
    ...
    public function setVendorCode($vendor_code)
    {
        ...
        if ((mb_strlen($vendor_code) > 72)) {
            throw new \InvalidArgumentException('invalid length for $vendor_code when calling ContentV2CardsUploadPostRequestInnerVariantsInner., must be smaller than or equal to 72.');
        }
     ...
     * Gets dimensions
     *
     * @return \Wildberries\Sdk\Products\Model\ContentV2CardsUploadPostRequestInnerVariantsInnerDimensions|null
     */
     ...
     * Sets dimensions
     *
     * @param \Wildberries\Sdk\Products\Model\ContentV2CardsUploadPostRequestInnerVariantsInnerDimensions|null $dimensions dimensions
     *
     * @return self
     */
