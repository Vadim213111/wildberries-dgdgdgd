 ...
 */
class ClubDiscReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ClubDiscReq';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['club_discount'] === null) {
            $invalidProperties[] = "'club_discount' can't be null";
        }
     ...
     * Sets club_discount
     *
     * @param int $club_discount Скидка WB Клуба, %
     *
     * @return self
     */
