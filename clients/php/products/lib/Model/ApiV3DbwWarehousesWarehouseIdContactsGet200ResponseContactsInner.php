...
/**
 * ApiV3DbwWarehousesWarehouseIdContactsGet200ResponseContactsInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Products
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3DbwWarehousesWarehouseIdContactsGet200ResponseContactsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_dbw_warehouses__warehouseId__contacts_get_200_response_contacts_inner';
    ...
    public function setComment($comment)
    {
        ...
        if ((mb_strlen($comment) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling ApiV3DbwWarehousesWarehouseIdContactsGet200ResponseContactsInner., must be smaller than or equal to 1000.');
        }
