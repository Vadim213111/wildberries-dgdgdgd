...
/**
 * SwaggerPublicErrorsCursorInput Class Doc Comment
 *
 * @category Class
 ...
 */
class SwaggerPublicErrorsCursorInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'swagger.PublicErrorsCursorInput';
     ...
     * Sets limit
     *
     * @param float|null $limit Количество пакетов в ответе
     *
     * @return self
     */
    public function setLimit($limit)
    {
        ...
        if (($limit > 100)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling SwaggerPublicErrorsCursorInput., must be smaller than or equal to 100.');
        }
     ...
     * Sets batch_uuid
     *
     * @param string|null $batch_uuid ID последнего пакета в ответе на предыдущий запрос
     *
     * @return self
     */
