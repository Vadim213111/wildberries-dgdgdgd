 ...
 */
class ApiV2BufferGoodsTaskGet200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v2_buffer_goods_task_get_200_response_data';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('buffer_goods', $data ?? [], null);
    }
    ...
    {
        return $this->container['buffer_goods'];
    }
     ...
     * @return self
     */
    public function setBufferGoods($buffer_goods)
    {
        if (is_null($buffer_goods)) {
            array_push($this->openAPINullablesSetToNull, 'buffer_goods');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('buffer_goods', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['buffer_goods'] = $buffer_goods;
