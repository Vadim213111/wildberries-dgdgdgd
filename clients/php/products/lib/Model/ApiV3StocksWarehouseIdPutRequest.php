...
/**
 * ApiV3StocksWarehouseIdPutRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Products
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3StocksWarehouseIdPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_stocks__warehouseId__put_request';
    ...
    protected static $openAPITypes = [
        'stocks' => '\Wildberries\Sdk\Products\Model\ApiV3StocksWarehouseIdPutRequestStocksInner[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['stocks']) > 1000)) {
            $invalidProperties[] = "invalid value for 'stocks', number of items must be less than or equal to 1000.";
        }

        if ((count($this->container['stocks']) < 1)) {
            $invalidProperties[] = "invalid value for 'stocks', number of items must be greater than or equal to 1.";
        }
     ...
     * Gets stocks
     *
     * @return \Wildberries\Sdk\Products\Model\ApiV3StocksWarehouseIdPutRequestStocksInner[]
     */
    ...
    public function setStocks($stocks)
    {
        ...
        if ((count($stocks) < 1)) {
            throw new \InvalidArgumentException('invalid length for $stocks when calling ApiV3StocksWarehouseIdPutRequest., number of items must be greater than or equal to 1.');
        }
