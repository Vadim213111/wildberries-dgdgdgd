 ...
 */
class StoreContactRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'StoreContactRequestBody';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['contacts']) && (count($this->container['contacts']) > 5)) {
            $invalidProperties[] = "invalid value for 'contacts', number of items must be less than or equal to 5.";
        }
