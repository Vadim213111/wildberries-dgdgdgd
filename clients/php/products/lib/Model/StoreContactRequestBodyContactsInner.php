...
/**
 * StoreContactRequestBodyContactsInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Products
 * @author   OpenAPI Generator team
 ...
 */
class StoreContactRequestBodyContactsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'StoreContactRequestBody_contacts_inner';
    ...
    public function setComment($comment)
    {
        ...
        if ((mb_strlen($comment) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling StoreContactRequestBodyContactsInner., must be smaller than or equal to 1000.');
        }
     ...
     * Sets phone
     *
     * @param string|null $phone Номер телефона.<br>Поддерживаются коды стран:   - `+7` — Россия, Казахстан   - `+374` — Армения   - `+375` — Беларусь   - `+996` — Кыргызстан
     *
     * @return self
     */
