...
/**
 * ContentV3MediaSavePostRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Products
 * @author   OpenAPI Generator team
 ...
 */
class ContentV3MediaSavePostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_content_v3_media_save_post_request';
     ...
     * Sets data
     *
     * @param string[]|null $data Ссылки на изображения в том порядке, в котором они будут в карточке товара, и на видео, на любой позиции массива
     *
     * @return self
     */
