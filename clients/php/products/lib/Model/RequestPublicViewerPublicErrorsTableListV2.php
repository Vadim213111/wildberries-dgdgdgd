 ...
 */
class RequestPublicViewerPublicErrorsTableListV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'requestPublicViewerPublicErrorsTableListV2';
