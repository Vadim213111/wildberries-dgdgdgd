...
/**
 * ContentV2CardsUploadAddPostRequestCardsToAddInnerSizesInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Products
 * @author   OpenAPI Generator team
 ...
 */
class ContentV2CardsUploadAddPostRequestCardsToAddInnerSizesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_content_v2_cards_upload_add_post_request_cardsToAdd_inner_sizes_inner';
     ...
     * Sets skus
     *
     * @param string[]|null $skus Баркод. Если не указать, сгенерируется автоматически
     *
     * @return self
     */
