...
/**
 * ContentV2BarcodesPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Products
 * @author   OpenAPI Generator team
 ...
 */
class ContentV2BarcodesPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_content_v2_barcodes_post_request';
     ...
     * Sets count
     *
     * @param int|null $count Кол-во баркодов которые надо сгенерировать, максимальное доступное количество баркодов для генерации - `5 000`
     *
     * @return self
     */
