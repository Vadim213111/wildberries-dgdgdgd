...
/**
 * GoodBufferHistory Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Products
 * @author   OpenAPI Generator team
 ...
 */
class GoodBufferHistory implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GoodBufferHistory';
     ...
     * Sets status
     *
     * @param int|null $status Статус товара: `1` — в обработке
     *
     * @return self
     */
