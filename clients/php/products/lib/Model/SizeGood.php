 ...
 */
class SizeGood implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SizeGood';
     ...
     * Sets size_id
     *
     * @param int|null $size_id ID размера. Можно получить с помощью метода [Получение списка товаров по артикулам](./work-with-products#tag/Ceny-i-skidki/paths/~1api~1v2~1list~1goods~1filter/get), поле `sizeID`. В методах Контента это поле `chrtID`
     *
     * @return self
     */
     ...
     *
     * @param float|null $discounted_price Цена со скидкой
     *
     * @return self
     */
     ...
     *
     * @param float|null $club_discounted_price Цена со скидкой, включая скидку WB Клуба
     *
     * @return self
     */
     ...
     * Sets tech_size_name
     *
     * @param string|null $tech_size_name Размер товара
     *
     * @return self
     */
