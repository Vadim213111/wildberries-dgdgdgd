...
/**
 * ContentV2CardsUpdatePostRequestInnerSizesInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Products
 * @author   OpenAPI Generator team
 ...
 */
class ContentV2CardsUpdatePostRequestInnerSizesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_content_v2_cards_update_post_request_inner_sizes_inner';
     ...
     * Sets chrt_id
     *
     * @param int|null $chrt_id ID размера для данного артикула WB<br> Обязателен к заполнению для существующих размеров<br> Для добавляемых размеров не указывается
     *
     * @return self
     */
     ...
     * Sets tech_size
     *
     * @param string|null $tech_size Размер товара (например, XL, S, 45)
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param int|null $price Цена товара, ₽<br> Указывается при добавлении размера
     *
     * @return self
     */
     ...
     * Sets skus
     *
     * @param string[]|null $skus Баркоды
     *
     * @return self
     */
