...
/**
 * ContentV2GetCardsListPost200ResponseCardsInnerTagsInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Products
 * @author   OpenAPI Generator team
 ...
 */
class ContentV2GetCardsListPost200ResponseCardsInnerTagsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_content_v2_get_cards_list_post_200_response_cards_inner_tags_inner';
     ...
     * Sets color
     *
     * @param string|null $color Цвет ярлыка. <br> Доступные цвета: - `D1CFD7` — серый - `FEE0E0` — красный - `ECDAFF` — фиолетовый - `E4EAFF` — синий - `DEF1DD` — зеленый - `FFECC7` — желтый
     *
     * @return self
     */
