...
/**
 * SwaggerPublicErrorsOrderV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class SwaggerPublicErrorsOrderV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'swagger.PublicErrorsOrderV2';
    ...
    {
        $this->setIfExists('ascending', $data ?? [], true);
    }
     ...
     * Sets ascending
     *
     * @param bool|null $ascending - `false` — сортировка по убыванию - `true` — сортировка по возрастанию
     *
     * @return self
     */
