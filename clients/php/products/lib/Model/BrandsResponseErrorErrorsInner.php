...
/**
 * BrandsResponseErrorErrorsInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Products
 * @author   OpenAPI Generator team
 ...
 */
class BrandsResponseErrorErrorsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BrandsResponseError_errors_inner';
     ...
     * Sets location
     *
     * @param string|null $location Параметр, где произошла ошибка
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param mixed|null $value Значение параметра, где произошла ошибка
     *
     * @return self
     */
