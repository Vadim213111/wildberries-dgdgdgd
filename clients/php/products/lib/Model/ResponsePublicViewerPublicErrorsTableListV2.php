 ...
 */
class ResponsePublicViewerPublicErrorsTableListV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'responsePublicViewerPublicErrorsTableListV2';
