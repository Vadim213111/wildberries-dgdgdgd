...
/**
 * ApiV2ListGoodsFilterGet200ResponseData Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiV2ListGoodsFilterGet200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v2_list_goods_filter_get_200_response_data';
    ...
    protected static $openAPITypes = [
        'list_goods' => '\Wildberries\Sdk\Products\Model\GoodsList[]'
    ];
    ...
    {
        $this->setIfExists('list_goods', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['list_goods'] === null) {
            $invalidProperties[] = "'list_goods' can't be null";
        }
     ...
     * Gets list_goods
     *
     * @return \Wildberries\Sdk\Products\Model\GoodsList[]
     */
    public function getListGoods()
    {
        return $this->container['list_goods'];
    }

    /**
     * Sets list_goods
     *
     * @param \Wildberries\Sdk\Products\Model\GoodsList[] $list_goods Информация о товарах
     *
     * @return self
     */
    public function setListGoods($list_goods)
    {
        if (is_null($list_goods)) {
            throw new \InvalidArgumentException('non-nullable list_goods cannot be null');
        }
        $this->container['list_goods'] = $list_goods;
