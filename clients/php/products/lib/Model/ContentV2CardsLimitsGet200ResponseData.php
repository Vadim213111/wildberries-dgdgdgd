...
/**
 * ContentV2CardsLimitsGet200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Products
 * @author   OpenAPI Generator team
 ...
 */
class ContentV2CardsLimitsGet200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_content_v2_cards_limits_get_200_response_data';
    ...
    protected static $setters = [
        'free_limits' => 'setFreeLimits',
        'paid_limits' => 'setPaidLimits'
    ];
    ...
    protected static $getters = [
        'free_limits' => 'getFreeLimits',
        'paid_limits' => 'getPaidLimits'
    ];
    ...
    {
        $this->setIfExists('free_limits', $data ?? [], null);
        $this->setIfExists('paid_limits', $data ?? [], null);
    }
    ...
    {
        return $this->container['free_limits'];
    }

    /**
     * Sets free_limits
     *
     * @param int|null $free_limits Количество бесплатных лимитов
     *
     * @return self
     */
    public function setFreeLimits($free_limits)
    {
        if (is_null($free_limits)) {
            throw new \InvalidArgumentException('non-nullable free_limits cannot be null');
        }
        $this->container['free_limits'] = $free_limits;
     ...
     * @return int|null
     */
    public function getPaidLimits()
    {
        return $this->container['paid_limits'];
    }

    /**
     * Sets paid_limits
     *
     * @param int|null $paid_limits Количество оплаченных лимитов
     *
     * @return self
     */
    public function setPaidLimits($paid_limits)
    {
        if (is_null($paid_limits)) {
            throw new \InvalidArgumentException('non-nullable paid_limits cannot be null');
        }
        $this->container['paid_limits'] = $paid_limits;
