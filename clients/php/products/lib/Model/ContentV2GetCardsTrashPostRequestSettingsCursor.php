...
/**
 * ContentV2GetCardsTrashPostRequestSettingsCursor Class Doc Comment
 *
 * @category Class
 ...
 */
class ContentV2GetCardsTrashPostRequestSettingsCursor implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_content_v2_get_cards_trash_post_request_settings_cursor';
     ...
     * Sets limit
     *
     * @param int|null $limit Сколько карточек товаров выдать в ответе
     *
     * @return self
     */
     ...
     * Sets trashed_at
     *
     * @param string|null $trashed_at Дата и время помещения в корзину
     *
     * @return self
     */
