 ...
 */
class ContentV2CardsUploadAddPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_content_v2_cards_upload_add_post_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('cards_to_add', $data ?? [], null);
    }
     ...
     * Sets imt_id
     *
     * @param int|null $imt_id `imtID` отдельной карточки товара или группы [объединённых](https://dev.wildberries.ru/knowledge-base/articles/019d49a4-1320-71bb-9dac-8ba07e7177ce/rabota-s-tovarami#obuedinenie-i-razuedinenie-kartochek-tovarov) карточек товаров, к которой присоединяются создаваемые карточки
     *
     * @return self
     */
    ...
    {
        return $this->container['cards_to_add'];
    }
     ...
     * @return self
     */
    public function setCardsToAdd($cards_to_add)
    {
        if (is_null($cards_to_add)) {
            throw new \InvalidArgumentException('non-nullable cards_to_add cannot be null');
        }
        $this->container['cards_to_add'] = $cards_to_add;
