...
/**
 * ContentV2GetCardsListPost200ResponseCursor Class Doc Comment
 *
 * @category Class
 ...
 */
class ContentV2GetCardsListPost200ResponseCursor implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_content_v2_get_cards_list_post_200_response_cursor';
     ...
     * Sets updated_at
     *
     * @param string|null $updated_at Дата и время, с которых надо запрашивать следующий список карточек товаров
     *
     * @return self
     */
