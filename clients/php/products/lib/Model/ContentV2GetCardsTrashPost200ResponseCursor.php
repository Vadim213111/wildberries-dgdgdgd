...
/**
 * ContentV2GetCardsTrashPost200ResponseCursor Class Doc Comment
 *
 * @category Class
 ...
 */
class ContentV2GetCardsTrashPost200ResponseCursor implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_content_v2_get_cards_trash_post_200_response_cursor';
    ...
    {
        return $this->container['trashed_at'];
    }

    /**
     * Sets trashed_at
     *
     * @param string|null $trashed_at Дата и время, с которых надо запрашивать следующий список карточек товаров
     *
     * @return self
     */
    public function setTrashedAt($trashed_at)
    {
        if (is_null($trashed_at)) {
            throw new \InvalidArgumentException('non-nullable trashed_at cannot be null');
        }
        $this->container['trashed_at'] = $trashed_at;
     ...
     * Sets nm_id
     *
     * @param int|null $nm_id Артикул WB, с которого надо запрашивать следующий список карточек товаров
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int|null $total Количество возвращённых карточек товаров
     *
     * @return self
     */
