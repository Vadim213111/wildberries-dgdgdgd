...
/**
 * RequestAlreadyExistsErrorData Class Doc Comment
 *
 * @category Class
 ...
 */
class RequestAlreadyExistsErrorData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RequestAlreadyExistsError_data';
     ...
     * Sets already_exists
     *
     * @param bool|null $already_exists Флаг дублирования загрузки: `true` — такая загрузка уже есть
     *
     * @return self
     */
