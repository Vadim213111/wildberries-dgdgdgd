...
/**
 * ApiV2QuarantineGoodsGet200ResponseData Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiV2QuarantineGoodsGet200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v2_quarantine_goods_get_200_response_data';
    ...
    protected static $openAPITypes = [
        'quarantine_goods' => '\Wildberries\Sdk\Products\Model\QuarantineGoods[]'
    ];
    ...
    protected static $setters = [
        'quarantine_goods' => 'setQuarantineGoods'
    ];
    ...
    protected static $getters = [
        'quarantine_goods' => 'getQuarantineGoods'
    ];
    ...
    {
        $this->setIfExists('quarantine_goods', $data ?? [], null);
    }
    ...
    /**
     * Gets quarantine_goods
     *
     * @return \Wildberries\Sdk\Products\Model\QuarantineGoods[]|null
     */
    public function getQuarantineGoods()
    {
        return $this->container['quarantine_goods'];
    }

    /**
     * Sets quarantine_goods
     *
     * @param \Wildberries\Sdk\Products\Model\QuarantineGoods[]|null $quarantine_goods Информация о товарах в карантине
     *
     * @return self
     */
    public function setQuarantineGoods($quarantine_goods)
    {
        if (is_null($quarantine_goods)) {
            throw new \InvalidArgumentException('non-nullable quarantine_goods cannot be null');
        }
        $this->container['quarantine_goods'] = $quarantine_goods;
