...
/**
 * ApiV3StocksWarehouseIdPutRequestStocksInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Products
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3StocksWarehouseIdPutRequestStocksInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_stocks__warehouseId__put_request_stocks_inner';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['amount']) && ($this->container['amount'] > 100000)) {
            $invalidProperties[] = "invalid value for 'amount', must be smaller than or equal to 100000.";
        }
