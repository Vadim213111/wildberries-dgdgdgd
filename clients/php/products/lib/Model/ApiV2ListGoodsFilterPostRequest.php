...
/**
 * ApiV2ListGoodsFilterPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Products
 * @author   OpenAPI Generator team
 ...
 */
class ApiV2ListGoodsFilterPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v2_list_goods_filter_post_request';
    ...
    {
        $this->setIfExists('nm_list', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['nm_list'] === null) {
            $invalidProperties[] = "'nm_list' can't be null";
        }
        if ((count($this->container['nm_list']) > 1000)) {
            $invalidProperties[] = "invalid value for 'nm_list', number of items must be less than or equal to 1000.";
        }

        if ((count($this->container['nm_list']) < 1)) {
            $invalidProperties[] = "invalid value for 'nm_list', number of items must be greater than or equal to 1.";
        }
    ...
    {
        return $this->container['nm_list'];
    }

    /**
     * Sets nm_list
     *
     * @param int[] $nm_list Артикулы WB для поиска товара
     *
     * @return self
     */
    public function setNmList($nm_list)
    {
        if (is_null($nm_list)) {
        ...
        if ((count($nm_list) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nm_list when calling ApiV2ListGoodsFilterPostRequest., number of items must be greater than or equal to 1.');
        }
        $this->container['nm_list'] = $nm_list;
