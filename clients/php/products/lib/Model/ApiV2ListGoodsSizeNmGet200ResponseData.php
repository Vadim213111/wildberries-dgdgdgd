 ...
 */
class ApiV2ListGoodsSizeNmGet200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v2_list_goods_size_nm_get_200_response_data';
    ...
    public function setListGoods($list_goods)
    {
        if (is_null($list_goods)) {
            array_push($this->openAPINullablesSetToNull, 'list_goods');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('list_goods', $nullablesSetToNull);
            if ($index !== FALSE) {
