 ...
 */
class ContentV2CardsUpdatePostRequestInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_content_v2_cards_update_post_request_inner';
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 60)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ContentV2CardsUpdatePostRequestInner., must be smaller than or equal to 60.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Описание товара<br> Максимальное количество символов зависит от категории товара<br> Стандарт — 2000, минимум — 1000, максимум — 5000<br> Подробно о правилах описания в **Правилах заполнения карточки товара** в [Справочном центре](https://seller.wildberries.ru/help-center/article/A-113) на портале продавцов
     *
     * @return self
     */
