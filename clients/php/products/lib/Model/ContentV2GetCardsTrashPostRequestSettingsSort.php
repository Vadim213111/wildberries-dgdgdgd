...
/**
 * ContentV2GetCardsTrashPostRequestSettingsSort Class Doc Comment
 *
 * @category Class
 ...
 */
class ContentV2GetCardsTrashPostRequestSettingsSort implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_content_v2_get_cards_trash_post_request_settings_sort';
    ...
    {
        $this->setIfExists('ascending', $data ?? [], false);
    }
