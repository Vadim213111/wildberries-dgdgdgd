...
/**
 * ApiV3WarehousesPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Products
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3WarehousesPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_warehouses_post_request';
     ...
     * Sets name
     *
     * @param string $name Имя склада продавца
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ApiV3WarehousesPostRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ApiV3WarehousesPostRequest., must be bigger than or equal to 1.');
        }
