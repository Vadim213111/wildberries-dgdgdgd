...
/**
 * ContentV2TagNomenclatureLinkPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Products
 * @author   OpenAPI Generator team
 ...
 */
class ContentV2TagNomenclatureLinkPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_content_v2_tag_nomenclature_link_post_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tags_ids', $data ?? [], null);
    }
    ...
    {
        return $this->container['tags_ids'];
    }

    /**
     * Sets tags_ids
     *
     * @param int[]|null $tags_ids Массив числовых ID ярлыков.<br> Что бы снять ярлыки с карточки товара, необходимо передать пустой массив.<br> Чтобы добавить ярлыки к уже имеющимся в карточке товара, необходимо в запросе передать новые ярлыки и ярлыки, которые уже есть в карточке товара.
     *
     * @return self
     */
    public function setTagsIds($tags_ids)
    {
        if (is_null($tags_ids)) {
            throw new \InvalidArgumentException('non-nullable tags_ids cannot be null');
        }
        $this->container['tags_ids'] = $tags_ids;
