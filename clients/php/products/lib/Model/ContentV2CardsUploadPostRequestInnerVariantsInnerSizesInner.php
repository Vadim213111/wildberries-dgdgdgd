...
/**
 * ContentV2CardsUploadPostRequestInnerVariantsInnerSizesInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Products
 * @author   OpenAPI Generator team
 ...
 */
class ContentV2CardsUploadPostRequestInnerVariantsInnerSizesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_content_v2_cards_upload_post_request_inner_variants_inner_sizes_inner';
     ...
     * Sets tech_size
     *
     * @param string|null $tech_size Размер товара (например, XL, 45)
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param int|null $price Цена товара
     *
     * @return self
     */
     ...
     * Sets skus
     *
     * @param string[]|null $skus Массив баркодов для размера. <br> Если не указать, сгенерируется автоматически. <br> Позволяет связать несколько баркодов с одним размером, например, для разных партий товара
     *
     * @return self
     */
