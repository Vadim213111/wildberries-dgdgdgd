...
/**
 * CommonInfoSupplierRating Class Doc Comment
 *
 * @category Class
 ...
 */
class CommonInfoSupplierRating implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CommonInfo_supplierRating';
     ...
     * Sets dynamics
     *
     * @param float|null $dynamics Динамика по сравнению с предыдущим периодом, %
     *
     * @return self
     */
