...
/**
 * PositionInfoAverage Class Doc Comment
 *
 * @category Class
 ...
 */
class PositionInfoAverage implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PositionInfo_average';
     ...
     * Sets current
     *
     * @param int $current Текущая средняя позиция товара
     *
     * @return self
     */
