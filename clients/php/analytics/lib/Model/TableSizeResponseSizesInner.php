 ...
 */
class TableSizeResponseSizesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TableSizeResponse_sizes_inner';
    ...
    {
        if (is_null($offices)) {
            throw new \InvalidArgumentException('non-nullable offices cannot be null');
        }
