...
/**
 * ProductStocks Class Doc Comment
 *
 * @category Class
 * @description Остатки
 * @package  Wildberries\Sdk\Analytics
 ...
 */
class ProductStocks implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Product_stocks';
    ...
    {
        $this->setIfExists('wb', $data ?? [], null);
        $this->setIfExists('mp', $data ?? [], null);
        $this->setIfExists('balance_sum', $data ?? [], null);
    }
    ...
    {
        if (is_null($wb)) {
            throw new \InvalidArgumentException('non-nullable wb cannot be null');
        }
        $this->container['wb'] = $wb;
    ...
    {
        if (is_null($mp)) {
            throw new \InvalidArgumentException('non-nullable mp cannot be null');
        }
        $this->container['mp'] = $mp;
    ...
    {
        return $this->container['balance_sum'];
    }
     ...
     * @return self
     */
    public function setBalanceSum($balance_sum)
    {
        if (is_null($balance_sum)) {
            throw new \InvalidArgumentException('non-nullable balance_sum cannot be null');
        }
        $this->container['balance_sum'] = $balance_sum;
