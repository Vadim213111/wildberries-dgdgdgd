 ...
 */
class ProductsResponseProductsInnerStatistic implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProductsResponse_products_inner_statistic';
