...
/**
 * TableSearchTextItemAllOfOpenCard Class Doc Comment
 *
 * @category Class
 ...
 */
class TableSearchTextItemAllOfOpenCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TableSearchTextItem_allOf_openCard';
     ...
     * Sets percentile
     *
     * @param int $percentile Процент, на который показатель количества открытий карточки товара выше, чем у карточек конкурентов по поисковому запросу
     *
     * @return self
     */
