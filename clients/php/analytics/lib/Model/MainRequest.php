...
/**
 * MainRequest Class Doc Comment
 *
 * @category Class
 * @description Параметры запроса для формирования главной страницы:   - &#x60;currentPeriod&#x60; — текущий период   - &#x60;pastPeriod&#x60; — предыдущий период для сравнения
 * @package  Wildberries\Sdk\Analytics
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MainRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MainRequest';
    ...
    public function setLimit($limit)
    {
        ...
        if (($limit > 1000)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling MainRequest., must be smaller than or equal to 1000.');
        }
