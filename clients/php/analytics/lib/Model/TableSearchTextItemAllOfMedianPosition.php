...
/**
 * TableSearchTextItemAllOfMedianPosition Class Doc Comment
 *
 * @category Class
 ...
 */
class TableSearchTextItemAllOfMedianPosition implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TableSearchTextItem_allOf_medianPosition';
     ...
     * Sets current
     *
     * @param int $current Текущая медианная позиция
     *
     * @return self
     */
