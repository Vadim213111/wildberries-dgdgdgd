 ...
 */
class TableShippingOfficeItemOfficesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TableShippingOfficeItem_offices_inner';
