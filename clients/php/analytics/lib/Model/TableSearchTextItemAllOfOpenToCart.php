...
/**
 * TableSearchTextItemAllOfOpenToCart Class Doc Comment
 *
 * @category Class
 ...
 */
class TableSearchTextItemAllOfOpenToCart implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TableSearchTextItem_allOf_openToCart';
     ...
     * Sets percentile
     *
     * @param int $percentile Процент, на который показатель конверсии в корзину выше, чем у карточек конкурентов по поисковому запросу
     *
     * @return self
     */
