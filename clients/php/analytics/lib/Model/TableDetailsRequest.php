 ...
 */
class TableDetailsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TableDetailsRequest';
    ...
    public const POSITION_CLUSTER_ALL = 'all';
    public const POSITION_CLUSTER_FIRST_HUNDRED = 'firstHundred';
    public const POSITION_CLUSTER_SECOND_HUNDRED = 'secondHundred';
    public const POSITION_CLUSTER_BELOW = 'below';
     ...
     * @return string[]
     */
    public function getPositionClusterAllowableValues()
    {
        return [
            self::POSITION_CLUSTER_ALL,
            self::POSITION_CLUSTER_FIRST_HUNDRED,
            self::POSITION_CLUSTER_SECOND_HUNDRED,
            self::POSITION_CLUSTER_BELOW,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getPositionClusterAllowableValues();
        if (!is_null($this->container['position_cluster']) && !in_array($this->container['position_cluster'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'position_cluster', must be one of '%s'",
                $this->container['position_cluster'],
     ...
     * Sets brand_name
     *
     * @param string|null $brand_name Название товара
     *
     * @return self
     */
     ...
     * Sets nm_ids
     *
     * @param int[]|null $nm_ids Список артикулов WB
     *
     * @return self
     */
     ...
     *
     * @param string $position_cluster Товары с какой средней позицией в поиске показывать в отчёте:   - `all` — все   - `firstHundred` — от 1 до 100   - `secondHundred` — от 101 до 200   - `below` — от 201 и ниже
     *
     * @return self
     */
    public function setPositionCluster($position_cluster)
    {
        ...
        $allowedValues = $this->getPositionClusterAllowableValues();
        if (!in_array($position_cluster, $allowedValues, true)) {
