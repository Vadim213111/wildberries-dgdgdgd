...
/**
 * NmReportCreateReportResponse Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Analytics
 * @author   OpenAPI Generator team
 ...
 */
class NmReportCreateReportResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NmReportCreateReportResponse';
     ...
     * Sets data
     *
     * @param string $data Уведомление, что началась генерация отчёта
     *
     * @return self
     */
