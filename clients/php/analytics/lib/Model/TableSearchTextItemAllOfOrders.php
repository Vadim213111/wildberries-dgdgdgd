...
/**
 * TableSearchTextItemAllOfOrders Class Doc Comment
 *
 * @category Class
 ...
 */
class TableSearchTextItemAllOfOrders implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TableSearchTextItem_allOf_orders';
     ...
     * Sets percentile
     *
     * @param int $percentile Процент, на который показатель заказов выше, чем у карточек конкурентов по поисковому запросу
     *
     * @return self
     */
