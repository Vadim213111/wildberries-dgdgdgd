 ...
 */
class SearchReportGroupReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SearchReportGroupReq';
     ...
     * Sets report_type
     *
     * @param string $report_type Тип отчёта `SEARCH_QUERIES_PREMIUM_REPORT_GROUP` — Отчёт по параметрам поиска. По предметам, брендам и ярлыкам
     *
     * @return self
     */
