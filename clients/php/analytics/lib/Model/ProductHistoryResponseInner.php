 ...
 */
class ProductHistoryResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProductHistoryResponse_inner';
