...
/**
 * OrderByMainAndDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderByMainAndDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'OrderByMainAndDetails';
    ...
    public const FIELD_MAX_PRICE = 'maxPrice';
    ...
    public function getFieldAllowableValues()
    {
        return [
            ...
            self::FIELD_MIN_PRICE,
            self::FIELD_MAX_PRICE,
        ];
    }
