...
/**
 * TableSearchTextItemAllOfAddToCart Class Doc Comment
 *
 * @category Class
 ...
 */
class TableSearchTextItemAllOfAddToCart implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TableSearchTextItem_allOf_addToCart';
     ...
     * Sets percentile
     *
     * @param int $percentile Процент, на который показатель добавлений в корзину выше, чем у карточек конкурентов по поисковому запросу
     *
     * @return self
     */
