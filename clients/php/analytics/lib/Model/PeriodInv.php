 ...
 */
class PeriodInv implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PeriodInv';
     ...
     * Sets start
     *
     * @param \DateTime $start Дата начала периода. Не позднее `end`. Не ранее 3 месяцев от текущей даты
     *
     * @return self
     */
     ...
     * Sets end
     *
     * @param \DateTime $end Дата окончания периода. Не ранее 3 месяцев от текущей даты
     *
     * @return self
     */
