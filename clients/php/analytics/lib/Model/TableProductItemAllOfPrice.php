...
/**
 * TableProductItemAllOfPrice Class Doc Comment
 *
 * @category Class
 * @description Цена
 * @package  Wildberries\Sdk\Analytics
 ...
 */
class TableProductItemAllOfPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TableProductItem_allOf_price';
