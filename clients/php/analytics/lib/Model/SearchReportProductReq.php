 ...
 */
class SearchReportProductReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SearchReportProductReq';
     ...
     * Sets report_type
     *
     * @param string $report_type Тип отчёта `SEARCH_QUERIES_PREMIUM_REPORT_PRODUCT` — Отчёт по параметрам поиска. По артикулам WB
     *
     * @return self
     */
