...
/**
 * TableGroupItemMetricsAvgPosition Class Doc Comment
 *
 * @category Class
 ...
 */
class TableGroupItemMetricsAvgPosition implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TableGroupItem_metrics_avgPosition';
     ...
     * Sets current
     *
     * @param int $current Текущая средняя позиция
     *
     * @return self
     */
