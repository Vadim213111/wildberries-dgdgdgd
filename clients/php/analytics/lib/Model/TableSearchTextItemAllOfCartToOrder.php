...
/**
 * TableSearchTextItemAllOfCartToOrder Class Doc Comment
 *
 * @category Class
 ...
 */
class TableSearchTextItemAllOfCartToOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TableSearchTextItem_allOf_cartToOrder';
     ...
     * Sets percentile
     *
     * @param int $percentile Процент, на который показатель конверсии в заказ выше, чем у карточек конкурентов по поисковому запросу
     *
     * @return self
     */
