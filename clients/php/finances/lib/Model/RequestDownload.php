 ...
 */
class RequestDownload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'requestDownload';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['params']) && (count($this->container['params']) > 50)) {
            $invalidProperties[] = "invalid value for 'params', number of items must be less than or equal to 50.";
        }
    ...
    public function setParams($params)
    {
        ...
        if ((count($params) < 1)) {
            throw new \InvalidArgumentException('invalid length for $params when calling RequestDownload., number of items must be greater than or equal to 1.');
        }
