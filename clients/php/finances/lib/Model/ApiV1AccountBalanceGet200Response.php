...
/**
 * ApiV1AccountBalanceGet200Response Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Finances
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1AccountBalanceGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_account_balance_get_200_response';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('for_withdraw', $data ?? [], null);
    }
     ...
     * Sets current
     *
     * @param float|null $current Текущий баланс продавца
     *
     * @return self
     */
     ...
     * @return float|null
     */
    public function getForWithdraw()
    {
        return $this->container['for_withdraw'];
    }

    /**
     * Sets for_withdraw
     *
     * @param float|null $for_withdraw Сумма, доступная к выводу
     *
     * @return self
     */
    public function setForWithdraw($for_withdraw)
    {
        if (is_null($for_withdraw)) {
            throw new \InvalidArgumentException('non-nullable for_withdraw cannot be null');
        }
        $this->container['for_withdraw'] = $for_withdraw;
