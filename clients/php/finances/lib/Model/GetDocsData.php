 ...
 */
class GetDocsData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GetDocs_data';
     ...
     * Sets file_name
     *
     * @param string|null $file_name Название документа
     *
     * @return self
     */
     ...
     * Sets extension
     *
     * @param string|null $extension Формат документа
     *
     * @return self
     */
     ...
     * Sets document
     *
     * @param string|null $document Документ в кодировке base64
     *
     * @return self
     */
