...
/**
 * GetCategoriesDataCategoriesInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Finances
 * @author   OpenAPI Generator team
 ...
 */
class GetCategoriesDataCategoriesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GetCategories_data_categories_inner';
     ...
     * Sets name
     *
     * @param string|null $name ID категории документа из параметра [запроса](./financial-reports-and-accounting#tag/Dokumenty/paths/~1api~1v1~1documents~1list/get) `category`
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title Название категории документа из поля [ответа](./financial-reports-and-accounting#tag/Dokumenty/~1api~1v1~1documents~1list/get) `category`
     *
     * @return self
     */
