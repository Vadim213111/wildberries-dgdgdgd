...
/**
 * GetListDataDocumentsInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Finances
 * @author   OpenAPI Generator team
 ...
 */
class GetListDataDocumentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GetList_data_documents_inner';
     ...
     * Sets service_name
     *
     * @param string|null $service_name Уникальный ID документа
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Название документа
     *
     * @return self
     */
     ...
     * Sets category
     *
     * @param string|null $category Название [категории документов](./financial-reports-and-accounting#tag/Dokumenty/paths/~1api~1v1~1documents~1categories/get) из поля ответа `title`
     *
     * @return self
     */
     ...
     * Sets extensions
     *
     * @param string[]|null $extensions Форматы документа
     *
     * @return self
     */
     ...
     * Sets creation_time
     *
     * @param string|null $creation_time Дата и время создания документа
     *
     * @return self
     */
     ...
     * Sets viewed
     *
     * @param bool|null $viewed Выгружен ли документ в личном кабинете
     *
     * @return self
     */
