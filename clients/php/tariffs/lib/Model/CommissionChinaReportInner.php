...
/**
 * CommissionChinaReportInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Tariffs
 * @author   OpenAPI Generator team
 ...
 */
class CommissionChinaReportInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CommissionChina_report_inner';
    ...
    {
        $this->setIfExists('kgvp_china', $data ?? [], null);
     ...
     * @return float|null
     */
    public function getKgvpChina()
    {
        return $this->container['kgvp_china'];
    }

    /**
     * Sets kgvp_china
     *
     * @param float|null $kgvp_china Комиссия для продавцов из Китая, %
     *
     * @return self
     */
    public function setKgvpChina($kgvp_china)
    {
        if (is_null($kgvp_china)) {
            throw new \InvalidArgumentException('non-nullable kgvp_china cannot be null');
        }
        $this->container['kgvp_china'] = $kgvp_china;
