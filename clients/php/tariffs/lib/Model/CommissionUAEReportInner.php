...
/**
 * CommissionUAEReportInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Tariffs
 * @author   OpenAPI Generator team
 ...
 */
class CommissionUAEReportInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CommissionUAE_report_inner';
    ...
    {
        $this->setIfExists('kgvp_uae', $data ?? [], null);
     ...
     * @return float|null
     */
    public function getKgvpUae()
    {
        return $this->container['kgvp_uae'];
    }

    /**
     * Sets kgvp_uae
     *
     * @param float|null $kgvp_uae Комиссия для продавцов из ОАЭ, %
     *
     * @return self
     */
    public function setKgvpUae($kgvp_uae)
    {
        if (is_null($kgvp_uae)) {
            throw new \InvalidArgumentException('non-nullable kgvp_uae cannot be null');
        }
        $this->container['kgvp_uae'] = $kgvp_uae;
