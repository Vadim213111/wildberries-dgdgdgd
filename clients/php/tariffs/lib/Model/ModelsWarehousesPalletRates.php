 ...
 */
class ModelsWarehousesPalletRates implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'models.WarehousesPalletRates';
    ...
    protected static $setters = [
        'dt_next_pallet' => 'setDtNextPallet',
    ...
    protected static $getters = [
        'dt_next_pallet' => 'getDtNextPallet',
    ...
    {
        $this->setIfExists('dt_next_pallet', $data ?? [], null);
     ...
     * @return string|null
     */
    public function getDtNextPallet()
    {
        return $this->container['dt_next_pallet'];
    }

    /**
     * Sets dt_next_pallet
     *
     * @param string|null $dt_next_pallet Дата начала следующего тарифа
     *
     * @return self
     */
    public function setDtNextPallet($dt_next_pallet)
    {
        if (is_null($dt_next_pallet)) {
            throw new \InvalidArgumentException('non-nullable dt_next_pallet cannot be null');
        }
        $this->container['dt_next_pallet'] = $dt_next_pallet;
