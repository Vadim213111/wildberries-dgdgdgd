...
/**
 * ApiBatchErrorResponse Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbw
 * @author   OpenAPI Generator team
 ...
 */
class ApiBatchErrorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'api.BatchErrorResponse';
    ...
    protected static $openAPITypes = [
        'code' => 'int',
        'detail' => 'string',
        'meta_details' => '\Wildberries\Sdk\OrdersDbw\Model\ApiBatchErrorResponseMetaDetailsInner[]'
    ];
     ...
     * Sets detail
     *
     * @param string $detail - `NotFound` — сборочное задание не найдено - `StatusMismatch` — операция невозможна для этого статуса сборочного задания - `ImeiIsNotFilled` — не заполнен IMEI - `MetaValidationFail` — ошибки валидации метаданных
     *
     * @return self
     */
     ...
     * Gets meta_details
     *
     * @return \Wildberries\Sdk\OrdersDbw\Model\ApiBatchErrorResponseMetaDetailsInner[]|null
     */
     ...
     * Sets meta_details
     *
     * @param \Wildberries\Sdk\OrdersDbw\Model\ApiBatchErrorResponseMetaDetailsInner[]|null $meta_details Детали ошибки валидации метаданных
     *
     * @return self
     */
