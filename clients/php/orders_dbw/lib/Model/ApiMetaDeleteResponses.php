...
/**
 * ApiMetaDeleteResponses Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbw
 * @author   OpenAPI Generator team
 ...
 */
class ApiMetaDeleteResponses implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'api.MetaDeleteResponses';
    ...
    protected static $openAPITypes = [
        'request_id' => 'string',
        'results' => '\Wildberries\Sdk\OrdersDbw\Model\ApiMetaDeleteResponsesResultsInner[]'
    ];
     ...
     * Sets request_id
     *
     * @param string|null $request_id Уникальный ID запроса. Отображается для ответов с ошибками
     *
     * @return self
     */
     ...
     * Gets results
     *
     * @return \Wildberries\Sdk\OrdersDbw\Model\ApiMetaDeleteResponsesResultsInner[]
     */
     ...
     * Sets results
     *
     * @param \Wildberries\Sdk\OrdersDbw\Model\ApiMetaDeleteResponsesResultsInner[] $results results
     *
     * @return self
     */
