...
/**
 * ApiV3DbwOrdersOrderIdMetaGtinPutRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbw
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3DbwOrdersOrderIdMetaGtinPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_dbw_orders__orderId__meta_gtin_put_request';
    ...
    public function setGtin($gtin)
    {
        ...
        if ((mb_strlen($gtin) > 13)) {
            throw new \InvalidArgumentException('invalid length for $gtin when calling ApiV3DbwOrdersOrderIdMetaGtinPutRequest., must be smaller than or equal to 13.');
        }
        if ((mb_strlen($gtin) < 13)) {
            throw new \InvalidArgumentException('invalid length for $gtin when calling ApiV3DbwOrdersOrderIdMetaGtinPutRequest., must be bigger than or equal to 13.');
        }
