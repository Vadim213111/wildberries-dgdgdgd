...
/**
 * OrderCourierInfo Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbw
 * @author   OpenAPI Generator team
 ...
 */
class OrderCourierInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'OrderCourierInfo';
    ...
    protected static $openAPITypes = [
        'courier_info' => '\Wildberries\Sdk\OrdersDbw\Model\CourierInfo',
        'order_id' => 'int'
    ];
     ...
     * Gets courier_info
     *
     * @return \Wildberries\Sdk\OrdersDbw\Model\CourierInfo|null
     */
     ...
     * Sets courier_info
     *
     * @param \Wildberries\Sdk\OrdersDbw\Model\CourierInfo|null $courier_info Информация о курьере
     *
     * @return self
     */
    public function setCourierInfo($courier_info)
    {
        if (is_null($courier_info)) {
            throw new \InvalidArgumentException('non-nullable courier_info cannot be null');
        }
