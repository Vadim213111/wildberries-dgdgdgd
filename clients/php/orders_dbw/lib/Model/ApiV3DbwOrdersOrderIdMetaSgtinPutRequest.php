...
/**
 * ApiV3DbwOrdersOrderIdMetaSgtinPutRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbw
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3DbwOrdersOrderIdMetaSgtinPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_dbw_orders__orderId__meta_sgtin_put_request';
    ...
    public function setSgtins($sgtins)
    {
        ...
        if ((count($sgtins) > 24)) {
            throw new \InvalidArgumentException('invalid value for $sgtins when calling ApiV3DbwOrdersOrderIdMetaSgtinPutRequest., number of items must be less than or equal to 24.');
        }
        if ((count($sgtins) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sgtins when calling ApiV3DbwOrdersOrderIdMetaSgtinPutRequest., number of items must be greater than or equal to 1.');
        }
