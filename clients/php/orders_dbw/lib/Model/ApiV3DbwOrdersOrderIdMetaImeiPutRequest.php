...
/**
 * ApiV3DbwOrdersOrderIdMetaImeiPutRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbw
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3DbwOrdersOrderIdMetaImeiPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_dbw_orders__orderId__meta_imei_put_request';
    ...
    public function setImei($imei)
    {
        ...
        if ((mb_strlen($imei) > 15)) {
            throw new \InvalidArgumentException('invalid length for $imei when calling ApiV3DbwOrdersOrderIdMetaImeiPutRequest., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($imei) < 15)) {
            throw new \InvalidArgumentException('invalid length for $imei when calling ApiV3DbwOrdersOrderIdMetaImeiPutRequest., must be bigger than or equal to 15.');
        }
