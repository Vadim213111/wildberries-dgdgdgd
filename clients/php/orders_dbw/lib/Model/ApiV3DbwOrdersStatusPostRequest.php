...
/**
 * ApiV3DbwOrdersStatusPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbw
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3DbwOrdersStatusPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_dbw_orders_status_post_request';
    ...
    public function setOrders($orders)
    {
        ...
        if ((count($orders) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $orders when calling ApiV3DbwOrdersStatusPostRequest., number of items must be less than or equal to 1000.');
        }
        if ((count($orders) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orders when calling ApiV3DbwOrdersStatusPostRequest., number of items must be greater than or equal to 1.');
        }
