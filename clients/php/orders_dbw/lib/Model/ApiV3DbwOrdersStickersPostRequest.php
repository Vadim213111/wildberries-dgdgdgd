...
/**
 * ApiV3DbwOrdersStickersPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbw
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3DbwOrdersStickersPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_dbw_orders_stickers_post_request';
     ...
     * Sets orders
     *
     * @param int[]|null $orders Список ID сборочных заданий
     *
     * @return self
     */
    public function setOrders($orders)
    {
        ...
        if ((count($orders) > 100)) {
            throw new \InvalidArgumentException('invalid value for $orders when calling ApiV3DbwOrdersStickersPostRequest., number of items must be less than or equal to 100.');
        }
        if ((count($orders) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orders when calling ApiV3DbwOrdersStickersPostRequest., number of items must be greater than or equal to 1.');
        }
