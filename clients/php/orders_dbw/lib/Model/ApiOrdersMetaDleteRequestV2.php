...
/**
 * ApiOrdersMetaDleteRequestV2 Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbw
 * @author   OpenAPI Generator team
 ...
 */
class ApiOrdersMetaDleteRequestV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'api.OrdersMetaDleteRequestV2';
    ...
    public function setOrdersIds($orders_ids)
    {
        ...
        if ((count($orders_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $orders_ids when calling ApiOrdersMetaDleteRequestV2., number of items must be less than or equal to 1000.');
        }
