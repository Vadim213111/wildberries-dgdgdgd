 ...
 */
class ApiStatusSetResponses implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'api.StatusSetResponses';
    ...
    protected static $openAPITypes = [
        'request_id' => 'string',
        'results' => '\Wildberries\Sdk\OrdersDbw\Model\ApiStatusSetResponse[]'
    ];
     ...
     * Sets request_id
     *
     * @param string|null $request_id Уникальный ID запроса, содержащего ошибки.
     *
     * @return self
     */
     ...
     * Gets results
     *
     * @return \Wildberries\Sdk\OrdersDbw\Model\ApiStatusSetResponse[]
     */
     ...
     * Sets results
     *
     * @param \Wildberries\Sdk\OrdersDbw\Model\ApiStatusSetResponse[] $results results
     *
     * @return self
     */
