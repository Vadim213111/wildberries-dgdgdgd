...
/**
 * ApiV3DbwOrdersOrderIdMetaUinPutRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbw
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3DbwOrdersOrderIdMetaUinPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_dbw_orders__orderId__meta_uin_put_request';
    ...
    public function setUin($uin)
    {
        ...
        if ((mb_strlen($uin) > 16)) {
            throw new \InvalidArgumentException('invalid length for $uin when calling ApiV3DbwOrdersOrderIdMetaUinPutRequest., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($uin) < 16)) {
            throw new \InvalidArgumentException('invalid length for $uin when calling ApiV3DbwOrdersOrderIdMetaUinPutRequest., must be bigger than or equal to 16.');
        }
