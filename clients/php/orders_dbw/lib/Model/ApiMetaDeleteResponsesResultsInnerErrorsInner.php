...
/**
 * ApiMetaDeleteResponsesResultsInnerErrorsInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbw
 * @author   OpenAPI Generator team
 ...
 */
class ApiMetaDeleteResponsesResultsInnerErrorsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'api_MetaDeleteResponses_results_inner_errors_inner';
     ...
     * Sets detail
     *
     * @param string $detail - `NotFound` — сборочное задание не найдено - `StatusMismatch` — операция невозможна для этого статуса сборочного задания - `ImeiIsNotFilled` — не заполнен IMEI
     *
     * @return self
     */
