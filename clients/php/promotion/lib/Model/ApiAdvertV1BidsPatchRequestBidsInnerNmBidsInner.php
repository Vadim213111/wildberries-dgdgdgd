...
/**
 * ApiAdvertV1BidsPatchRequestBidsInnerNmBidsInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class ApiAdvertV1BidsPatchRequestBidsInnerNmBidsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_advert_v1_bids_patch_request_bids_inner_nm_bids_inner';
    ...
    public const PLACEMENT_RECOMMENDATIONS = 'recommendations';
    public const PLACEMENT_COMBINED = 'combined';
    ...
    */
     ...
     * Sets placement
     *
     * @param string $placement Место размещения:   - `search` — в поиске (для кампаний с ручной ставкой)   - `recommendations`— в рекомендациях (для кампаний с ручной ставкой)   - `combined` — в поиске и рекомендациях (для кампаний с единой ставкой)
     *
     * @return self
     */
