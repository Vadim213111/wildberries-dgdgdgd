...
/**
 * V0GetNormQueryListResponseItemNormQueries Class Doc Comment
 *
 * @category Class
 * @description Поисковые кластеры
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class V0GetNormQueryListResponseItemNormQueries implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V0GetNormQueryListResponseItemNormQueries';
     ...
     * Sets active
     *
     * @param string[]|null $active Активные поисковые кластеры
     *
     * @return self
     */
     ...
     * Sets excluded
     *
     * @param string[]|null $excluded Неактивные поисковые кластеры
     *
     * @return self
     */
