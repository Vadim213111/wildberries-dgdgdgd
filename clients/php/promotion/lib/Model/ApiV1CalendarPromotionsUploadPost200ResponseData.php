...
/**
 * ApiV1CalendarPromotionsUploadPost200ResponseData Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiV1CalendarPromotionsUploadPost200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_calendar_promotions_upload_post_200_response_data';
     ...
     * Sets already_exists
     *
     * @param bool|null $already_exists Загрузка с такими данными уже существует
     *
     * @return self
     */
