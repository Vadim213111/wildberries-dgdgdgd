...
/**
 * DailyStats1Inner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class DailyStats1Inner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DailyStats1_inner';
    ...
    protected static $openAPITypes = [
        'date' => '\DateTime',
        'app_type_stats' => '\Wildberries\Sdk\Promotion\Model\DailyStats1InnerAppTypeStatsInner[]'
    ];
    ...
    protected static $setters = [
        'date' => 'setDate',
        'app_type_stats' => 'setAppTypeStats'
    ];
    ...
    protected static $getters = [
        'date' => 'getDate',
        'app_type_stats' => 'getAppTypeStats'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('app_type_stats', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets app_type_stats
     *
     * @return \Wildberries\Sdk\Promotion\Model\DailyStats1InnerAppTypeStatsInner[]|null
     */
    public function getAppTypeStats()
    {
        return $this->container['app_type_stats'];
    }

    /**
     * Sets app_type_stats
     *
     * @param \Wildberries\Sdk\Promotion\Model\DailyStats1InnerAppTypeStatsInner[]|null $app_type_stats Статистика по платформам
     *
     * @return self
     */
    public function setAppTypeStats($app_type_stats)
    {
        if (is_null($app_type_stats)) {
            throw new \InvalidArgumentException('non-nullable app_type_stats cannot be null');
        }
        $this->container['app_type_stats'] = $app_type_stats;
