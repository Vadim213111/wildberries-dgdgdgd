...
/**
 * V0BidRecommendationReachMax Class Doc Comment
 *
 * @category Class
 * @description Максимальный охват: 76-100%
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class V0BidRecommendationReachMax implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V0BidRecommendationReachMax';
