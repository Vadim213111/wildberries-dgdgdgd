...
/**
 * AdvV0AuctionPlacementsPutRequestPlacementsInnerPlacements Class Doc Comment
 *
 * @category Class
 * @description Места размещения
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AdvV0AuctionPlacementsPutRequestPlacementsInnerPlacements implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v0_auction_placements_put_request_placements_inner_placements';
    ...
    */
     ...
     * Sets search
     *
     * @param bool $search Размещение в поиске:   - `false` — отключено   - `true` — включено
     *
     * @return self
     */
     ...
     *
     * @param bool $recommendations Размещение в рекомендациях:   - `false` — отключено   - `true` — включено
     *
     * @return self
     */
