...
/**
 * V0GetNormQueryListRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class V0GetNormQueryListRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V0GetNormQueryListRequest';
    ...
    protected static $openAPITypes = [
        'items' => '\Wildberries\Sdk\Promotion\Model\V0GetNormQueryListRequestItem[]'
    ];
     ...
     * Gets items
     *
     * @return \Wildberries\Sdk\Promotion\Model\V0GetNormQueryListRequestItem[]
     */
     ...
     * Sets items
     *
     * @param \Wildberries\Sdk\Promotion\Model\V0GetNormQueryListRequestItem[] $items items
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) > 100)) {
            throw new \InvalidArgumentException('invalid value for $items when calling V0GetNormQueryListRequest., number of items must be less than or equal to 100.');
        }
