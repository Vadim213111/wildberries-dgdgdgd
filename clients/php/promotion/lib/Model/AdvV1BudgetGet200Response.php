...
/**
 * AdvV1BudgetGet200Response Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class AdvV1BudgetGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_adv_v1_budget_get_200_response';
     ...
     * Sets cash
     *
     * @param int|null $cash Поле не используется. Значение всегда 0.
     *
     * @return self
     */
     ...
     * @return int|null
     */
    public function getNetting()
    {
        return $this->container['netting'];
    }

    /**
     * Sets netting
     *
     * @param int|null $netting Поле не используется. Значение всегда 0.
     *
     * @return self
     */
    public function setNetting($netting)
    {
        if (is_null($netting)) {
            throw new \InvalidArgumentException('non-nullable netting cannot be null');
        }
        $this->container['netting'] = $netting;
