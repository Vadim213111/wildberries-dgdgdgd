 ...
 */
class DailyStats2InnerAppTypeStatsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DailyStats2_inner_app_type_stats_inner';
