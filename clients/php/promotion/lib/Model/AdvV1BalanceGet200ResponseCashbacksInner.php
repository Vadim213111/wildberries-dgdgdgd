...
/**
 * AdvV1BalanceGet200ResponseCashbacksInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class AdvV1BalanceGet200ResponseCashbacksInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v1_balance_get_200_response_cashbacks_inner';
    ...
    */
     ...
     * Sets percent
     *
     * @param int|null $percent Процент от суммы пополнения бюджета кампании, который можно оплатить промо-бонусами за один раз
     *
     * @return self
     */
     ...
     *
     * @param string|null $expiration_date Дата окончания действия промо-бонусов
     *
     * @return self
     */
