...
/**
 * Timestamps Class Doc Comment
 *
 * @category Class
 * @description Временные отметки
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Timestamps implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Timestamps';
    ...
    */
     ...
     * Sets started
     *
     * @param \DateTime|null $started Время последнего запуска кампании
     *
     * @return self
     */
