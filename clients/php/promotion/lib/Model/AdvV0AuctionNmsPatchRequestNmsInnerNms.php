...
/**
 * AdvV0AuctionNmsPatchRequestNmsInnerNms Class Doc Comment
 *
 * @category Class
 * @description Карточки товаров. Максимум 50 товаров для одной кампании
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AdvV0AuctionNmsPatchRequestNmsInnerNms implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v0_auction_nms_patch_request_nms_inner_nms';
