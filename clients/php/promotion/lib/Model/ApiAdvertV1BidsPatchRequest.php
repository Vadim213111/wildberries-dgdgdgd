...
/**
 * ApiAdvertV1BidsPatchRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class ApiAdvertV1BidsPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_advert_v1_bids_patch_request';
    ...
    protected static $openAPITypes = [
        'bids' => '\Wildberries\Sdk\Promotion\Model\ApiAdvertV1BidsPatchRequestBidsInner[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['bids']) > 50)) {
            $invalidProperties[] = "invalid value for 'bids', number of items must be less than or equal to 50.";
        }
     ...
     * Gets bids
     *
     * @return \Wildberries\Sdk\Promotion\Model\ApiAdvertV1BidsPatchRequestBidsInner[]
     */
     ...
     * Sets bids
     *
     * @param \Wildberries\Sdk\Promotion\Model\ApiAdvertV1BidsPatchRequestBidsInner[] $bids Ставки в кампаниях
     *
     * @return self
     */
