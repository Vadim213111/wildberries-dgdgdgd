...
/**
 * V0GetNormQueryBidsRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class V0GetNormQueryBidsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V0GetNormQueryBidsRequest';
    ...
    protected static $openAPITypes = [
        'items' => '\Wildberries\Sdk\Promotion\Model\V0GetNormQueryBidsRequestItem[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \Wildberries\Sdk\Promotion\Model\V0GetNormQueryBidsRequestItem[]
     */
     ...
     * Sets items
     *
     * @param \Wildberries\Sdk\Promotion\Model\V0GetNormQueryBidsRequestItem[] $items items
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) > 100)) {
            throw new \InvalidArgumentException('invalid value for $items when calling V0GetNormQueryBidsRequest., number of items must be less than or equal to 100.');
        }
