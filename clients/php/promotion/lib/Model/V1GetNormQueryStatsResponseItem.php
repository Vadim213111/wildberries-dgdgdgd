...
/**
 * V1GetNormQueryStatsResponseItem Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class V1GetNormQueryStatsResponseItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V1GetNormQueryStatsResponseItem';
    ...
    protected static $openAPITypes = [
        'advert_id' => 'int',
        'nm_id' => 'int',
        'daily_stats' => '\Wildberries\Sdk\Promotion\Model\V1GetNormQueryStatsResponseItemDailyStat[]'
    ];
     ...
     * Gets daily_stats
     *
     * @return \Wildberries\Sdk\Promotion\Model\V1GetNormQueryStatsResponseItemDailyStat[]|null
     */
     ...
     * Sets daily_stats
     *
     * @param \Wildberries\Sdk\Promotion\Model\V1GetNormQueryStatsResponseItemDailyStat[]|null $daily_stats Статистика с детализацией по дням
     *
     * @return self
     */
