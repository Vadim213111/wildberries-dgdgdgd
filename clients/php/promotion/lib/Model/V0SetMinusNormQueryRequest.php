...
/**
 * V0SetMinusNormQueryRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class V0SetMinusNormQueryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V0SetMinusNormQueryRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['norm_queries'] === null) {
            $invalidProperties[] = "'norm_queries' can't be null";
        }
        if ((count($this->container['norm_queries']) > 1000)) {
            $invalidProperties[] = "invalid value for 'norm_queries', number of items must be less than or equal to 1000.";
        }
     ...
     * Sets norm_queries
     *
     * @param string[] $norm_queries norm_queries
     *
     * @return self
     */
