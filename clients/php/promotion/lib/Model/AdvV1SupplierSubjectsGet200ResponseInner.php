...
/**
 * AdvV1SupplierSubjectsGet200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class AdvV1SupplierSubjectsGet200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_adv_v1_supplier_subjects_get_200_response_inner';
     ...
     * Sets name
     *
     * @param string|null $name Предмет
     *
     * @return self
     */
     ...
     * Sets count
     *
     * @param int|null $count Количество Артикулов WB (`nmId`) с таким предметом.
     *
     * @return self
     */
