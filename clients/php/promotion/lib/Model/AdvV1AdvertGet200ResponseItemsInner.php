...
class AdvV1AdvertGet200ResponseItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param int|null $additional_settings Дополнительные настройки.  Формат почтовой рассылки: - `1` — общий - `2` — частичный - `3` — уникальный   Социальная сеть: - `1` — VK - `2` — OK (Одноклассники)
     *
     * @return self
     */
