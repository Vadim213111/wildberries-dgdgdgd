...
/**
 * AdvertSubject Class Doc Comment
 *
 * @category Class
 * @description Предмет
 * @package  Wildberries\Sdk\Promotion
 ...
 */
class AdvertSubject implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AdvertSubject';
