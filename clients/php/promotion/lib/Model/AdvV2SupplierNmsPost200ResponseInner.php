...
/**
 * AdvV2SupplierNmsPost200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class AdvV2SupplierNmsPost200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_adv_v2_supplier_nms_post_200_response_inner';
    ...
    {
        if (is_null($nm)) {
            throw new \InvalidArgumentException('non-nullable nm cannot be null');
        }
