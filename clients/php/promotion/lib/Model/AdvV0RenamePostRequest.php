...
/**
 * AdvV0RenamePostRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class AdvV0RenamePostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_adv_v0_rename_post_request';
     ...
     * Sets advert_id
     *
     * @param int $advert_id ID кампании, в которой меняется название
     *
     * @return self
     */
