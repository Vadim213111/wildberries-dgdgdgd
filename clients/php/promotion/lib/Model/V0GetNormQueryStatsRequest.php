...
/**
 * V0GetNormQueryStatsRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class V0GetNormQueryStatsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V0GetNormQueryStatsRequest';
    ...
    protected static $openAPITypes = [
        'from' => '\DateTime',
        'to' => '\DateTime',
        'items' => '\Wildberries\Sdk\Promotion\Model\V0GetNormQueryStatsRequestItemsInner[]'
    ];
    ...
    */
     ...
     * Sets to
     *
     * @param \DateTime $to Дата окончания периода
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \Wildberries\Sdk\Promotion\Model\V0GetNormQueryStatsRequestItemsInner[]
     */
     ...
     * Sets items
     *
     * @param \Wildberries\Sdk\Promotion\Model\V0GetNormQueryStatsRequestItemsInner[] $items items
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) > 100)) {
            throw new \InvalidArgumentException('invalid value for $items when calling V0GetNormQueryStatsRequest., number of items must be less than or equal to 100.');
        }
