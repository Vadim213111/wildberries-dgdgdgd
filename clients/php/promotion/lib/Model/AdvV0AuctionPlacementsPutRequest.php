 ...
 */
class AdvV0AuctionPlacementsPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_adv_v0_auction_placements_put_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['placements']) > 50)) {
            $invalidProperties[] = "invalid value for 'placements', number of items must be less than or equal to 50.";
        }
