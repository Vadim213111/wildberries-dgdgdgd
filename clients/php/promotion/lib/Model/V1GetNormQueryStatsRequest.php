...
/**
 * V1GetNormQueryStatsRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class V1GetNormQueryStatsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V1GetNormQueryStatsRequest';
    ...
    protected static $openAPITypes = [
        'from' => '\DateTime',
        'to' => '\DateTime',
        'items' => '\Wildberries\Sdk\Promotion\Model\V1GetNormQueryStatsRequestItemsInner[]'
    ];
     ...
     * Gets items
     *
     * @return \Wildberries\Sdk\Promotion\Model\V1GetNormQueryStatsRequestItemsInner[]
     */
     ...
     * Sets items
     *
     * @param \Wildberries\Sdk\Promotion\Model\V1GetNormQueryStatsRequestItemsInner[] $items items
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) > 100)) {
            throw new \InvalidArgumentException('invalid value for $items when calling V1GetNormQueryStatsRequest., number of items must be less than or equal to 100.');
        }
