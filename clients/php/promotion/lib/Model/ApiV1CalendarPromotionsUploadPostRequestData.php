...
/**
 * ApiV1CalendarPromotionsUploadPostRequestData Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiV1CalendarPromotionsUploadPostRequestData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_calendar_promotions_upload_post_request_data';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('upload_now', $data ?? [], null);
        $this->setIfExists('nomenclatures', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['promotion_id']) && ($this->container['promotion_id'] < 1)) {
            $invalidProperties[] = "invalid value for 'promotion_id', must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['nomenclatures']) && (count($this->container['nomenclatures']) > 1000)) {
            $invalidProperties[] = "invalid value for 'nomenclatures', number of items must be less than or equal to 1000.";
        }

        if (!is_null($this->container['nomenclatures']) && (count($this->container['nomenclatures']) < 1)) {
            $invalidProperties[] = "invalid value for 'nomenclatures', number of items must be greater than or equal to 1.";
        }
     ...
     * Sets promotion_id
     *
     * @param int|null $promotion_id ID акции
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getUploadNow()
    {
        return $this->container['upload_now'];
    }

    /**
     * Sets upload_now
     *
     * @param bool|null $upload_now Установить скидку:   - `true` — сейчас   - `false` — в момент старта акции
     *
     * @return self
     */
    public function setUploadNow($upload_now)
    {
        if (is_null($upload_now)) {
            throw new \InvalidArgumentException('non-nullable upload_now cannot be null');
        }
        $this->container['upload_now'] = $upload_now;
    ...
    {
        return $this->container['nomenclatures'];
    }

    /**
     * Sets nomenclatures
     *
     * @param int[]|null $nomenclatures Артикулы WB, которые можно добавить в акцию
     *
     * @return self
     */
    public function setNomenclatures($nomenclatures)
    {
        ...
        if ((count($nomenclatures) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nomenclatures when calling ApiV1CalendarPromotionsUploadPostRequestData., number of items must be greater than or equal to 1.');
        }
        $this->container['nomenclatures'] = $nomenclatures;
