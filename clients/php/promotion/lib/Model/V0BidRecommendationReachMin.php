...
/**
 * V0BidRecommendationReachMin Class Doc Comment
 *
 * @category Class
 * @description Минимальный охват: 50-60%
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class V0BidRecommendationReachMin implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V0BidRecommendationReachMin';
