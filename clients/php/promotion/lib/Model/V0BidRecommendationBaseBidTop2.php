...
/**
 * V0BidRecommendationBaseBidTop2 Class Doc Comment
 *
 * @category Class
 * @description Топ-ставка
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class V0BidRecommendationBaseBidTop2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V0BidRecommendationBaseBidTop2';
     ...
     * Sets bid_kopecks
     *
     * @param int|null $bid_kopecks Рекомендуемая ставка, копеек. Если `0`, для данного предмета топ-ставка не используется
     *
     * @return self
     */
