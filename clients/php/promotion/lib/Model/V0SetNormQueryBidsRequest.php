...
/**
 * V0SetNormQueryBidsRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class V0SetNormQueryBidsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V0SetNormQueryBidsRequest';
    ...
    protected static $openAPITypes = [
        'bids' => '\Wildberries\Sdk\Promotion\Model\V0SetNormQueryBidsRequestItem[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['bids']) > 100)) {
            $invalidProperties[] = "invalid value for 'bids', number of items must be less than or equal to 100.";
        }
     ...
     * Gets bids
     *
     * @return \Wildberries\Sdk\Promotion\Model\V0SetNormQueryBidsRequestItem[]
     */
     ...
     * Sets bids
     *
     * @param \Wildberries\Sdk\Promotion\Model\V0SetNormQueryBidsRequestItem[] $bids bids
     *
     * @return self
     */
