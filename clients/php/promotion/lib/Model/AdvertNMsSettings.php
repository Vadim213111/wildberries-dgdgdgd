...
/**
 * AdvertNMsSettings Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class AdvertNMsSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AdvertNMsSettings';
    ...
    {
        $this->setIfExists('bids_kopecks', $data ?? [], null);
     ...
     * Gets bids_kopecks
     *
     * @return \Wildberries\Sdk\Promotion\Model\AdvertBidsKopecks
     */
    public function getBidsKopecks()
    {
        return $this->container['bids_kopecks'];
    }

    /**
     * Sets bids_kopecks
     *
     * @param \Wildberries\Sdk\Promotion\Model\AdvertBidsKopecks $bids_kopecks bids_kopecks
     *
     * @return self
     */
    public function setBidsKopecks($bids_kopecks)
    {
        if (is_null($bids_kopecks)) {
            throw new \InvalidArgumentException('non-nullable bids_kopecks cannot be null');
        }
        $this->container['bids_kopecks'] = $bids_kopecks;
