...
/**
 * ApiAdvertV1BidsPatchRequestBidsInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class ApiAdvertV1BidsPatchRequestBidsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_advert_v1_bids_patch_request_bids_inner';
    ...
    protected static $openAPITypes = [
        'advert_id' => 'int',
        'nm_bids' => '\Wildberries\Sdk\Promotion\Model\ApiAdvertV1BidsPatchRequestBidsInnerNmBidsInner[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('nm_bids', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['nm_bids']) > 50)) {
            $invalidProperties[] = "invalid value for 'nm_bids', number of items must be less than or equal to 50.";
        }
     ...
     * Gets nm_bids
     *
     * @return \Wildberries\Sdk\Promotion\Model\ApiAdvertV1BidsPatchRequestBidsInnerNmBidsInner[]
     */
    public function getNmBids()
    {
        return $this->container['nm_bids'];
    }
     ...
     * @return self
     */
    public function setNmBids($nm_bids)
    {
        if (is_null($nm_bids)) {
        ...
        $this->container['nm_bids'] = $nm_bids;
