...
/**
 * V0BidRecommendationReachMedium Class Doc Comment
 *
 * @category Class
 * @description Средний охват: 61-75%
 * @package  Wildberries\Sdk\Promotion
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class V0BidRecommendationReachMedium implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V0BidRecommendationReachMedium';
    ...
    protected static $setters = [
        ...
        'bid_kopecks_min' => 'setBidKopecksMin'
    ];
    ...
    protected static $getters = [
        ...
        'bid_kopecks_min' => 'getBidKopecksMin'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bid_kopecks_min', $data ?? [], null);
    }
    ...
    /**
     * Gets bid_kopecks_min
     *
     * @return int|null
     */
    public function getBidKopecksMin()
    {
        return $this->container['bid_kopecks_min'];
    }
     ...
     * @return self
     */
    public function setBidKopecksMin($bid_kopecks_min)
    {
        if (is_null($bid_kopecks_min)) {
            throw new \InvalidArgumentException('non-nullable bid_kopecks_min cannot be null');
        }
        $this->container['bid_kopecks_min'] = $bid_kopecks_min;
