 ...
 */
class ResponseFeedbackInnerProductDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'responseFeedback_inner_productDetails';
