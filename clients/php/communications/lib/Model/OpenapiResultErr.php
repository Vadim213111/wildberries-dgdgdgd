...
/**
 * OpenapiResultErr Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Communications
 * @author   OpenAPI Generator team
 ...
 */
class OpenapiResultErr implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'openapi.ResultErr';
    ...
    public const STATUS_FEEDBACK_NOT_FOUND = 'feedbackNotFound';
    public const STATUS_ITEM_NOT_FOUND = 'itemNotFound';
    public const STATUS_FEEDBACK_MISMATCH = 'feedbackMismatch';
    public const STATUS_ITEM_NO_IMAGES = 'itemNoImages';
    public const STATUS_FEEDBACK_EXCLUDED = 'feedbackExcluded';
    public const STATUS_IMT_NOT_DISPLAYED = 'imtNotDisplayed';
    public const STATUS_GLOBAL_LIMIT_REACHED = 'globalLimitReached';
    public const STATUS_UNIT_LIMIT_REACHED = 'unitLimitReached';
    public const STATUS_TARIFF_RESTRICTION = 'tariffRestriction';
    public const STATUS_SUBSCRIPTION_RESTRICTION = 'subscriptionRestriction';
    public const STATUS_ALREADY_PINNED = 'alreadyPinned';
    public const STATUS_BODY_NOT_VALID = 'bodyNotValid';
    ...
    {
        return [
            self::STATUS_FEEDBACK_NOT_FOUND,
            self::STATUS_ITEM_NOT_FOUND,
            self::STATUS_FEEDBACK_MISMATCH,
            self::STATUS_ITEM_NO_IMAGES,
            self::STATUS_FEEDBACK_EXCLUDED,
            self::STATUS_IMT_NOT_DISPLAYED,
            self::STATUS_GLOBAL_LIMIT_REACHED,
            self::STATUS_UNIT_LIMIT_REACHED,
            self::STATUS_TARIFF_RESTRICTION,
            self::STATUS_SUBSCRIPTION_RESTRICTION,
            self::STATUS_ALREADY_PINNED,
            self::STATUS_BODY_NOT_VALID,
        ];
    }
