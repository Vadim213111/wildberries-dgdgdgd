...
/**
 * MessageResponseResult Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Communications
 * @author   OpenAPI Generator team
 ...
 */
class MessageResponseResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MessageResponse_result';
    ...
    protected static $openAPIFormats = [
        'add_time' => 'Unix Timestamp в миллисекундах',
        'chat_id' => null,
        'sign' => null
    ];
     ...
     * Sets add_time
     *
     * @param int|null $add_time Дата и время создания чата
     *
     * @return self
     */
     ...
     * Sets sign
     *
     * @param string|null $sign Подпись чата
     *
     * @return self
     */
