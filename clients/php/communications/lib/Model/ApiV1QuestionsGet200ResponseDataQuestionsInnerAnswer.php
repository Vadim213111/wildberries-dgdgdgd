...
/**
 * ApiV1QuestionsGet200ResponseDataQuestionsInnerAnswer Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiV1QuestionsGet200ResponseDataQuestionsInnerAnswer implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_questions_get_200_response_data_questions_inner_answer';
     ...
     * Sets editable
     *
     * @param bool|null $editable Можно ли отредактировать ответ (`false` - нельзя, `true` - можно)
     *
     * @return self
     */
