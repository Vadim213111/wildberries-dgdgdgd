 ...
 */
class EventsResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EventsResult';
    ...
    protected static array $openAPINullables = [
        'next' => false,
        'newest_event_time' => false,
        'oldest_event_time' => false,
        'total_events' => false,
        'events' => false
    ];
    ...
    protected static $setters = [
        'next' => 'setNext',
        'newest_event_time' => 'setNewestEventTime',
        'oldest_event_time' => 'setOldestEventTime',
    ...
    protected static $getters = [
        'next' => 'getNext',
        'newest_event_time' => 'getNewestEventTime',
        'oldest_event_time' => 'getOldestEventTime',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('newest_event_time', $data ?? [], null);
        $this->setIfExists('oldest_event_time', $data ?? [], null);
     ...
     * Sets next
     *
     * @param int|null $next Пагинатор. Значение поля необходимо указать в запросе для получения следующего пакета данных
     *
     * @return self
     */
    ...
    {
        return $this->container['newest_event_time'];
    }
     ...
     * @return self
     */
    public function setNewestEventTime($newest_event_time)
    {
        if (is_null($newest_event_time)) {
            throw new \InvalidArgumentException('non-nullable newest_event_time cannot be null');
        }
        $this->container['newest_event_time'] = $newest_event_time;
    ...
    {
        return $this->container['oldest_event_time'];
    }
     ...
     * @return self
     */
    public function setOldestEventTime($oldest_event_time)
    {
        if (is_null($oldest_event_time)) {
            throw new \InvalidArgumentException('non-nullable oldest_event_time cannot be null');
        }
        $this->container['oldest_event_time'] = $oldest_event_time;
     ...
     * Sets total_events
     *
     * @param int|null $total_events Количество событий
     *
     * @return self
     */
