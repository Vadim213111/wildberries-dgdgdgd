...
/**
 * ApiV1FeedbackGet200ResponseDataPhotoLinksInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Communications
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1FeedbackGet200ResponseDataPhotoLinksInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_feedback_get_200_response_data_photoLinks_inner';
    ...
    protected static $setters = [
        'full_size' => 'setFullSize',
        'mini_size' => 'setMiniSize'
    ];
    ...
    {
        $this->setIfExists('full_size', $data ?? [], null);
        $this->setIfExists('mini_size', $data ?? [], null);
    }
    ...
    {
        return $this->container['full_size'];
    }

    /**
     * Sets full_size
     *
     * @param string|null $full_size Адрес фотографии полного размера
     *
     * @return self
     */
    public function setFullSize($full_size)
    {
        if (is_null($full_size)) {
            throw new \InvalidArgumentException('non-nullable full_size cannot be null');
        }
        $this->container['full_size'] = $full_size;
     ...
     * @return string|null
     */
    public function getMiniSize()
    {
        return $this->container['mini_size'];
    }

    /**
     * Sets mini_size
     *
     * @param string|null $mini_size Адрес фотографии маленького размера
     *
     * @return self
     */
    public function setMiniSize($mini_size)
    {
        if (is_null($mini_size)) {
            throw new \InvalidArgumentException('non-nullable mini_size cannot be null');
        }
        $this->container['mini_size'] = $mini_size;
