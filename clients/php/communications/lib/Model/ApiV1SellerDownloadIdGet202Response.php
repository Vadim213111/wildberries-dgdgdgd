...
/**
 * ApiV1SellerDownloadIdGet202Response Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Communications
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1SellerDownloadIdGet202Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_seller_download__id__get_202_response';
    ...
    protected static $setters = [
        'moderation_state' => 'setModerationState',
        'retry_seconds' => 'setRetrySeconds'
    ];
    ...
    protected static $getters = [
        'moderation_state' => 'getModerationState',
        'retry_seconds' => 'getRetrySeconds'
    ];
    ...
    {
        $this->setIfExists('moderation_state', $data ?? [], null);
        $this->setIfExists('retry_seconds', $data ?? [], null);
    }
    ...
    {
        return $this->container['moderation_state'];
    }
     ...
     * @return self
     */
    public function setModerationState($moderation_state)
    {
        if (is_null($moderation_state)) {
            throw new \InvalidArgumentException('non-nullable moderation_state cannot be null');
        }
        $this->container['moderation_state'] = $moderation_state;
    ...
    {
        return $this->container['retry_seconds'];
    }
     ...
     * @return self
     */
    public function setRetrySeconds($retry_seconds)
    {
        if (is_null($retry_seconds)) {
            throw new \InvalidArgumentException('non-nullable retry_seconds cannot be null');
        }
        $this->container['retry_seconds'] = $retry_seconds;
