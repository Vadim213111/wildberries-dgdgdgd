...
/**
 * ApiV1QuestionsPatchRequestOneOf Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Communications
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1QuestionsPatchRequestOneOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_questions_patch_request_oneOf';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['was_viewed'] === null) {
            $invalidProperties[] = "'was_viewed' can't be null";
        }
     ...
     * Sets was_viewed
     *
     * @param bool $was_viewed Просмотрен ли вопрос
     *
     * @return self
     */
