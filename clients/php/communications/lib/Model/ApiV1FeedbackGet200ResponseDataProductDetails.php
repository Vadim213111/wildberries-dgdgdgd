 ...
 */
class ApiV1FeedbackGet200ResponseDataProductDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_feedback_get_200_response_data_productDetails';
    ...
    public function setSupplierArticle($supplier_article)
    {
        if (is_null($supplier_article)) {
            array_push($this->openAPINullablesSetToNull, 'supplier_article');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('supplier_article', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets brand_name
     *
     * @param string|null $brand_name Бренд товара
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param string|null $size Размер товара (`techSize` в КТ)
     *
     * @return self
     */
