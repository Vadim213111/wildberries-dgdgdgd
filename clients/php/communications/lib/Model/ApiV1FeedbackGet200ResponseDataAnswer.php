...
/**
 * ApiV1FeedbackGet200ResponseDataAnswer Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiV1FeedbackGet200ResponseDataAnswer implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_feedback_get_200_response_data_answer';
     ...
     * Sets state
     *
     * @param string|null $state Статус:   - `none` — новый   - `wbRu`— отображается на сайте   - `reviewRequired` — ответ проходит проверку   - `rejected` — ответ отклонён
     *
     * @return self
     */
     ...
     * Sets editable
     *
     * @param bool|null $editable Можно ли отредактировать ответ:   - `false` — нет   - `true` — да
     *
     * @return self
     */
