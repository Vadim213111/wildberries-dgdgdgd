 ...
 */
class OpenapiSellerLimitsResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'openapi_SellerLimitsResponse_data';
    ...
    {
        if (is_null($tariff)) {
            array_push($this->openAPINullablesSetToNull, 'tariff');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tariff', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
