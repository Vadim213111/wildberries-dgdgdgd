...
/**
 * TrbxStickers Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class TrbxStickers implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TrbxStickers';
    ...
    public function setBarcode($barcode)
    {
        ...
        if ((mb_strlen($barcode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $barcode when calling TrbxStickers., must be bigger than or equal to 1.');
        }
