...
/**
 * ApiV3OrdersStatusPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3OrdersStatusPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_orders_status_post_request';
    ...
    public function setOrders($orders)
    {
        ...
        if ((count($orders) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orders when calling ApiV3OrdersStatusPostRequest., number of items must be greater than or equal to 1.');
        }
