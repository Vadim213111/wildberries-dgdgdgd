...
/**
 * ApiV3SuppliesSupplyIdTrbxPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3SuppliesSupplyIdTrbxPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_supplies__supplyId__trbx_post_request';
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['amount'] > 1000)) {
            $invalidProperties[] = "invalid value for 'amount', must be smaller than or equal to 1000.";
        }
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling ApiV3SuppliesSupplyIdTrbxPostRequest., must be bigger than or equal to 1.');
        }
