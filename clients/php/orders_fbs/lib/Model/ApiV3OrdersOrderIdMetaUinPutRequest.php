...
/**
 * ApiV3OrdersOrderIdMetaUinPutRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3OrdersOrderIdMetaUinPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_orders__orderId__meta_uin_put_request';
    ...
    public function setUin($uin)
    {
        ...
        if ((mb_strlen($uin) > 16)) {
            throw new \InvalidArgumentException('invalid length for $uin when calling ApiV3OrdersOrderIdMetaUinPutRequest., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($uin) < 16)) {
            throw new \InvalidArgumentException('invalid length for $uin when calling ApiV3OrdersOrderIdMetaUinPutRequest., must be bigger than or equal to 16.');
        }
