...
/**
 * ApiV3OrdersStickersPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3OrdersStickersPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_orders_stickers_post_request';
    ...
    public function setOrders($orders)
    {
        ...
        if ((count($orders) > 100)) {
            throw new \InvalidArgumentException('invalid value for $orders when calling ApiV3OrdersStickersPostRequest., number of items must be less than or equal to 100.');
        }
        if ((count($orders) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orders when calling ApiV3OrdersStickersPostRequest., number of items must be greater than or equal to 1.');
        }
