...
/**
 * ApiV3SuppliesSupplyIdTrbxStickersPost200Response Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3SuppliesSupplyIdTrbxStickersPost200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_supplies__supplyId__trbx_stickers_post_200_response';
    ...
    protected static $openAPITypes = [
        'stickers' => '\Wildberries\Sdk\OrdersFbs\Model\TrbxStickers[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['stickers']) && (count($this->container['stickers']) < 1)) {
            $invalidProperties[] = "invalid value for 'stickers', number of items must be greater than or equal to 1.";
        }
     ...
     * Gets stickers
     *
     * @return \Wildberries\Sdk\OrdersFbs\Model\TrbxStickers[]|null
     */
     ...
     * Sets stickers
     *
     * @param \Wildberries\Sdk\OrdersFbs\Model\TrbxStickers[]|null $stickers stickers
     *
     * @return self
     */
