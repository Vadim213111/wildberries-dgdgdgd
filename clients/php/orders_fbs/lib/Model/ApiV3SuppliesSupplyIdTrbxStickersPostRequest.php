...
/**
 * ApiV3SuppliesSupplyIdTrbxStickersPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3SuppliesSupplyIdTrbxStickersPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_supplies__supplyId__trbx_stickers_post_request';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['trbx_ids'] === null) {
            $invalidProperties[] = "'trbx_ids' can't be null";
        }
