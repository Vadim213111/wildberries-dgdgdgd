...
/**
 * ApiMarketplaceV3SuppliesSupplyIdOrdersPatchRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiMarketplaceV3SuppliesSupplyIdOrdersPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_marketplace_v3_supplies__supplyId__orders_patch_request';
     ...
     * Sets orders
     *
     * @param int[]|null $orders ID сборочных заданий
     *
     * @return self
     */
    public function setOrders($orders)
    {
        ...
        if ((count($orders) > 100)) {
            throw new \InvalidArgumentException('invalid value for $orders when calling ApiMarketplaceV3SuppliesSupplyIdOrdersPatchRequest., number of items must be less than or equal to 100.');
        }
        if ((count($orders) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orders when calling ApiMarketplaceV3SuppliesSupplyIdOrdersPatchRequest., number of items must be greater than or equal to 1.');
        }
