...
/**
 * ApiV3SuppliesSupplyIdTrbxPost201Response Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3SuppliesSupplyIdTrbxPost201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_supplies__supplyId__trbx_post_201_response';
    ...
    {
        $this->setIfExists('trbx_ids', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['trbx_ids']) && (count($this->container['trbx_ids']) < 1)) {
            $invalidProperties[] = "invalid value for 'trbx_ids', number of items must be greater than or equal to 1.";
        }
     ...
     * @return string[]|null
     */
    public function getTrbxIds()
    {
        return $this->container['trbx_ids'];
    }
     ...
     * @return self
     */
    public function setTrbxIds($trbx_ids)
    {
        if (is_null($trbx_ids)) {
        ...
        $this->container['trbx_ids'] = $trbx_ids;
