...
/**
 * ApiV3OrdersOrderIdMetaGtinPutRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3OrdersOrderIdMetaGtinPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_orders__orderId__meta_gtin_put_request';
    ...
    public function setGtin($gtin)
    {
        ...
        if ((mb_strlen($gtin) > 13)) {
            throw new \InvalidArgumentException('invalid length for $gtin when calling ApiV3OrdersOrderIdMetaGtinPutRequest., must be smaller than or equal to 13.');
        }
        if ((mb_strlen($gtin) < 13)) {
            throw new \InvalidArgumentException('invalid length for $gtin when calling ApiV3OrdersOrderIdMetaGtinPutRequest., must be bigger than or equal to 13.');
        }
