...
/**
 * ApiV3SuppliesSupplyIdTrbxGet200Response Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3SuppliesSupplyIdTrbxGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_supplies__supplyId__trbx_get_200_response';
    ...
    protected static $openAPITypes = [
        'trbxes' => '\Wildberries\Sdk\OrdersFbs\Model\SupplyTrbx[]'
    ];
    ...
    {
        $this->setIfExists('trbxes', $data ?? [], null);
    }
     ...
     * Gets trbxes
     *
     * @return \Wildberries\Sdk\OrdersFbs\Model\SupplyTrbx[]|null
     */
    public function getTrbxes()
    {
        return $this->container['trbxes'];
    }

    /**
     * Sets trbxes
     *
     * @param \Wildberries\Sdk\OrdersFbs\Model\SupplyTrbx[]|null $trbxes trbxes
     *
     * @return self
     */
    public function setTrbxes($trbxes)
    {
        if (is_null($trbxes)) {
            throw new \InvalidArgumentException('non-nullable trbxes cannot be null');
        }
        $this->container['trbxes'] = $trbxes;
