...
/**
 * ApiV3OrdersOrderIdMetaSgtinPutRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3OrdersOrderIdMetaSgtinPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_orders__orderId__meta_sgtin_put_request';
    ...
    public function setSgtins($sgtins)
    {
        ...
        if ((count($sgtins) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sgtins when calling ApiV3OrdersOrderIdMetaSgtinPutRequest., number of items must be greater than or equal to 1.');
        }
