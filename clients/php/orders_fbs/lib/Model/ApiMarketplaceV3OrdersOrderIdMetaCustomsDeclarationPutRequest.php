...
/**
 * ApiMarketplaceV3OrdersOrderIdMetaCustomsDeclarationPutRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiMarketplaceV3OrdersOrderIdMetaCustomsDeclarationPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_marketplace_v3_orders__orderId__meta_customs_declaration_put_request';
    ...
    public function setCustomsDeclaration($customs_declaration)
    {
        ...
        if ((mb_strlen($customs_declaration) > 29)) {
            throw new \InvalidArgumentException('invalid length for $customs_declaration when calling ApiMarketplaceV3OrdersOrderIdMetaCustomsDeclarationPutRequest., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($customs_declaration) < 17)) {
            throw new \InvalidArgumentException('invalid length for $customs_declaration when calling ApiMarketplaceV3OrdersOrderIdMetaCustomsDeclarationPutRequest., must be bigger than or equal to 17.');
        }
