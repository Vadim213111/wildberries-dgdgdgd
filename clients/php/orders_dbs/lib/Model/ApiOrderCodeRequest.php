...
/**
 * ApiOrderCodeRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiOrderCodeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'api.OrderCodeRequest';
     ...
     * Sets code
     *
     * @param string|null $code Код подтверждения. <br> Отображается у покупателя на сайте и в приложении Wildberries
     *
     * @return self
     */
