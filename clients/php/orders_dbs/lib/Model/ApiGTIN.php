 ...
 */
class ApiGTIN implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'api.GTIN';
    ...
    public function setGtin($gtin)
    {
        ...
        if ((mb_strlen($gtin) > 13)) {
            throw new \InvalidArgumentException('invalid length for $gtin when calling ApiGTIN., must be smaller than or equal to 13.');
        }
        if ((mb_strlen($gtin) < 13)) {
            throw new \InvalidArgumentException('invalid length for $gtin when calling ApiGTIN., must be bigger than or equal to 13.');
        }
