 ...
 */
class ApiIMEI implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'api.IMEI';
    ...
    public function setImei($imei)
    {
        ...
        if ((mb_strlen($imei) > 15)) {
            throw new \InvalidArgumentException('invalid length for $imei when calling ApiIMEI., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($imei) < 15)) {
            throw new \InvalidArgumentException('invalid length for $imei when calling ApiIMEI., must be bigger than or equal to 15.');
        }
