...
/**
 * ApiB2bClientInfo Class Doc Comment
 *
 * @category Class
 * @description Данные покупателя B2B
 * @package  Wildberries\Sdk\OrdersDbs
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ApiB2bClientInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'api.B2bClientInfo';
    ...
    */
     ...
     * Sets inn
     *
     * @param string|null $inn Индивидуальный номер налогоплательщика (ИНН)
     *
     * @return self
     */
     ...
     * Sets kpp
     *
     * @param string|null $kpp Код причины постановки на учёт (КПП)
     *
     * @return self
     */
     ...
     * Sets org_name
     *
     * @param string|null $org_name Наименование организации
     *
     * @return self
     */
