...
/**
 * ApiOrderGroupsRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiOrderGroupsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'api.OrderGroupsRequest';
     ...
     * Sets groups
     *
     * @param string[]|null $groups Список значений `groupId`. Можно получить из [новых](./orders-dbs#tag/Sborochnye-zadaniya-DBS/paths/~1api~1v3~1dbs~1orders~1new/get) и [завершенных](./orders-dbs#tag/Sborochnye-zadaniya-DBS/paths/~1api~1v3~1dbs~1orders/get) сборочных заданий
     *
     * @return self
     */
