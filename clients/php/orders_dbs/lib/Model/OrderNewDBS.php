 ...
 */
class OrderNewDBS implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'OrderNewDBS';
    ...
    public function setComment($comment)
    {
        ...
        if ((mb_strlen($comment) > 300)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling OrderNewDBS., must be smaller than or equal to 300.');
        }
