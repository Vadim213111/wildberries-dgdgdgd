...
/**
 * ApiV3DbsOrdersOrderIdMetaGtinPutRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3DbsOrdersOrderIdMetaGtinPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_dbs_orders__orderId__meta_gtin_put_request';
    ...
    public function setGtin($gtin)
    {
        ...
        if ((mb_strlen($gtin) > 13)) {
            throw new \InvalidArgumentException('invalid length for $gtin when calling ApiV3DbsOrdersOrderIdMetaGtinPutRequest., must be smaller than or equal to 13.');
        }
        if ((mb_strlen($gtin) < 13)) {
            throw new \InvalidArgumentException('invalid length for $gtin when calling ApiV3DbsOrdersOrderIdMetaGtinPutRequest., must be bigger than or equal to 13.');
        }
