...
/**
 * ApiMarketplaceV3DbsOrdersStatusReceivePost200ResponseResultsInnerErrorsInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiMarketplaceV3DbsOrdersStatusReceivePost200ResponseResultsInnerErrorsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_marketplace_v3_dbs_orders_status_receive_post_200_response_results_inner_errors_inner';
    ...
    */
     ...
     * Sets detail
     *
     * @param string|null $detail - `NotFound` — сборочное задание не найдено - `StatusMismatch` — операция невозможна для этого статуса сборочного задания - `SGTINIsNotFilled` — обязательный [код маркировки](./orders-dbs#tag/Metadannye-DBS/paths/~1api~1marketplace~1v3~1dbs~1orders~1meta~1sgtin/post) не указан
     *
     * @return self
     */
