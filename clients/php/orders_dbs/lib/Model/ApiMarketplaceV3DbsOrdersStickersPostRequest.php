...
/**
 * ApiMarketplaceV3DbsOrdersStickersPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiMarketplaceV3DbsOrdersStickersPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_marketplace_v3_dbs_orders_stickers_post_request';
    ...
    public function setOrders($orders)
    {
        ...
        if ((count($orders) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orders when calling ApiMarketplaceV3DbsOrdersStickersPostRequest., number of items must be greater than or equal to 1.');
        }
