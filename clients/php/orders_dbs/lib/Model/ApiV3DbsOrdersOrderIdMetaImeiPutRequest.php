...
/**
 * ApiV3DbsOrdersOrderIdMetaImeiPutRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3DbsOrdersOrderIdMetaImeiPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_dbs_orders__orderId__meta_imei_put_request';
    ...
    public function setImei($imei)
    {
        ...
        if ((mb_strlen($imei) > 15)) {
            throw new \InvalidArgumentException('invalid length for $imei when calling ApiV3DbsOrdersOrderIdMetaImeiPutRequest., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($imei) < 15)) {
            throw new \InvalidArgumentException('invalid length for $imei when calling ApiV3DbsOrdersOrderIdMetaImeiPutRequest., must be bigger than or equal to 15.');
        }
