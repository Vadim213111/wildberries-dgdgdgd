...
/**
 * ApiOrdersCodeRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiOrdersCodeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'api.OrdersCodeRequest';
    ...
    protected static $openAPITypes = [
        'orders' => '\Wildberries\Sdk\OrdersDbs\Model\ApiOrderCodeRequest[]'
    ];
     ...
     * Gets orders
     *
     * @return \Wildberries\Sdk\OrdersDbs\Model\ApiOrderCodeRequest[]
     */
     ...
     * Sets orders
     *
     * @param \Wildberries\Sdk\OrdersDbs\Model\ApiOrderCodeRequest[] $orders orders
     *
     * @return self
     */
    public function setOrders($orders)
    {
        ...
        if ((count($orders) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $orders when calling ApiOrdersCodeRequest., number of items must be less than or equal to 1000.');
        }
