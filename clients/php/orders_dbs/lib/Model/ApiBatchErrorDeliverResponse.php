...
/**
 * ApiBatchErrorDeliverResponse Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiBatchErrorDeliverResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'api.BatchErrorDeliverResponse';
    ...
    protected static $openAPITypes = [
        'code' => 'int',
        'detail' => 'string',
        'meta_details' => '\Wildberries\Sdk\OrdersDbs\Model\ApiBatchErrorDeliverResponseMetaDetailsInner[]'
    ];
     ...
     * Sets detail
     *
     * @param string|null $detail - `NotFound` — сборочное задание не найдено - `StatusMismatch` — операция невозможна для этого статуса сборочного задания - `ImeiIsNotFilled` — не заполнен IMEI - `MetaValidationFail` — ошибки валидации метаданных
     *
     * @return self
     */
     ...
     * Gets meta_details
     *
     * @return \Wildberries\Sdk\OrdersDbs\Model\ApiBatchErrorDeliverResponseMetaDetailsInner[]|null
     */
     ...
     * Sets meta_details
     *
     * @param \Wildberries\Sdk\OrdersDbs\Model\ApiBatchErrorDeliverResponseMetaDetailsInner[]|null $meta_details Детали ошибки валидации метаданных
     *
     * @return self
     */
