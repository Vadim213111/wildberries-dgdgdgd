...
/**
 * ExciseReportRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Reports
 * @author   OpenAPI Generator team
 ...
 */
class ExciseReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ExciseReportRequest';
    ...
    public const COUNTRIES_AM = 'AM';
    public const COUNTRIES_BY = 'BY';
    public const COUNTRIES_KG = 'KG';
    public const COUNTRIES_KZ = 'KZ';
    public const COUNTRIES_RU = 'RU';
    public const COUNTRIES_UZ = 'UZ';
     ...
     * Sets countries
     *
     * @param string[]|null $countries Код стран по стандарту ISO 3166-2. Чтобы получить данные по всем странам, оставьте параметр пустым
     *
     * @return self
     */
