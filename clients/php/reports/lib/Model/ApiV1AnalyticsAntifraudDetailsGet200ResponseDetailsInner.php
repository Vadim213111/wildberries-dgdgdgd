...
/**
 * ApiV1AnalyticsAntifraudDetailsGet200ResponseDetailsInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Reports
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1AnalyticsAntifraudDetailsGet200ResponseDetailsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_analytics_antifraud_details_get_200_response_details_inner';
     ...
     * Sets sum
     *
     * @param int|null $sum Сумма заказа
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency Валюта заказа
     *
     * @return self
     */
     ...
     * Sets date_from
     *
     * @param string|null $date_from Начало отчётного периода
     *
     * @return self
     */
     ...
     * Sets date_to
     *
     * @param string|null $date_to Конец отчётного периода
     *
     * @return self
     */
