...
/**
 * ApiV1AnalyticsBannedProductsShadowedGet200ResponseReportInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Reports
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1AnalyticsBannedProductsShadowedGet200ResponseReportInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_analytics_banned_products_shadowed_get_200_response_report_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('nm_rating', $data ?? [], null);
    }
     ...
     * @return float|null
     */
    public function getNmRating()
    {
        return $this->container['nm_rating'];
    }

    /**
     * Sets nm_rating
     *
     * @param float|null $nm_rating Рейтинг товара
     *
     * @return self
     */
    public function setNmRating($nm_rating)
    {
        if (is_null($nm_rating)) {
            throw new \InvalidArgumentException('non-nullable nm_rating cannot be null');
        }
        $this->container['nm_rating'] = $nm_rating;
