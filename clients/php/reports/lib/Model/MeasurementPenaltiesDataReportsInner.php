...
/**
 * MeasurementPenaltiesDataReportsInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\Reports
 * @author   OpenAPI Generator team
 ...
 */
class MeasurementPenaltiesDataReportsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MeasurementPenalties_data_reports_inner';
     ...
     * Sets is_valid
     *
     * @param bool|null $is_valid Статус обмера:   - `false` — отменён   - `true` — подтверждён
     *
     * @return self
     */
    ...
    {
        return $this->container['is_valid_dt'];
    }
     ...
     * @return self
     */
    public function setIsValidDt($is_valid_dt)
    {
        if (is_null($is_valid_dt)) {
            throw new \InvalidArgumentException('non-nullable is_valid_dt cannot be null');
        }
        $this->container['is_valid_dt'] = $is_valid_dt;

        return $this;
    }

    /**
     * Gets reversal_amount
     *
     * @return float|null
     */
    public function getReversalAmount()
    {
        return $this->container['reversal_amount'];
    }

    /**
     * Sets reversal_amount
     *
     * @param float|null $reversal_amount Сумма сторно
     *
     * @return self
     */
    public function setReversalAmount($reversal_amount)
    {
        if (is_null($reversal_amount)) {
            throw new \InvalidArgumentException('non-nullable reversal_amount cannot be null');
        }
        $this->container['reversal_amount'] = $reversal_amount;
     ...
     * Sets penalty_amount
     *
     * @param float|null $penalty_amount Сумма штрафа
     *
     * @return self
     */
