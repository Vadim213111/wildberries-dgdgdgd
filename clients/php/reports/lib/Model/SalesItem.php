...
class SalesItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'spp' => 'setSpp',
        'payment_sale_amount' => 'setPaymentSaleAmount',
        'for_pay' => 'setForPay',
    ...
    protected static $getters = [
        ...
        'spp' => 'getSpp',
        'payment_sale_amount' => 'getPaymentSaleAmount',
        'for_pay' => 'getForPay',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('payment_sale_amount', $data ?? [], null);
     ...
     * Sets date
     *
     * @param string|null $date Дата и время продажи. Это поле соответствует параметру `dateFrom` в запросе, если параметр `flag`=1. Если часовой пояс не указан, то берётся Московское время (UTC+3).
     *
     * @return self
     */
     ...
     *
     * @param string|null $last_change_date Дата и время обновления информации в сервисе. Это поле соответствует параметру `dateFrom` в запросе, если параметр `flag`=0 или не указан. Если часовой пояс не указан, то берётся Московское время (UTC+3).
     *
     * @return self
     */
    ...
    /**
     * Gets payment_sale_amount
     *
     * @return int|null
     */
    public function getPaymentSaleAmount()
    {
        return $this->container['payment_sale_amount'];
    }

    /**
     * Sets payment_sale_amount
     *
     * @param int|null $payment_sale_amount Скидка за оплату WB Кошельком, ₽
     *
     * @return self
     */
    public function setPaymentSaleAmount($payment_sale_amount)
    {
        if (is_null($payment_sale_amount)) {
            throw new \InvalidArgumentException('non-nullable payment_sale_amount cannot be null');
        }
        $this->container['payment_sale_amount'] = $payment_sale_amount;
     ...
     * Sets sale_id
     *
     * @param string|null $sale_id Уникальный ID продажи/возврата - `S**********` — продажа - `R**********` — возврат (на склад WB)
     *
     * @return self
     */
