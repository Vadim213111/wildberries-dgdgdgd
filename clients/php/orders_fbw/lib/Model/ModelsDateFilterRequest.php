...
/**
 * ModelsDateFilterRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersFbw
 * @author   OpenAPI Generator team
 ...
 */
class ModelsDateFilterRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'models.DateFilterRequest';
    ...
    public const TYPE_FACT_DATE = 'factDate';
    public const TYPE_CREATE_DATE = 'createDate';
    public const TYPE_SUPPLY_DATE = 'supplyDate';
    public const TYPE_UPDATED_DATE = 'updatedDate';
    ...
    public function getTypeAllowableValues()
    {
        return [
            self::TYPE_FACT_DATE,
            self::TYPE_CREATE_DATE,
            self::TYPE_SUPPLY_DATE,
            self::TYPE_UPDATED_DATE,
        ];
    }
     ...
     * Sets from
     *
     * @param string|null $from Дата начала периода
     *
     * @return self
     */
     ...
     * Sets till
     *
     * @param string|null $till Дата окончания периода
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type Тип дат:   - `factDate` — дата фактической отгрузки поставки   - `createDate` — дата создания поставки   - `supplyDate` — плановая дата отгрузки поставки   - `updatedDate` — дата изменения поставки
     *
     * @return self
     */
