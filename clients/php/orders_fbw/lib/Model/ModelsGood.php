 ...
 */
class ModelsGood implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'models.Good';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['quantity']) && ($this->container['quantity'] > 999999)) {
     ...
     * Sets quantity
     *
     * @param int|null $quantity Суммарное количество товаров, планируемых для поставки. <br>  **Максимум 999999**
     *
     * @return self
     */
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling ModelsGood., must be bigger than or equal to 1.');
        }
