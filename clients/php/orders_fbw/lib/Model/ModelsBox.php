 ...
 */
class ModelsBox implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'models.Box';
     ...
     * Sets package_code
     *
     * @param string|null $package_code Штрих-код упаковки
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int|null $quantity Суммарное количество товара в упаковке, шт
     *
     * @return self
     */
