 ...
 */
class ModelsOptionsResultModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'models.OptionsResultModel';
     ...
     * Sets request_id
     *
     * @param string|null $request_id ID запроса при наличии ошибок
     *
     * @return self
     */
