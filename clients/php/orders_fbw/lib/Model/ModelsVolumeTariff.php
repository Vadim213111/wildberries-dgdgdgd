 ...
 */
class ModelsVolumeTariff implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'models.VolumeTariff';
     ...
     * Sets from
     *
     * @param int|null $from Объём поставки от, литры
     *
     * @return self
     */
     ...
     * Sets to
     *
     * @param int|null $to Объём поставки до, литры
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param float|null $value Тариф, ₽ за литр
     *
     * @return self
     */
