...
/**
 * ApiOrdersErrorResponse Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\InStorePickup
 * @author   OpenAPI Generator team
 ...
 */
class ApiOrdersErrorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'api.OrdersErrorResponse';
     ...
     * Sets detail
     *
     * @param string $detail - `NotFound` — сборочное задание не найдено
     *
     * @return self
     */
