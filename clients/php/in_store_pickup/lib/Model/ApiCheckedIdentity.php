...
/**
 * ApiCheckedIdentity Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\InStorePickup
 * @author   OpenAPI Generator team
 ...
 */
class ApiCheckedIdentity implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'api.CheckedIdentity';
     ...
     * Sets ok
     *
     * @param bool|null $ok Принадлежит ли заказ покупателю:   - `true` — принадлежит   - `false` — значение не применяется. Если заказ не принадлежит покупателю, вы получите ответ со статус-кодом `409`
     *
     * @return self
     */
