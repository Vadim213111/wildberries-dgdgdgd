 ...
 */
class ApiOrdersIMEISetRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'api.OrdersIMEISetRequest';
    ...
    protected static $openAPITypes = [
        'orders' => '\Wildberries\Sdk\InStorePickup\Model\ApiIMEI[]'
    ];
     ...
     * Gets orders
     *
     * @return \Wildberries\Sdk\InStorePickup\Model\ApiIMEI[]
     */
     ...
     * Sets orders
     *
     * @param \Wildberries\Sdk\InStorePickup\Model\ApiIMEI[] $orders orders
     *
     * @return self
     */
    public function setOrders($orders)
    {
        ...
        if ((count($orders) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $orders when calling ApiOrdersIMEISetRequest., number of items must be less than or equal to 1000.');
        }
