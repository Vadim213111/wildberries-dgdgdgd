...
/**
 * ApiOrdersGTINSetRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\InStorePickup
 * @author   OpenAPI Generator team
 ...
 */
class ApiOrdersGTINSetRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'api.OrdersGTINSetRequest';
    ...
    protected static $openAPITypes = [
        'orders' => '\Wildberries\Sdk\InStorePickup\Model\ApiGTIN[]'
    ];
     ...
     * Gets orders
     *
     * @return \Wildberries\Sdk\InStorePickup\Model\ApiGTIN[]
     */
     ...
     * Sets orders
     *
     * @param \Wildberries\Sdk\InStorePickup\Model\ApiGTIN[] $orders orders
     *
     * @return self
     */
    public function setOrders($orders)
    {
        ...
        if ((count($orders) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $orders when calling ApiOrdersGTINSetRequest., number of items must be less than or equal to 1000.');
        }
