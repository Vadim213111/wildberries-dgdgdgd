...
/**
 * ApiOrderClientInfo Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\InStorePickup
 * @author   OpenAPI Generator team
 ...
 */
class ApiOrderClientInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'api.OrderClientInfo';
     ...
     * Sets phone
     *
     * @param string|null $phone Телефон для связи с покупателем. Чтобы связаться с покупателем наберите этот номер и введите добавочный код. Данный номер не является прямым номером покупателя.
     *
     * @return self
     */
     ...
     * Sets phone_code
     *
     * @param int|null $phone_code Добавочный код
     *
     * @return self
     */
