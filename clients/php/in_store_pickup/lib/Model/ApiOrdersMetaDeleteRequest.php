...
/**
 * ApiOrdersMetaDeleteRequest Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\InStorePickup
 * @author   OpenAPI Generator team
 ...
 */
class ApiOrdersMetaDeleteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'api.OrdersMetaDeleteRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('orders_ids', $data ?? [], null);
    }
     ...
     * Sets key
     *
     * @param string $key Тип метаданных для удаления (`imei`, `uin`, `gtin`, `sgtin`). Передаётся только одно значение
     *
     * @return self
     */
    ...
    {
        return $this->container['orders_ids'];
    }
     ...
     * @return self
     */
    public function setOrdersIds($orders_ids)
    {
        ...
        if ((count($orders_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $orders_ids when calling ApiOrdersMetaDeleteRequest., number of items must be less than or equal to 1000.');
        }
        $this->container['orders_ids'] = $orders_ids;
