...
/**
 * ApiV3ClickCollectOrdersNewGet401Response Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\InStorePickup
 * @author   OpenAPI Generator team
 ...
 */
class ApiV3ClickCollectOrdersNewGet401Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v3_click_collect_orders_new_get_401_response';
     ...
     * Sets code
     *
     * @param string|null $code Внутренний код ошибки
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param float|null $status HTTP статус-код
     *
     * @return self
     */
     ...
     * Sets status_text
     *
     * @param string|null $status_text Расшифровка HTTP статус-кода
     *
     * @return self
     */
