...
/**
 * ApiMetaErrorResponse Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\InStorePickup
 * @author   OpenAPI Generator team
 ...
 */
class ApiMetaErrorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'api.MetaErrorResponse';
     ...
     * Sets detail
     *
     * @param string $detail - `NotFound` — сборочное задание не найдено - `IncorrectRequestBody` — неправильный запрос - `IncorrectRequest` — передан некорректный параметр
     *
     * @return self
     */
