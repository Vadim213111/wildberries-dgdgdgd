 ...
 */
class ApiOrdersUINSetRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'api.OrdersUINSetRequest';
    ...
    protected static $openAPITypes = [
        'orders' => '\Wildberries\Sdk\InStorePickup\Model\ApiUIN[]'
    ];
     ...
     * Gets orders
     *
     * @return \Wildberries\Sdk\InStorePickup\Model\ApiUIN[]
     */
     ...
     * Sets orders
     *
     * @param \Wildberries\Sdk\InStorePickup\Model\ApiUIN[] $orders orders
     *
     * @return self
     */
    public function setOrders($orders)
    {
        ...
        if ((count($orders) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $orders when calling ApiOrdersUINSetRequest., number of items must be less than or equal to 1000.');
        }
