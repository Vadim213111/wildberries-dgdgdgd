...
class AdvV1PromotionCountGet200Response(BaseModel):
    """
    AdvV1PromotionCountGet200Response
    """ # noqa: E501
    adverts: Optional[List[AdvV1PromotionCountGet200ResponseAdvertsInner]] = Field(default=None, description="Данные по кампаниям")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "adverts": [AdvV1PromotionCountGet200ResponseAdvertsInner.from_dict(_item) for _item in obj["adverts"]] if obj.get("adverts") is not None else None,
            "all": obj.get("all")
        })
        return _obj
