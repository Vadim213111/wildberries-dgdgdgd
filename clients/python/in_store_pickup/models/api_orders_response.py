...
class ApiOrdersResponse(BaseModel):
    ...
    errors: Optional[List[ApiOrdersErrorResponse]] = Field(default=None, description="Детали ошибки")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiOrdersResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiOrdersResponse from a dict"""
        if obj is None:
            return None
