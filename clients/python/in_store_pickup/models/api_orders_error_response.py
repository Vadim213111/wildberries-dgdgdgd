...
class ApiOrdersErrorResponse(BaseModel):
    """
    ApiOrdersErrorResponse
    """ # noqa: E501
    code: StrictInt = Field(description="Код ошибки", json_schema_extra={"examples": [404]})
    detail: StrictStr = Field(description="- `NotFound` — сборочное задание не найдено ", json_schema_extra={"examples": ["NotFound"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiOrdersErrorResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiOrdersErrorResponse from a dict"""
        if obj is None:
            return None
