...
class ApiOrdersMetaDleteRequestV2(BaseModel):
    """
    ApiOrdersMetaDleteRequestV2
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="Название метаданных для удаления (imei, uin, gtin, sgtin). Передаётся только одно значение", json_schema_extra={"examples": ["sgtin"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiOrdersMetaDleteRequestV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiOrdersMetaDleteRequestV2 from a dict"""
        if obj is None:
            return None
