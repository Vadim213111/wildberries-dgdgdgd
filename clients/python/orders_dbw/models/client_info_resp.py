...
class ClientInfoResp(BaseModel):
    """
    ClientInfoResp
    """ # noqa: E501
    orders: Optional[List[ClientInfo]] = Field(default=None, description="Информация о покупателях")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClientInfoResp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClientInfoResp from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "orders": [ClientInfo.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None
        })
        return _obj
