...
class ErrorObject403(BaseModel):
    ...
    ErrorObject403
    """ # noqa: E501
    title: StrictStr = Field(description="Заголовок ошибки", json_schema_extra={"examples": ["Authorization error"]})
    detail: StrictStr = Field(description="Детали ошибки", json_schema_extra={"examples": ["Authorization error"]})
