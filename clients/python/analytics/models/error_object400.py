...
class ErrorObject400(BaseModel):
    ...
    ErrorObject400
    """ # noqa: E501
    title: StrictStr = Field(description="Заголовок ошибки", json_schema_extra={"examples": ["Invalid request body"]})
    detail: StrictStr = Field(description="Детали ошибки", json_schema_extra={"examples": ["code=400, message=invalid: positionCluster (field required), limit (field required), offset (field required), internal=invalid: positionCluster (field required), limit (field required), offset (field required"]})
