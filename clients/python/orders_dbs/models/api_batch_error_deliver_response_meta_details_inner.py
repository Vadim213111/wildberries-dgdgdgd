...
class ApiBatchErrorDeliverResponseMetaDetailsInner(BaseModel):
    """
    ApiBatchErrorDeliverResponseMetaDetailsInner
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="Метаданные", json_schema_extra={"examples": ["sgtin"]})
    value: Optional[StrictStr] = Field(default=None, description="Значение метаданных", json_schema_extra={"examples": ["1234567890"]})
    decision: Optional[StrictStr] = Field(default=None, description="Статус проверки: - `sgtin`   - `sgtinInvalidFormat` — Неверный формат маркировки   - `sgtinNotFound` — Маркировка не найдена в [Честном знаке](https://chestnyznak.ru)   - `sgtinEmitted` —  Маркировка эмитирована   - `sgtinApplied` — Не пройдена процедура Ввод в оборот   - `sgtinWrittenOff` — Списан   - `sgtinRetired` — Выбыл   - `sgtinWithdrawn` — Выбыл   - `sgtinDisaggregation` — Расформирован   - `sgtinDisaggregated` — Расформирован   - `sgtinAppliedNotPaid` — Не оплачен   - `pending` — Маркировка на проверке ", json_schema_extra={"examples": ["sgtinEmitted"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiBatchErrorDeliverResponseMetaDetailsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiBatchErrorDeliverResponseMetaDetailsInner from a dict"""
        if obj is None:
            return None
