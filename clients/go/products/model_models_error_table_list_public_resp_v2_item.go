...
func (o *ModelsErrorTableListPublicRespV2Item) GetSubjects() map[string]ModelsErrorSubject {
	if o == nil {
		var ret map[string]ModelsErrorSubject
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ModelsErrorTableListPublicRespV2Item) GetSubjectsOk() (*map[string]ModelsErrorSubject, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ModelsErrorTableListPublicRespV2Item) SetSubjects(v map[string]ModelsErrorSubject) {
	o.Subjects = v
}
