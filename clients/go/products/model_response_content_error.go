...
// checks if the ResponseContentError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseContentError{}
...
// NewResponseContentError instantiates a new ResponseContentError object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewResponseContentError() *ResponseContentError {
	this := ResponseContentError{}
	return &this
}

// NewResponseContentErrorWithDefaults instantiates a new ResponseContentError object
...
type NullableResponseContentError struct {
	value *ResponseContentError
	isSet bool
}

func (v NullableResponseContentError) Get() *ResponseContentError {
	return v.value
}

func (v *NullableResponseContentError) Set(val *ResponseContentError) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseContentError) IsSet() bool {
	return v.isSet
}
...
func NewNullableResponseContentError(val *ResponseContentError) *NullableResponseContentError {
	return &NullableResponseContentError{value: val, isSet: true}
}
