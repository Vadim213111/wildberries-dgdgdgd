...
// checks if the ApiV3PassesPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiV3PassesPostRequest{}
...
type _ApiV3PassesPostRequest ApiV3PassesPostRequest

// NewApiV3PassesPostRequest instantiates a new ApiV3PassesPostRequest object
...
// NewApiV3PassesPostRequestWithDefaults instantiates a new ApiV3PassesPostRequest object
...
func (o *ApiV3PassesPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varApiV3PassesPostRequest := _ApiV3PassesPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiV3PassesPostRequest)

	if err != nil {
		return err
	}

	*o = ApiV3PassesPostRequest(varApiV3PassesPostRequest)

	return err
}

type NullableApiV3PassesPostRequest struct {
	value *ApiV3PassesPostRequest
	isSet bool
}

func (v NullableApiV3PassesPostRequest) Get() *ApiV3PassesPostRequest {
	return v.value
}

func (v *NullableApiV3PassesPostRequest) Set(val *ApiV3PassesPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableApiV3PassesPostRequest) IsSet() bool {
	return v.isSet
}
...
func NewNullableApiV3PassesPostRequest(val *ApiV3PassesPostRequest) *NullableApiV3PassesPostRequest {
	return &NullableApiV3PassesPostRequest{value: val, isSet: true}
}
