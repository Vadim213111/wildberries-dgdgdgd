...
// checks if the MetaCustomsDeclaration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetaCustomsDeclaration{}

// MetaCustomsDeclaration Номер грузовой таможенной декларации
type MetaCustomsDeclaration struct {
	Value NullableString `json:"value,omitempty"`
}

// NewMetaCustomsDeclaration instantiates a new MetaCustomsDeclaration object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewMetaCustomsDeclaration() *MetaCustomsDeclaration {
	this := MetaCustomsDeclaration{}
	return &this
}

// NewMetaCustomsDeclarationWithDefaults instantiates a new MetaCustomsDeclaration object
...
func NewNullableMetaCustomsDeclaration(val *MetaCustomsDeclaration) *NullableMetaCustomsDeclaration {
	return &NullableMetaCustomsDeclaration{value: val, isSet: true}
}
