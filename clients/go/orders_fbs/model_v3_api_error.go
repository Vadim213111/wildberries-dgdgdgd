...
// checks if the V3APIError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V3APIError{}
...
// NewV3APIError instantiates a new V3APIError object
...
// NewV3APIErrorWithDefaults instantiates a new V3APIError object
...
func NewNullableV3APIError(val *V3APIError) *NullableV3APIError {
	return &NullableV3APIError{value: val, isSet: true}
}
