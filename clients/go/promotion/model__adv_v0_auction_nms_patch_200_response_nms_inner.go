...
// checks if the AdvV0AuctionNmsPatch200ResponseNmsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvV0AuctionNmsPatch200ResponseNmsInner{}
...
type _AdvV0AuctionNmsPatch200ResponseNmsInner AdvV0AuctionNmsPatch200ResponseNmsInner

// NewAdvV0AuctionNmsPatch200ResponseNmsInner instantiates a new AdvV0AuctionNmsPatch200ResponseNmsInner object
...
func NewAdvV0AuctionNmsPatch200ResponseNmsInner(advertId int64, nms AdvV0AuctionNmsPatch200ResponseNmsInnerNms) *AdvV0AuctionNmsPatch200ResponseNmsInner {
	this := AdvV0AuctionNmsPatch200ResponseNmsInner{}
	this.AdvertId = advertId
	this.Nms = nms
	return &this
}

// NewAdvV0AuctionNmsPatch200ResponseNmsInnerWithDefaults instantiates a new AdvV0AuctionNmsPatch200ResponseNmsInner object
...
func (o *AdvV0AuctionNmsPatch200ResponseNmsInner) GetAdvertId() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
func (o *AdvV0AuctionNmsPatch200ResponseNmsInner) SetAdvertId(v int64) {
	o.AdvertId = v
}

// GetNms returns the Nms field value
func (o *AdvV0AuctionNmsPatch200ResponseNmsInner) GetNms() AdvV0AuctionNmsPatch200ResponseNmsInnerNms {
	if o == nil {
		var ret AdvV0AuctionNmsPatch200ResponseNmsInnerNms
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AdvV0AuctionNmsPatch200ResponseNmsInner) GetNmsOk() (*AdvV0AuctionNmsPatch200ResponseNmsInnerNms, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Nms, true
...
func (o *AdvV0AuctionNmsPatch200ResponseNmsInner) SetNms(v AdvV0AuctionNmsPatch200ResponseNmsInnerNms) {
	o.Nms = v
}
...
func (o *AdvV0AuctionNmsPatch200ResponseNmsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varAdvV0AuctionNmsPatch200ResponseNmsInner := _AdvV0AuctionNmsPatch200ResponseNmsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAdvV0AuctionNmsPatch200ResponseNmsInner)

	if err != nil {
		return err
	}

	*o = AdvV0AuctionNmsPatch200ResponseNmsInner(varAdvV0AuctionNmsPatch200ResponseNmsInner)

	return err
}

type NullableAdvV0AuctionNmsPatch200ResponseNmsInner struct {
	value *AdvV0AuctionNmsPatch200ResponseNmsInner
	isSet bool
}

func (v NullableAdvV0AuctionNmsPatch200ResponseNmsInner) Get() *AdvV0AuctionNmsPatch200ResponseNmsInner {
	return v.value
}

func (v *NullableAdvV0AuctionNmsPatch200ResponseNmsInner) Set(val *AdvV0AuctionNmsPatch200ResponseNmsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvV0AuctionNmsPatch200ResponseNmsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvV0AuctionNmsPatch200ResponseNmsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvV0AuctionNmsPatch200ResponseNmsInner(val *AdvV0AuctionNmsPatch200ResponseNmsInner) *NullableAdvV0AuctionNmsPatch200ResponseNmsInner {
	return &NullableAdvV0AuctionNmsPatch200ResponseNmsInner{value: val, isSet: true}
}

func (v NullableAdvV0AuctionNmsPatch200ResponseNmsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdvV0AuctionNmsPatch200ResponseNmsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
