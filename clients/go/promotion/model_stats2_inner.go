...
// checks if the Stats2Inner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Stats2Inner{}
...
// NewStats2Inner instantiates a new Stats2Inner object
...
// NewStats2InnerWithDefaults instantiates a new Stats2Inner object
...
func (v NullableStats2Inner) Get() *Stats2Inner {
	return v.value
}
...
func NewNullableStats2Inner(val *Stats2Inner) *NullableStats2Inner {
	return &NullableStats2Inner{value: val, isSet: true}
}
