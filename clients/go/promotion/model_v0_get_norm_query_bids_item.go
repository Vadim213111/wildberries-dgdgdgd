...
var _ MappedNullable = &V0GetNormQueryBidsItem{}
...
// NewV0GetNormQueryBidsItemWithDefaults instantiates a new V0GetNormQueryBidsItem object
...
type NullableV0GetNormQueryBidsItem struct {
	value *V0GetNormQueryBidsItem
	isSet bool
}

func (v NullableV0GetNormQueryBidsItem) Get() *V0GetNormQueryBidsItem {
	return v.value
}

func (v *NullableV0GetNormQueryBidsItem) Set(val *V0GetNormQueryBidsItem) {
	v.value = val
	v.isSet = true
}

func (v NullableV0GetNormQueryBidsItem) IsSet() bool {
	return v.isSet
}
...
func NewNullableV0GetNormQueryBidsItem(val *V0GetNormQueryBidsItem) *NullableV0GetNormQueryBidsItem {
	return &NullableV0GetNormQueryBidsItem{value: val, isSet: true}
}
