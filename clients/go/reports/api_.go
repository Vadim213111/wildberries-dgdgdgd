...
func (a *DefaultApiService) ApiV1AcceptanceReportGetExecute(r ApiApiV1AcceptanceReportGetRequest) (*CreateTaskResponse, *http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 401 {
			var v ApiV1SupplierIncomesGet401Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
Метод возвращает отчёт о [платной приёмке](https://seller.wildberries.ru/analytics-reports/acceptance-report) по ID [задания на генерацию](/openapi/reports#tag/Platnaya-priyomka/paths/~1api~1v1~1acceptance_report/get).
...
Метод возвращает статус [задания на генерацию](/openapi/reports#tag/Platnaya-priyomka/paths/~1api~1v1~1acceptance_report/get) отчёта о [платной приёмке](/openapi/reports#tag/Platnaya-priyomka/paths/~1api~1v1~1acceptance_report~1tasks~1%7Btask_id%7D~1download/get).
...
| Период | Лимит | Интервал | Всплеск |
| --- | --- | --- | --- |
| 10 минут | 1 запрос | 10 минут | 10 запросов |
</div>
...
type ApiApiV1AnalyticsWarehouseMeasurementsGetRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
	dateTo *time.Time
	tab *string
...
func (r ApiApiV1AnalyticsWarehouseMeasurementsGetRequest) DateTo(dateTo time.Time) ApiApiV1AnalyticsWarehouseMeasurementsGetRequest {
	r.dateTo = &dateTo
	return r
}

func (r ApiApiV1AnalyticsWarehouseMeasurementsGetRequest) Tab(tab string) ApiApiV1AnalyticsWarehouseMeasurementsGetRequest {
	r.tab = &tab
	return r
}

func (r ApiApiV1AnalyticsWarehouseMeasurementsGetRequest) Limit(limit int32) ApiApiV1AnalyticsWarehouseMeasurementsGetRequest {
	r.limit = &limit
	return r
}

// Начало отчётного периода. По умолчанию используется дата, когда были впервые получены данные для отчёта
func (r ApiApiV1AnalyticsWarehouseMeasurementsGetRequest) DateFrom(dateFrom time.Time) ApiApiV1AnalyticsWarehouseMeasurementsGetRequest {
	r.dateFrom = &dateFrom
	return r
}

func (r ApiApiV1AnalyticsWarehouseMeasurementsGetRequest) Offset(offset int32) ApiApiV1AnalyticsWarehouseMeasurementsGetRequest {
	r.offset = &offset
	return r
}

func (r ApiApiV1AnalyticsWarehouseMeasurementsGetRequest) Execute() (*ApiV1AnalyticsWarehouseMeasurementsGet200Response, *http.Response, error) {
	return r.ApiService.ApiV1AnalyticsWarehouseMeasurementsGetExecute(r)
}

/*
ApiV1AnalyticsWarehouseMeasurementsGet Занижение габаритов упаковки

Метод будет отключён 27 января. Используйте [актуальные методы](https://dev.wildberries.ru/release-notes?id=430)
...
| 1 минута | 5 запросов | 12 секунд | 1 запрос |
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiApiV1AnalyticsWarehouseMeasurementsGetRequest

Deprecated
*/
func (a *DefaultApiService) ApiV1AnalyticsWarehouseMeasurementsGet(ctx context.Context) ApiApiV1AnalyticsWarehouseMeasurementsGetRequest {
	return ApiApiV1AnalyticsWarehouseMeasurementsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Deprecated
func (a *DefaultApiService) ApiV1AnalyticsWarehouseMeasurementsGetExecute(r ApiApiV1AnalyticsWarehouseMeasurementsGetRequest) (*ApiV1AnalyticsWarehouseMeasurementsGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ApiV1AnalyticsWarehouseMeasurementsGet200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.ApiV1AnalyticsWarehouseMeasurementsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/analytics/warehouse-measurements"
	...
	if r.tab == nil {
		return localVarReturnValue, nil, reportError("tab is required and must be specified")
	}
	if r.limit == nil {
	...
	parameterAddToHeaderOrQuery(localVarQueryParams, "dateTo", r.dateTo, "form", "")
	parameterAddToHeaderOrQuery(localVarQueryParams, "tab", r.tab, "form", "")
...
type ApiApiV1SupplierIncomesGetRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
	dateFrom *time.Time
}
...
func (r ApiApiV1SupplierIncomesGetRequest) DateFrom(dateFrom time.Time) ApiApiV1SupplierIncomesGetRequest {
	r.dateFrom = &dateFrom
	return r
}

func (r ApiApiV1SupplierIncomesGetRequest) Execute() ([]IncomesItem, *http.Response, error) {
	return r.ApiService.ApiV1SupplierIncomesGetExecute(r)
}

/*
ApiV1SupplierIncomesGet Поставки

Данный метод устарел. Он будет удалён [11 марта](https://dev.wildberries.ru/release-notes?id=431)


 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiApiV1SupplierIncomesGetRequest

Deprecated
*/
func (a *DefaultApiService) ApiV1SupplierIncomesGet(ctx context.Context) ApiApiV1SupplierIncomesGetRequest {
	return ApiApiV1SupplierIncomesGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return []IncomesItem
// Deprecated
func (a *DefaultApiService) ApiV1SupplierIncomesGetExecute(r ApiApiV1SupplierIncomesGetRequest) ([]IncomesItem, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.ApiV1SupplierIncomesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/supplier/incomes"
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v ApiV1SupplierIncomesGet400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
Для точных финансовых расчётов, сверки и отчётности используйте [детализации к отчётам реализации](/openapi/financial-reports-and-accounting#tag/Finansovye-otchyoty/paths/~1api~1v5~1supplier~1reportDetailByPeriod/get).<br><br>
