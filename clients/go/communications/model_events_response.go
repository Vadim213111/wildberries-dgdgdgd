...
func (o *EventsResponse) GetResult() EventsResult {
	if o == nil || IsNil(o.Result) {
		var ret EventsResult
		return ret
	}
	return *o.Result
}
...
func (o *EventsResponse) GetResultOk() (*EventsResult, bool) {
	if o == nil || IsNil(o.Result) {
		return nil, false
	}
...
func (o *EventsResponse) HasResult() bool {
	if o != nil && !IsNil(o.Result) {
		return true
	}
...
// SetResult gets a reference to the given EventsResult and assigns it to the Result field.
func (o *EventsResponse) SetResult(v EventsResult) {
	o.Result = &v
}

// GetErrors returns the Errors field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *EventsResponse) GetErrors() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
func (o *EventsResponse) GetErrorsOk() ([]string, bool) {
...
func (o *EventsResponse) HasErrors() bool {
	if o != nil && !IsNil(o.Errors) {
		return true
	}
...
func (o *EventsResponse) SetErrors(v []string) {
	o.Errors = v
}
