 ...
 * 
 * @export
 * @interface ApiV1SupplierStocksGet402Response
 */
export interface ApiV1SupplierStocksGet402Response {
    /**
     * Заголовок ошибки
     * @type {string}
     * @memberof ApiV1SupplierStocksGet402Response
     */
    title?: string;
    /**
...
/**
 * Check if a given object implements the ApiV1SupplierStocksGet402Response interface.
 */
export function instanceOfApiV1SupplierStocksGet402Response(value: object): value is ApiV1SupplierStocksGet402Response {
    return true;
}

export function ApiV1SupplierStocksGet402ResponseFromJSON(json: any): ApiV1SupplierStocksGet402Response {
    return ApiV1SupplierStocksGet402ResponseFromJSONTyped(json, false);
}

export function ApiV1SupplierStocksGet402ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV1SupplierStocksGet402Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ApiV1SupplierStocksGet402ResponseToJSON(json: any): ApiV1SupplierStocksGet402Response {
    return ApiV1SupplierStocksGet402ResponseToJSONTyped(json, false);
}

export function ApiV1SupplierStocksGet402ResponseToJSONTyped(value?: ApiV1SupplierStocksGet402Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
