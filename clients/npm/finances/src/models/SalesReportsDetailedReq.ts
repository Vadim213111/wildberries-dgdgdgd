...
/**
 * Check if a given object implements the SalesReportsDetailedReq interface.
 */
export function instanceOfSalesReportsDetailedReq(value: object): value is SalesReportsDetailedReq {
    if (!('dateFrom' in value) || value['dateFrom'] === undefined) return false;
    if (!('dateTo' in value) || value['dateTo'] === undefined) return false;
    return true;
}

export function SalesReportsDetailedReqFromJSON(json: any): SalesReportsDetailedReq {
    return SalesReportsDetailedReqFromJSONTyped(json, false);
}

export function SalesReportsDetailedReqFromJSONTyped(json: any, ignoreDiscriminator: boolean): SalesReportsDetailedReq {
    if (json == null) {
        return json;
    }
    return {
...
export function SalesReportsDetailedReqToJSON(json: any): SalesReportsDetailedReq {
    return SalesReportsDetailedReqToJSONTyped(json, false);
}

export function SalesReportsDetailedReqToJSONTyped(value?: SalesReportsDetailedReq | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
