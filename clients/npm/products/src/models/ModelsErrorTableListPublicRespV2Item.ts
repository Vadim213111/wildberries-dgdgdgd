...
import type { ModelsErrorSubject } from './ModelsErrorSubject';
import {
    ModelsErrorSubjectFromJSON,
    ModelsErrorSubjectFromJSONTyped,
    ModelsErrorSubjectToJSON,
    ModelsErrorSubjectToJSONTyped,
} from './ModelsErrorSubject';
...
export interface ModelsErrorTableListPublicRespV2Item {
     ...
     * @type {{ [key: string]: ModelsErrorSubject; }}
     * @memberof ModelsErrorTableListPublicRespV2Item
     */
...
export function ModelsErrorTableListPublicRespV2ItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelsErrorTableListPublicRespV2Item {
    ...
    return {
        ...
        'subjects': (mapValues(json['subjects'], ModelsErrorSubjectFromJSON)),
...
export function ModelsErrorTableListPublicRespV2ItemToJSONTyped(value?: ModelsErrorTableListPublicRespV2Item | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'subjects': (mapValues(value['subjects'], ModelsErrorSubjectToJSON)),
