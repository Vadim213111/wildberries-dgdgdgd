...
import type { ContentV2DirectoryTnvedGet200ResponseDataInner } from './ContentV2DirectoryTnvedGet200ResponseDataInner';
import {
    ContentV2DirectoryTnvedGet200ResponseDataInnerFromJSON,
    ContentV2DirectoryTnvedGet200ResponseDataInnerFromJSONTyped,
    ContentV2DirectoryTnvedGet200ResponseDataInnerToJSON,
    ContentV2DirectoryTnvedGet200ResponseDataInnerToJSONTyped,
} from './ContentV2DirectoryTnvedGet200ResponseDataInner';

/**
 * 
 * @export
 * @interface ContentV2DirectoryTnvedGet200Response
 */
...
/**
 * Check if a given object implements the ContentV2DirectoryTnvedGet200Response interface.
 */
export function instanceOfContentV2DirectoryTnvedGet200Response(value: object): value is ContentV2DirectoryTnvedGet200Response {
    return true;
}

export function ContentV2DirectoryTnvedGet200ResponseFromJSON(json: any): ContentV2DirectoryTnvedGet200Response {
    return ContentV2DirectoryTnvedGet200ResponseFromJSONTyped(json, false);
}

export function ContentV2DirectoryTnvedGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContentV2DirectoryTnvedGet200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ContentV2DirectoryTnvedGet200ResponseToJSON(json: any): ContentV2DirectoryTnvedGet200Response {
    return ContentV2DirectoryTnvedGet200ResponseToJSONTyped(json, false);
}

export function ContentV2DirectoryTnvedGet200ResponseToJSONTyped(value?: ContentV2DirectoryTnvedGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(ContentV2DirectoryTnvedGet200ResponseDataInnerToJSON)),
        'error': value['error'],
