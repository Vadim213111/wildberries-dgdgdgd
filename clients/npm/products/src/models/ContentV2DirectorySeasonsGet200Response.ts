 ...
 * 
 * @export
 * @interface ContentV2DirectorySeasonsGet200Response
 */
...
/**
 * Check if a given object implements the ContentV2DirectorySeasonsGet200Response interface.
 */
export function instanceOfContentV2DirectorySeasonsGet200Response(value: object): value is ContentV2DirectorySeasonsGet200Response {
    return true;
}

export function ContentV2DirectorySeasonsGet200ResponseFromJSON(json: any): ContentV2DirectorySeasonsGet200Response {
    return ContentV2DirectorySeasonsGet200ResponseFromJSONTyped(json, false);
}

export function ContentV2DirectorySeasonsGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContentV2DirectorySeasonsGet200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ContentV2DirectorySeasonsGet200ResponseToJSON(json: any): ContentV2DirectorySeasonsGet200Response {
    return ContentV2DirectorySeasonsGet200ResponseToJSONTyped(json, false);
}

export function ContentV2DirectorySeasonsGet200ResponseToJSONTyped(value?: ContentV2DirectorySeasonsGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
