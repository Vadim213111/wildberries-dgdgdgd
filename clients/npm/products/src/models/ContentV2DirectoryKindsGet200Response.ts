 ...
 * 
 * @export
 * @interface ContentV2DirectoryKindsGet200Response
 */
...
/**
 * Check if a given object implements the ContentV2DirectoryKindsGet200Response interface.
 */
export function instanceOfContentV2DirectoryKindsGet200Response(value: object): value is ContentV2DirectoryKindsGet200Response {
    return true;
}

export function ContentV2DirectoryKindsGet200ResponseFromJSON(json: any): ContentV2DirectoryKindsGet200Response {
    return ContentV2DirectoryKindsGet200ResponseFromJSONTyped(json, false);
}

export function ContentV2DirectoryKindsGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContentV2DirectoryKindsGet200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ContentV2DirectoryKindsGet200ResponseToJSON(json: any): ContentV2DirectoryKindsGet200Response {
    return ContentV2DirectoryKindsGet200ResponseToJSONTyped(json, false);
}

export function ContentV2DirectoryKindsGet200ResponseToJSONTyped(value?: ContentV2DirectoryKindsGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
