 ...
 */
export function instanceOfApiV1SellerInfoGet402Response(value: object): value is ApiV1SellerInfoGet402Response {
    return true;
}

export function ApiV1SellerInfoGet402ResponseFromJSON(json: any): ApiV1SellerInfoGet402Response {
    return ApiV1SellerInfoGet402ResponseFromJSONTyped(json, false);
}

export function ApiV1SellerInfoGet402ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV1SellerInfoGet402Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ApiV1SellerInfoGet402ResponseToJSON(json: any): ApiV1SellerInfoGet402Response {
    return ApiV1SellerInfoGet402ResponseToJSONTyped(json, false);
}

export function ApiV1SellerInfoGet402ResponseToJSONTyped(value?: ApiV1SellerInfoGet402Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
