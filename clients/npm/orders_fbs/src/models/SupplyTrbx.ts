...
/**
 * Check if a given object implements the SupplyTrbx interface.
 */
export function instanceOfSupplyTrbx(value: object): value is SupplyTrbx {
    return true;
}

export function SupplyTrbxFromJSON(json: any): SupplyTrbx {
    return SupplyTrbxFromJSONTyped(json, false);
}

export function SupplyTrbxFromJSONTyped(json: any, ignoreDiscriminator: boolean): SupplyTrbx {
    if (json == null) {
        return json;
    }
    return {
...
export function SupplyTrbxToJSON(json: any): SupplyTrbx {
    return SupplyTrbxToJSONTyped(json, false);
}

export function SupplyTrbxToJSONTyped(value?: SupplyTrbx | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
