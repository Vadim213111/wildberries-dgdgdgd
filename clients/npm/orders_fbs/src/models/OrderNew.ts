...
export interface OrderNew {
    ...
    /**
     * Список метаданных, которые можно добавить в сборочное задание.<br>
     * Поставку со сборочным заданием без этих метаданных можно перевести в доставку, но они могут потребоваться, например, при возврате товара покупателем
     * 
     * @type {Array<string>}
     * @memberof OrderNew
     */
...
export function OrderNewFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderNew {
    ...
    return {
        ...
        'sellerDate': json['sellerDate'] == null ? undefined : json['sellerDate'],
        'salePrice': json['salePrice'] == null ? undefined : json['salePrice'],
        'requiredMeta': json['requiredMeta'] == null ? undefined : json['requiredMeta'],
        'optionalMeta': json['optionalMeta'] == null ? undefined : json['optionalMeta'],
