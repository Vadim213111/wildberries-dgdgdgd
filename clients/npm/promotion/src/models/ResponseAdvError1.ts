...
/**
 * Check if a given object implements the ResponseAdvError1 interface.
 */
export function instanceOfResponseAdvError1(value: object): value is ResponseAdvError1 {
    return true;
}

export function ResponseAdvError1FromJSON(json: any): ResponseAdvError1 {
    return ResponseAdvError1FromJSONTyped(json, false);
}

export function ResponseAdvError1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ResponseAdvError1 {
    if (json == null) {
        return json;
    }
    return {
...
export function ResponseAdvError1ToJSON(json: any): ResponseAdvError1 {
    return ResponseAdvError1ToJSONTyped(json, false);
}

export function ResponseAdvError1ToJSONTyped(value?: ResponseAdvError1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
