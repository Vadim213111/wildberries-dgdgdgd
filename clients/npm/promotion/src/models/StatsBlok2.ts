...
import type { DailyStats2Inner } from './DailyStats2Inner';
import {
    DailyStats2InnerFromJSON,
    DailyStats2InnerFromJSONTyped,
    DailyStats2InnerToJSON,
    DailyStats2InnerToJSONTyped,
} from './DailyStats2Inner';
...
/**
 * Check if a given object implements the StatsBlok2 interface.
 */
export function instanceOfStatsBlok2(value: object): value is StatsBlok2 {
    return true;
}

export function StatsBlok2FromJSON(json: any): StatsBlok2 {
    return StatsBlok2FromJSONTyped(json, false);
}

export function StatsBlok2FromJSONTyped(json: any, ignoreDiscriminator: boolean): StatsBlok2 {
    if (json == null) {
        return json;
    }
    return {
        ...
        'dailyStats': json['daily_stats'] == null ? undefined : ((json['daily_stats'] as Array<any>).map(DailyStats2InnerFromJSON)),
...
export function StatsBlok2ToJSON(json: any): StatsBlok2 {
    return StatsBlok2ToJSONTyped(json, false);
}

export function StatsBlok2ToJSONTyped(value?: StatsBlok2 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'cpc': value['cpc'],
        'status': value['status'],
        'daily_stats': value['dailyStats'] == null ? undefined : ((value['dailyStats'] as Array<any>).map(DailyStats2InnerToJSON)),
