...
/**
 * Check if a given object implements the RequestWithIntervalInterval interface.
 */
export function instanceOfRequestWithIntervalInterval(value: object): value is RequestWithIntervalInterval {
    return true;
}

export function RequestWithIntervalIntervalFromJSON(json: any): RequestWithIntervalInterval {
    return RequestWithIntervalIntervalFromJSONTyped(json, false);
}

export function RequestWithIntervalIntervalFromJSONTyped(json: any, ignoreDiscriminator: boolean): RequestWithIntervalInterval {
    if (json == null) {
        return json;
    }
    return {
...
export function RequestWithIntervalIntervalToJSON(json: any): RequestWithIntervalInterval {
    return RequestWithIntervalIntervalToJSONTyped(json, false);
}

export function RequestWithIntervalIntervalToJSONTyped(value?: RequestWithIntervalInterval | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
