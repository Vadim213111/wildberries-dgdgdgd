...
/**
 * Check if a given object implements the AdvertSubject interface.
 */
export function instanceOfAdvertSubject(value: object): value is AdvertSubject {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('name' in value) || value['name'] === undefined) return false;
    return true;
}

export function AdvertSubjectFromJSON(json: any): AdvertSubject {
    return AdvertSubjectFromJSONTyped(json, false);
}

export function AdvertSubjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): AdvertSubject {
    if (json == null) {
        return json;
    }
    return {
...
export function AdvertSubjectToJSON(json: any): AdvertSubject {
    return AdvertSubjectToJSONTyped(json, false);
}

export function AdvertSubjectToJSONTyped(value?: AdvertSubject | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
