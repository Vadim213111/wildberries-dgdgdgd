...
/**
 * Check if a given object implements the ResponseWithReturn interface.
 */
export function instanceOfResponseWithReturn(value: object): value is ResponseWithReturn {
    return true;
}

export function ResponseWithReturnFromJSON(json: any): ResponseWithReturn {
    return ResponseWithReturnFromJSONTyped(json, false);
}

export function ResponseWithReturnFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResponseWithReturn {
    if (json == null) {
        return json;
    }
    return {
...
export function ResponseWithReturnToJSON(json: any): ResponseWithReturn {
    return ResponseWithReturnToJSONTyped(json, false);
}

export function ResponseWithReturnToJSONTyped(value?: ResponseWithReturn | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
