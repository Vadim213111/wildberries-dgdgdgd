 ...
 * Метрики товара
 * @export
 * @interface TableProductItemStMetrics
 */
export interface TableProductItemStMetrics {
    /**
     * Заказы, шт.
     * @type {number}
 ...
 * @export
 */
export const TableProductItemStMetricsAvailabilityEnum = {
    Deficient: 'deficient',
    Actual: 'actual',
    Balanced: 'balanced',
    NonActual: 'nonActual',
...
export type TableProductItemStMetricsAvailabilityEnum = typeof TableProductItemStMetricsAvailabilityEnum[keyof typeof TableProductItemStMetricsAvailabilityEnum];


/**
 * Check if a given object implements the TableProductItemStMetrics interface.
 */
export function instanceOfTableProductItemStMetrics(value: object): value is TableProductItemStMetrics {
...
export function TableProductItemStMetricsFromJSON(json: any): TableProductItemStMetrics {
    return TableProductItemStMetricsFromJSONTyped(json, false);
}

export function TableProductItemStMetricsFromJSONTyped(json: any, ignoreDiscriminator: boolean): TableProductItemStMetrics {
    if (json == null) {
        return json;
    }
    return {
...
export function TableProductItemStMetricsToJSON(json: any): TableProductItemStMetrics {
    return TableProductItemStMetricsToJSONTyped(json, false);
}

export function TableProductItemStMetricsToJSONTyped(value?: TableProductItemStMetrics | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
