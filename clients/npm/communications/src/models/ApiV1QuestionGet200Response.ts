 ...
 * 
 * @export
 * @interface ApiV1QuestionGet200Response
 */
...
/**
 * Check if a given object implements the ApiV1QuestionGet200Response interface.
 */
export function instanceOfApiV1QuestionGet200Response(value: object): value is ApiV1QuestionGet200Response {
    return true;
}

export function ApiV1QuestionGet200ResponseFromJSON(json: any): ApiV1QuestionGet200Response {
    return ApiV1QuestionGet200ResponseFromJSONTyped(json, false);
}

export function ApiV1QuestionGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV1QuestionGet200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ApiV1QuestionGet200ResponseToJSON(json: any): ApiV1QuestionGet200Response {
    return ApiV1QuestionGet200ResponseToJSONTyped(json, false);
}

export function ApiV1QuestionGet200ResponseToJSONTyped(value?: ApiV1QuestionGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
