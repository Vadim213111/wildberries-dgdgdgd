 ...
 * 
 * @export
 * @interface ApiV1FeedbacksAnswerPostRequest
 */
export interface ApiV1FeedbacksAnswerPostRequest {
    /**
     * ID отзыва
     * @type {string}
     * @memberof ApiV1FeedbacksAnswerPostRequest
     */
    id: string;
    /**
     * Текст ответа
...
/**
 * Check if a given object implements the ApiV1FeedbacksAnswerPostRequest interface.
 */
export function instanceOfApiV1FeedbacksAnswerPostRequest(value: object): value is ApiV1FeedbacksAnswerPostRequest {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('text' in value) || value['text'] === undefined) return false;
    return true;
}

export function ApiV1FeedbacksAnswerPostRequestFromJSON(json: any): ApiV1FeedbacksAnswerPostRequest {
    return ApiV1FeedbacksAnswerPostRequestFromJSONTyped(json, false);
}

export function ApiV1FeedbacksAnswerPostRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV1FeedbacksAnswerPostRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ApiV1FeedbacksAnswerPostRequestToJSON(json: any): ApiV1FeedbacksAnswerPostRequest {
    return ApiV1FeedbacksAnswerPostRequestToJSONTyped(json, false);
}

export function ApiV1FeedbacksAnswerPostRequestToJSONTyped(value?: ApiV1FeedbacksAnswerPostRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
