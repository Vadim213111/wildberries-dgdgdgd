 ...
 * 
 * @export
 * @interface ApiV1QuestionsPatch200Response
 */
...
/**
 * Check if a given object implements the ApiV1QuestionsPatch200Response interface.
 */
export function instanceOfApiV1QuestionsPatch200Response(value: object): value is ApiV1QuestionsPatch200Response {
    return true;
}

export function ApiV1QuestionsPatch200ResponseFromJSON(json: any): ApiV1QuestionsPatch200Response {
    return ApiV1QuestionsPatch200ResponseFromJSONTyped(json, false);
}

export function ApiV1QuestionsPatch200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV1QuestionsPatch200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ApiV1QuestionsPatch200ResponseToJSON(json: any): ApiV1QuestionsPatch200Response {
    return ApiV1QuestionsPatch200ResponseToJSONTyped(json, false);
}

export function ApiV1QuestionsPatch200ResponseToJSONTyped(value?: ApiV1QuestionsPatch200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
