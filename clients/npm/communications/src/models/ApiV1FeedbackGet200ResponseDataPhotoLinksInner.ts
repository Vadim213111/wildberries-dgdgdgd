 ...
 * 
 * @export
 * @interface ApiV1FeedbackGet200ResponseDataPhotoLinksInner
 */
...
/**
 * Check if a given object implements the ApiV1FeedbackGet200ResponseDataPhotoLinksInner interface.
 */
export function instanceOfApiV1FeedbackGet200ResponseDataPhotoLinksInner(value: object): value is ApiV1FeedbackGet200ResponseDataPhotoLinksInner {
    return true;
}

export function ApiV1FeedbackGet200ResponseDataPhotoLinksInnerFromJSON(json: any): ApiV1FeedbackGet200ResponseDataPhotoLinksInner {
    return ApiV1FeedbackGet200ResponseDataPhotoLinksInnerFromJSONTyped(json, false);
}

export function ApiV1FeedbackGet200ResponseDataPhotoLinksInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV1FeedbackGet200ResponseDataPhotoLinksInner {
    if (json == null) {
        return json;
    }
    return {
...
export function ApiV1FeedbackGet200ResponseDataPhotoLinksInnerToJSON(json: any): ApiV1FeedbackGet200ResponseDataPhotoLinksInner {
    return ApiV1FeedbackGet200ResponseDataPhotoLinksInnerToJSONTyped(json, false);
}

export function ApiV1FeedbackGet200ResponseDataPhotoLinksInnerToJSONTyped(value?: ApiV1FeedbackGet200ResponseDataPhotoLinksInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
