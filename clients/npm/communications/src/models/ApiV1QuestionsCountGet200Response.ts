 ...
 * 
 * @export
 * @interface ApiV1QuestionsCountGet200Response
 */
export interface ApiV1QuestionsCountGet200Response {
    /**
     * Количество вопросов
     * @type {number}
     * @memberof ApiV1QuestionsCountGet200Response
     */
    data?: number;
    /**
     * Есть ли ошибка
...
/**
 * Check if a given object implements the ApiV1QuestionsCountGet200Response interface.
 */
export function instanceOfApiV1QuestionsCountGet200Response(value: object): value is ApiV1QuestionsCountGet200Response {
    return true;
}

export function ApiV1QuestionsCountGet200ResponseFromJSON(json: any): ApiV1QuestionsCountGet200Response {
    return ApiV1QuestionsCountGet200ResponseFromJSONTyped(json, false);
}

export function ApiV1QuestionsCountGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV1QuestionsCountGet200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ApiV1QuestionsCountGet200ResponseToJSON(json: any): ApiV1QuestionsCountGet200Response {
    return ApiV1QuestionsCountGet200ResponseToJSONTyped(json, false);
}

export function ApiV1QuestionsCountGet200ResponseToJSONTyped(value?: ApiV1QuestionsCountGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
