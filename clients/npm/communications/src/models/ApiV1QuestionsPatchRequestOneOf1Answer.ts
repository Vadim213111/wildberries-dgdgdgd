 ...
 * 
 * @export
 * @interface ApiV1QuestionsPatchRequestOneOf1Answer
 */
...
/**
 * Check if a given object implements the ApiV1QuestionsPatchRequestOneOf1Answer interface.
 */
export function instanceOfApiV1QuestionsPatchRequestOneOf1Answer(value: object): value is ApiV1QuestionsPatchRequestOneOf1Answer {
    if (!('text' in value) || value['text'] === undefined) return false;
    return true;
}

export function ApiV1QuestionsPatchRequestOneOf1AnswerFromJSON(json: any): ApiV1QuestionsPatchRequestOneOf1Answer {
    return ApiV1QuestionsPatchRequestOneOf1AnswerFromJSONTyped(json, false);
}

export function ApiV1QuestionsPatchRequestOneOf1AnswerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV1QuestionsPatchRequestOneOf1Answer {
    if (json == null) {
        return json;
    }
    return {
...
export function ApiV1QuestionsPatchRequestOneOf1AnswerToJSON(json: any): ApiV1QuestionsPatchRequestOneOf1Answer {
    return ApiV1QuestionsPatchRequestOneOf1AnswerToJSONTyped(json, false);
}

export function ApiV1QuestionsPatchRequestOneOf1AnswerToJSONTyped(value?: ApiV1QuestionsPatchRequestOneOf1Answer | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
