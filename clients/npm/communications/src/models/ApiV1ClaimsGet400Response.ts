 ...
 * 
 * @export
 * @interface ApiV1ClaimsGet400Response
 */
export interface ApiV1ClaimsGet400Response {
    /**
     * ID ошибки
     * @type {string}
     * @memberof ApiV1ClaimsGet400Response
     */
    title?: string;
    /**
     * Описание ошибки
...
/**
 * Check if a given object implements the ApiV1ClaimsGet400Response interface.
 */
export function instanceOfApiV1ClaimsGet400Response(value: object): value is ApiV1ClaimsGet400Response {
    return true;
}

export function ApiV1ClaimsGet400ResponseFromJSON(json: any): ApiV1ClaimsGet400Response {
    return ApiV1ClaimsGet400ResponseFromJSONTyped(json, false);
}

export function ApiV1ClaimsGet400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV1ClaimsGet400Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ApiV1ClaimsGet400ResponseToJSON(json: any): ApiV1ClaimsGet400Response {
    return ApiV1ClaimsGet400ResponseToJSONTyped(json, false);
}

export function ApiV1ClaimsGet400ResponseToJSONTyped(value?: ApiV1ClaimsGet400Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
