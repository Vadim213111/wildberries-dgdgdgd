 ...
 * 
 * @export
 * @interface ApiV1FeedbacksCountGet200Response
 */
...
/**
 * Check if a given object implements the ApiV1FeedbacksCountGet200Response interface.
 */
export function instanceOfApiV1FeedbacksCountGet200Response(value: object): value is ApiV1FeedbacksCountGet200Response {
    return true;
}

export function ApiV1FeedbacksCountGet200ResponseFromJSON(json: any): ApiV1FeedbacksCountGet200Response {
    return ApiV1FeedbacksCountGet200ResponseFromJSONTyped(json, false);
}

export function ApiV1FeedbacksCountGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV1FeedbacksCountGet200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ApiV1FeedbacksCountGet200ResponseToJSON(json: any): ApiV1FeedbacksCountGet200Response {
    return ApiV1FeedbacksCountGet200ResponseToJSONTyped(json, false);
}

export function ApiV1FeedbacksCountGet200ResponseToJSONTyped(value?: ApiV1FeedbacksCountGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
