...
pub struct ApiV1CalendarPromotionsGet200ResponseData {
    /// Список акций
    #[serde(rename = "promotions", skip_serializing_if = "Option::is_none")]
    pub promotions: Option<Vec<models::ApiV1CalendarPromotionsGet200ResponseDataPromotionsInner>>,
}

impl ApiV1CalendarPromotionsGet200ResponseData {
    /// Данные ответа
    pub fn new() -> ApiV1CalendarPromotionsGet200ResponseData {
