...
pub struct V0SetNormQueryBidsRequestItem {
    /// ID кампании
...
impl V0SetNormQueryBidsRequestItem {
    pub fn new(advert_id: i32, nm_id: i32, norm_query: String, bid: i32) -> V0SetNormQueryBidsRequestItem {
