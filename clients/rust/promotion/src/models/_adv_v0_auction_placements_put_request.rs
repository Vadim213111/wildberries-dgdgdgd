...
pub struct AdvV0AuctionPlacementsPutRequest {
    /// Места размещения в кампаниях
    #[serde(rename = "placements")]
    pub placements: Vec<models::AdvV0AuctionPlacementsPutRequestPlacementsInner>,
}

impl AdvV0AuctionPlacementsPutRequest {
    pub fn new(placements: Vec<models::AdvV0AuctionPlacementsPutRequestPlacementsInner>) -> AdvV0AuctionPlacementsPutRequest {
