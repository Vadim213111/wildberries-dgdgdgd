...
pub struct ApiAdvertV1BidsPatch200ResponseBidsInnerNmBidsInner {
    /// Артикул WB
    #[serde(rename = "nm_id")]
    pub nm_id: i64,
    /// Ставка
...
impl ApiAdvertV1BidsPatch200ResponseBidsInnerNmBidsInner {
    pub fn new(nm_id: i64, bid_kopecks: i64, placement: String) -> ApiAdvertV1BidsPatch200ResponseBidsInnerNmBidsInner {
