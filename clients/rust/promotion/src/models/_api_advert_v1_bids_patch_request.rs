...
pub struct ApiAdvertV1BidsPatchRequest {
    /// Ставки в кампаниях
    #[serde(rename = "bids")]
    pub bids: Vec<models::ApiAdvertV1BidsPatchRequestBidsInner>,
}

impl ApiAdvertV1BidsPatchRequest {
    pub fn new(bids: Vec<models::ApiAdvertV1BidsPatchRequestBidsInner>) -> ApiAdvertV1BidsPatchRequest {
