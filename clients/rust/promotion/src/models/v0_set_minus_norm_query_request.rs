...
pub struct V0SetMinusNormQueryRequest {
    /// ID кампании
    ...
    #[serde(rename = "nm_id")]
    pub nm_id: i32,
    #[serde(rename = "norm_queries")]
    pub norm_queries: Vec<String>,
}

impl V0SetMinusNormQueryRequest {
    pub fn new(advert_id: i32, nm_id: i32, norm_queries: Vec<String>) -> V0SetMinusNormQueryRequest {
