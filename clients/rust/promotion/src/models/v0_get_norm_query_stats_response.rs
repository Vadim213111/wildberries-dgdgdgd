...
pub struct V0GetNormQueryStatsResponse {
    #[serde(rename = "stats")]
    pub stats: Vec<models::V0GetNormQueryStatsItem>,
}

impl V0GetNormQueryStatsResponse {
    /// Статистика по поисковым кластерам
    pub fn new(stats: Vec<models::V0GetNormQueryStatsItem>) -> V0GetNormQueryStatsResponse {
