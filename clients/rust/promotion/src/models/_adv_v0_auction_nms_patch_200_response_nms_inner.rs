...
pub struct AdvV0AuctionNmsPatch200ResponseNmsInner {
    /// ID кампании
    #[serde(rename = "advert_id")]
    pub advert_id: i64,
    #[serde(rename = "nms")]
    pub nms: Box<models::AdvV0AuctionNmsPatch200ResponseNmsInnerNms>,
}

impl AdvV0AuctionNmsPatch200ResponseNmsInner {
    pub fn new(advert_id: i64, nms: models::AdvV0AuctionNmsPatch200ResponseNmsInnerNms) -> AdvV0AuctionNmsPatch200ResponseNmsInner {
