...
pub struct AdvV1AdvertGet200Response {
    /// ID медиакампании
    ...
    pub items: Option<Vec<models::AdvV1AdvertGet200ResponseItemsInner>>,
}

impl AdvV1AdvertGet200Response {
    pub fn new() -> AdvV1AdvertGet200Response {
