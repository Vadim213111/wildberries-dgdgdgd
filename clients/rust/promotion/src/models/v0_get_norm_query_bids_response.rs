...
pub struct V0GetNormQueryBidsResponse {
    #[serde(rename = "bids")]
    pub bids: Vec<models::V0GetNormQueryBidsItem>,
}

impl V0GetNormQueryBidsResponse {
    pub fn new(bids: Vec<models::V0GetNormQueryBidsItem>) -> V0GetNormQueryBidsResponse {
