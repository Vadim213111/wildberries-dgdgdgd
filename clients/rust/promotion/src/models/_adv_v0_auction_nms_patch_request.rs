...
pub struct AdvV0AuctionNmsPatchRequest {
    /// Карточки товаров в кампаниях
    #[serde(rename = "nms")]
    pub nms: Vec<models::AdvV0AuctionNmsPatchRequestNmsInner>,
}

impl AdvV0AuctionNmsPatchRequest {
    pub fn new(nms: Vec<models::AdvV0AuctionNmsPatchRequestNmsInner>) -> AdvV0AuctionNmsPatchRequest {
