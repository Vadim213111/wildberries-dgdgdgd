...
pub struct DailyStats1InnerAppTypeStatsInner {
    ...
    pub stats: Option<Vec<models::Stats1Inner>>,
}

impl DailyStats1InnerAppTypeStatsInner {
    pub fn new() -> DailyStats1InnerAppTypeStatsInner {
