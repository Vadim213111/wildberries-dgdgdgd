...
pub struct AdvV0AuctionNmsPatch200ResponseNmsInnerNms {
...
impl AdvV0AuctionNmsPatch200ResponseNmsInnerNms {
    /// Карточки товаров
    pub fn new(added: Vec<i32>, deleted: Vec<i32>) -> AdvV0AuctionNmsPatch200ResponseNmsInnerNms {
