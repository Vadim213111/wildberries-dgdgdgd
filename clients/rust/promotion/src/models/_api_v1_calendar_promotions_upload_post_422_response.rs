...
pub struct ApiV1CalendarPromotionsUploadPost422Response {
    /// Текст ошибки
    #[serde(rename = "errorText", skip_serializing_if = "Option::is_none")]
    pub error_text: Option<String>,
}

impl ApiV1CalendarPromotionsUploadPost422Response {
    pub fn new() -> ApiV1CalendarPromotionsUploadPost422Response {
