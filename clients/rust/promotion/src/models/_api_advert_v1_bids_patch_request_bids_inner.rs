...
pub struct ApiAdvertV1BidsPatchRequestBidsInner {
    /// ID кампании
...
impl ApiAdvertV1BidsPatchRequestBidsInner {
    pub fn new(advert_id: i64, nm_bids: Vec<models::ApiAdvertV1BidsPatchRequestBidsInnerNmBidsInner>) -> ApiAdvertV1BidsPatchRequestBidsInner {
