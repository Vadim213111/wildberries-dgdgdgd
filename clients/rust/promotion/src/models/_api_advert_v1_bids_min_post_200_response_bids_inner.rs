...
pub struct ApiAdvertV1BidsMinPost200ResponseBidsInner {
    /// Список ставок по местам размещения
    #[serde(rename = "bids")]
    pub bids: Vec<models::ApiAdvertV1BidsMinPost200ResponseBidsInnerBidsInner>,
    /// Артикул WB
    #[serde(rename = "nm_id")]
    pub nm_id: i64,
}

impl ApiAdvertV1BidsMinPost200ResponseBidsInner {
    pub fn new(bids: Vec<models::ApiAdvertV1BidsMinPost200ResponseBidsInnerBidsInner>, nm_id: i64) -> ApiAdvertV1BidsMinPost200ResponseBidsInner {
