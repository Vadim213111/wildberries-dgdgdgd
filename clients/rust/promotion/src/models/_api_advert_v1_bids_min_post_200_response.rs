...
pub struct ApiAdvertV1BidsMinPost200Response {
    /// Список карточек товаров со ставками
    #[serde(rename = "bids")]
    pub bids: Vec<models::ApiAdvertV1BidsMinPost200ResponseBidsInner>,
}

impl ApiAdvertV1BidsMinPost200Response {
    pub fn new(bids: Vec<models::ApiAdvertV1BidsMinPost200ResponseBidsInner>) -> ApiAdvertV1BidsMinPost200Response {
