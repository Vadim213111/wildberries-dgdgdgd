...
pub struct V0GetNormQueryStatsItem {
    /// ID кампании
    ...
    pub stats: Option<Vec<models::V0GetNormQueryStatsItemStat>>,
}

impl V0GetNormQueryStatsItem {
    pub fn new(advert_id: i32, nm_id: i32) -> V0GetNormQueryStatsItem {
