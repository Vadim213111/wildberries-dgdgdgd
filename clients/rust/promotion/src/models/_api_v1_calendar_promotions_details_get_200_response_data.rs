...
pub struct ApiV1CalendarPromotionsDetailsGet200ResponseData {
    /// Список акций
    #[serde(rename = "promotions", skip_serializing_if = "Option::is_none")]
    pub promotions: Option<Vec<models::ApiV1CalendarPromotionsDetailsGet200ResponseDataPromotionsInner>>,
}

impl ApiV1CalendarPromotionsDetailsGet200ResponseData {
    /// Данные ответа
    pub fn new() -> ApiV1CalendarPromotionsDetailsGet200ResponseData {
