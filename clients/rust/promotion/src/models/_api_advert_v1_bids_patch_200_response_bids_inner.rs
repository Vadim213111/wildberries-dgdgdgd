...
pub struct ApiAdvertV1BidsPatch200ResponseBidsInner {
    /// ID кампании
    #[serde(rename = "advert_id")]
    pub advert_id: i64,
    /// Ставки
    #[serde(rename = "nm_bids")]
    pub nm_bids: Vec<models::ApiAdvertV1BidsPatch200ResponseBidsInnerNmBidsInner>,
}

impl ApiAdvertV1BidsPatch200ResponseBidsInner {
    pub fn new(advert_id: i64, nm_bids: Vec<models::ApiAdvertV1BidsPatch200ResponseBidsInnerNmBidsInner>) -> ApiAdvertV1BidsPatch200ResponseBidsInner {
