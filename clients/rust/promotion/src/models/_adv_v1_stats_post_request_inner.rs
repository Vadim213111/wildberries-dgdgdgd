...
#[serde(untagged)]
pub enum AdvV1StatsPostRequestInner {
    RequestWithDate(Box<models::RequestWithDate>),
    RequestWithInterval(Box<models::RequestWithInterval>),
    RequestWithCampaignId(Box<models::RequestWithCampaignId>),
}

impl Default for AdvV1StatsPostRequestInner {
    fn default() -> Self {
        Self::RequestWithDate(Default::default())
    }
}
