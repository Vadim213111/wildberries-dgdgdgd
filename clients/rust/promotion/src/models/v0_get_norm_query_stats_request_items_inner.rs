...
pub struct V0GetNormQueryStatsRequestItemsInner {
    /// ID кампании
...
impl V0GetNormQueryStatsRequestItemsInner {
    pub fn new(advert_id: i32, nm_id: i32) -> V0GetNormQueryStatsRequestItemsInner {
