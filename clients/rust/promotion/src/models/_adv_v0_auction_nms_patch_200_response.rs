...
pub struct AdvV0AuctionNmsPatch200Response {
    /// Результат отработки запроса
    #[serde(rename = "nms")]
    pub nms: Vec<models::AdvV0AuctionNmsPatch200ResponseNmsInner>,
}

impl AdvV0AuctionNmsPatch200Response {
    pub fn new(nms: Vec<models::AdvV0AuctionNmsPatch200ResponseNmsInner>) -> AdvV0AuctionNmsPatch200Response {
