...
pub struct V0GetNormQueryMinusRequest {
    #[serde(rename = "items")]
    pub items: Vec<models::V0GetNormQueryMinusRequestItem>,
}

impl V0GetNormQueryMinusRequest {
    pub fn new(items: Vec<models::V0GetNormQueryMinusRequestItem>) -> V0GetNormQueryMinusRequest {
