...
pub struct ApiV1CalendarPromotionsUploadPostRequest {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ApiV1CalendarPromotionsUploadPostRequestData>>,
}

impl ApiV1CalendarPromotionsUploadPostRequest {
    pub fn new() -> ApiV1CalendarPromotionsUploadPostRequest {
