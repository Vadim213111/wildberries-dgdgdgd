...
pub struct V0GetNormQueryBidsRequest {
    #[serde(rename = "items")]
    pub items: Vec<models::V0GetNormQueryBidsRequestItem>,
}

impl V0GetNormQueryBidsRequest {
    pub fn new(items: Vec<models::V0GetNormQueryBidsRequestItem>) -> V0GetNormQueryBidsRequest {
