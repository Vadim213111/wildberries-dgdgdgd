...
pub struct DailyStats2InnerAppTypeStatsInner {
    ...
    pub stats: Option<Vec<models::Stats2Inner>>,
}

impl DailyStats2InnerAppTypeStatsInner {
    pub fn new() -> DailyStats2InnerAppTypeStatsInner {
