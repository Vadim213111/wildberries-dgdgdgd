...
pub struct AdvV0AuctionPlacementsPutRequestPlacementsInnerPlacements {
...
impl AdvV0AuctionPlacementsPutRequestPlacementsInnerPlacements {
    /// Места размещения
    pub fn new(search: bool, recommendations: bool) -> AdvV0AuctionPlacementsPutRequestPlacementsInnerPlacements {
