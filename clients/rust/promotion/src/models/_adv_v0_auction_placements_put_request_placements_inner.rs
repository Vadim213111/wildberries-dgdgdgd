...
pub struct AdvV0AuctionPlacementsPutRequestPlacementsInner {
    /// ID кампании
    #[serde(rename = "advert_id")]
    pub advert_id: i64,
    #[serde(rename = "placements")]
    pub placements: Box<models::AdvV0AuctionPlacementsPutRequestPlacementsInnerPlacements>,
}

impl AdvV0AuctionPlacementsPutRequestPlacementsInner {
    pub fn new(advert_id: i64, placements: models::AdvV0AuctionPlacementsPutRequestPlacementsInnerPlacements) -> AdvV0AuctionPlacementsPutRequestPlacementsInner {
