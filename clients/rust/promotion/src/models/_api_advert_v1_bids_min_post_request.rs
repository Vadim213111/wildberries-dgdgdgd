...
pub struct ApiAdvertV1BidsMinPostRequest {
    /// ID кампании
    ...
    #[serde(rename = "placement_types")]
    pub placement_types: Vec<PlacementTypes>,
}

impl ApiAdvertV1BidsMinPostRequest {
    pub fn new(advert_id: i64, nm_ids: Vec<i64>, payment_type: PaymentType, placement_types: Vec<PlacementTypes>) -> ApiAdvertV1BidsMinPostRequest {
