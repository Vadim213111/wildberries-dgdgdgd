...
pub struct StandardizedBatchError {
    /// Детали ошибки
    #[serde(rename = "detail")]
    pub detail: String,
...
impl StandardizedBatchError {
    pub fn new(detail: String, origin: String, request_id: String, status: i32, title: String) -> StandardizedBatchError {
