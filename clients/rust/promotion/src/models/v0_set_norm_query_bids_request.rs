...
pub struct V0SetNormQueryBidsRequest {
    #[serde(rename = "bids")]
    pub bids: Vec<models::V0SetNormQueryBidsRequestItem>,
}

impl V0SetNormQueryBidsRequest {
    pub fn new(bids: Vec<models::V0SetNormQueryBidsRequestItem>) -> V0SetNormQueryBidsRequest {
