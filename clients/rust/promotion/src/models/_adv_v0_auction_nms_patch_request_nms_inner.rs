...
pub struct AdvV0AuctionNmsPatchRequestNmsInner {
    /// ID кампании
    #[serde(rename = "advert_id")]
    pub advert_id: i64,
    #[serde(rename = "nms")]
    pub nms: Box<models::AdvV0AuctionNmsPatchRequestNmsInnerNms>,
}

impl AdvV0AuctionNmsPatchRequestNmsInner {
    pub fn new(advert_id: i64, nms: models::AdvV0AuctionNmsPatchRequestNmsInnerNms) -> AdvV0AuctionNmsPatchRequestNmsInner {
