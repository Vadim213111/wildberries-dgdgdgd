...
pub struct ApiCommunicationsV2NewsGet200ResponseDataInner {
    /// Текст новости
    ...
    pub types: Option<Vec<models::ApiCommunicationsV2NewsGet200ResponseDataInnerTypesInner>>,
}

impl ApiCommunicationsV2NewsGet200ResponseDataInner {
    pub fn new() -> ApiCommunicationsV2NewsGet200ResponseDataInner {
