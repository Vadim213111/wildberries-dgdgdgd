...
pub async fn content_v2_cards_move_nm_post(configuration: &configuration::Configuration, content_v2_cards_move_nm_post_request: Option<models::ContentV2CardsMoveNmPostRequest>) -> Result<models::ResponseCardCreate, Error<ContentV2CardsMoveNmPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ResponseCardCreate`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ResponseCardCreate`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn content_v2_cards_update_post(configuration: &configuration::Configuration, _content_v2_cards_update_post_request_inner: Option<Vec<models::ContentV2CardsUpdatePostRequestInner>>) -> Result<models::ResponseCardCreate, Error<ContentV2CardsUpdatePostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn content_v2_cards_upload_add_post(configuration: &configuration::Configuration, content_v2_cards_upload_add_post_request: Option<models::ContentV2CardsUploadAddPostRequest>) -> Result<models::ResponseCardCreate, Error<ContentV2CardsUploadAddPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn content_v2_cards_upload_post(configuration: &configuration::Configuration, _content_v2_cards_upload_post_request_inner: Option<Vec<models::ContentV2CardsUploadPostRequestInner>>) -> Result<models::ResponseCardCreate, Error<ContentV2CardsUploadPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
