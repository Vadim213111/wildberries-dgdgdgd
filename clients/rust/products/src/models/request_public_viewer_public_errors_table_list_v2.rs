...
pub struct RequestPublicViewerPublicErrorsTableListV2 {
    #[serde(rename = "cursor", skip_serializing_if = "Option::is_none")]
    pub cursor: Option<Box<models::SwaggerPublicErrorsCursorInput>>,
    #[serde(rename = "order", skip_serializing_if = "Option::is_none")]
    pub order: Option<Box<models::SwaggerPublicErrorsOrderV2>>,
}

impl RequestPublicViewerPublicErrorsTableListV2 {
    pub fn new() -> RequestPublicViewerPublicErrorsTableListV2 {
