...
pub struct ApiV3StocksWarehouseIdPost200ResponseStocksInner {
    /// ID размера товара
...
impl ApiV3StocksWarehouseIdPost200ResponseStocksInner {
    pub fn new() -> ApiV3StocksWarehouseIdPost200ResponseStocksInner {
