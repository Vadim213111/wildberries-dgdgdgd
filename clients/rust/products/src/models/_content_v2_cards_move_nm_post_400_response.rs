...
#[serde(untagged)]
pub enum ContentV2CardsMoveNmPost400Response {
    ResponseCardCreate(Box<models::ResponseCardCreate>),
    ResponseIncorrectDate(Box<models::ResponseIncorrectDate>),
}

impl Default for ContentV2CardsMoveNmPost400Response {
    fn default() -> Self {
        Self::ResponseCardCreate(Default::default())
    }
}
