...
pub struct ApiV2ListGoodsFilterGet200ResponseData {
    /// Информация о товарах
    #[serde(rename = "listGoods")]
    pub list_goods: Vec<models::GoodsList>,
}

impl ApiV2ListGoodsFilterGet200ResponseData {
    /// Данные ответа
    pub fn new(list_goods: Vec<models::GoodsList>) -> ApiV2ListGoodsFilterGet200ResponseData {
