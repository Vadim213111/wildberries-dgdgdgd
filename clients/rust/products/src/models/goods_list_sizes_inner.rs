...
pub struct GoodsListSizesInner {
...
impl GoodsListSizesInner {
    pub fn new(size_id: i64, price: i32, discounted_price: f64, club_discounted_price: f64, tech_size_name: String) -> GoodsListSizesInner {
        GoodsListSizesInner {
            size_id,
            price,
            discounted_price,
