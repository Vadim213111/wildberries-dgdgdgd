...
pub struct ContentV2CardsDeleteTrashPost200Response {
    ...
    pub additional_errors: Option<Option<serde_json::Value>>,
}

impl ContentV2CardsDeleteTrashPost200Response {
    pub fn new() -> ContentV2CardsDeleteTrashPost200Response {
