...
pub struct ApiV2UploadTaskClubDiscountPostRequest {
    /// Товары и скидки WB Клуба для них. Максимум 1 000 товаров. 
    #[serde(rename = "data")]
    pub data: Vec<models::ClubDiscReq>,
}

impl ApiV2UploadTaskClubDiscountPostRequest {
    pub fn new(data: Vec<models::ClubDiscReq>) -> ApiV2UploadTaskClubDiscountPostRequest {
