...
#[serde(untagged)]
pub enum ContentV2CardsMoveNmPostRequest {
    RequestMoveNmsImtConn(Box<models::RequestMoveNmsImtConn>),
    RequestMoveNmsImtDisconn(Box<models::RequestMoveNmsImtDisconn>),
}

impl Default for ContentV2CardsMoveNmPostRequest {
    fn default() -> Self {
        Self::RequestMoveNmsImtConn(Default::default())
    }
}
