...
pub struct ResponseCardCreate {
    ...
    #[serde(rename = "additionalErrors", skip_serializing_if = "Option::is_none")]
    pub additional_errors: Option<Box<models::ResponseCardCreateAdditionalErrors>>,
}

impl ResponseCardCreate {
    pub fn new() -> ResponseCardCreate {
        ResponseCardCreate {
            data: None,
            error: None,
            error_text: None,
