...
pub struct ContentV2GetCardsTrashPostRequest {
    #[serde(rename = "settings", skip_serializing_if = "Option::is_none")]
    pub settings: Option<Box<models::ContentV2GetCardsTrashPostRequestSettings>>,
}

impl ContentV2GetCardsTrashPostRequest {
    pub fn new() -> ContentV2GetCardsTrashPostRequest {
