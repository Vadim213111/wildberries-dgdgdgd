...
pub struct ContentV2GetCardsListPostRequest {
    #[serde(rename = "settings", skip_serializing_if = "Option::is_none")]
    pub settings: Option<Box<models::ContentV2GetCardsListPostRequestSettings>>,
}

impl ContentV2GetCardsListPostRequest {
    pub fn new() -> ContentV2GetCardsListPostRequest {
