...
pub struct ContentV2GetCardsListPostRequestSettingsCursor {
...
impl ContentV2GetCardsListPostRequestSettingsCursor {
    /// Курсор 
    pub fn new() -> ContentV2GetCardsListPostRequestSettingsCursor {
