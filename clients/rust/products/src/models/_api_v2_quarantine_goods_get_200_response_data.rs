...
pub struct ApiV2QuarantineGoodsGet200ResponseData {
    /// Информация о товарах в карантине
    #[serde(rename = "quarantineGoods", skip_serializing_if = "Option::is_none")]
    pub quarantine_goods: Option<Vec<models::QuarantineGoods>>,
}

impl ApiV2QuarantineGoodsGet200ResponseData {
    /// Данные ответа
    pub fn new() -> ApiV2QuarantineGoodsGet200ResponseData {
        ApiV2QuarantineGoodsGet200ResponseData {
            quarantine_goods: None,
        }
    }
}
