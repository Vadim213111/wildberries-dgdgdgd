...
pub struct ApiV2BufferGoodsTaskGet200ResponseData {
    /// ID загрузки
    ...
    #[serde(rename = "bufferGoods", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub buffer_goods: Option<Option<Vec<models::GoodBufferHistory>>>,
}

impl ApiV2BufferGoodsTaskGet200ResponseData {
    /// Данные ответа
    pub fn new() -> ApiV2BufferGoodsTaskGet200ResponseData {
