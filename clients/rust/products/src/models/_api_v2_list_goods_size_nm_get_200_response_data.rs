...
pub struct ApiV2ListGoodsSizeNmGet200ResponseData {
    /// Размеры товара
    #[serde(rename = "listGoods", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub list_goods: Option<Option<Vec<models::SizeGood>>>,
}

impl ApiV2ListGoodsSizeNmGet200ResponseData {
    /// Данные ответа
    pub fn new() -> ApiV2ListGoodsSizeNmGet200ResponseData {
