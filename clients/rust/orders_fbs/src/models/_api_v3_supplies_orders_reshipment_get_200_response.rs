...
pub struct ApiV3SuppliesOrdersReshipmentGet200Response {
    /// Список сборочных заданий
    #[serde(rename = "orders", skip_serializing_if = "Option::is_none")]
    pub orders: Option<Vec<models::ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner>>,
}

impl ApiV3SuppliesOrdersReshipmentGet200Response {
    pub fn new() -> ApiV3SuppliesOrdersReshipmentGet200Response {
