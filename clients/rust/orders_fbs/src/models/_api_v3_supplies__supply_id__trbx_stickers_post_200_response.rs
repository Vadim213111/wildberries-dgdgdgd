...
pub struct ApiV3SuppliesSupplyIdTrbxStickersPost200Response {
    #[serde(rename = "stickers", skip_serializing_if = "Option::is_none")]
    pub stickers: Option<Vec<models::TrbxStickers>>,
}

impl ApiV3SuppliesSupplyIdTrbxStickersPost200Response {
    pub fn new() -> ApiV3SuppliesSupplyIdTrbxStickersPost200Response {
