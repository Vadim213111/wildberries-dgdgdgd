...
pub struct Model409SupplyDeliverError {
    /// Код ошибки
    ...
    pub data: Option<Option<Box<models::Model409SupplyDeliverErrorData>>>,
}

impl Model409SupplyDeliverError {
    pub fn new() -> Model409SupplyDeliverError {
