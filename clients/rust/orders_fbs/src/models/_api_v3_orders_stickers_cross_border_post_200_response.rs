...
pub struct ApiV3OrdersStickersCrossBorderPost200Response {
    #[serde(rename = "stickers", skip_serializing_if = "Option::is_none")]
    pub stickers: Option<Vec<models::ApiV3OrdersStickersCrossBorderPost200ResponseStickersInner>>,
}

impl ApiV3OrdersStickersCrossBorderPost200Response {
    pub fn new() -> ApiV3OrdersStickersCrossBorderPost200Response {
