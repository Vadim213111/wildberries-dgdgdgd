...
pub struct ApiV3OrdersStickersPost200Response {
    #[serde(rename = "stickers", skip_serializing_if = "Option::is_none")]
    pub stickers: Option<Vec<models::ApiV3OrdersStickersPost200ResponseStickersInner>>,
}

impl ApiV3OrdersStickersPost200Response {
    pub fn new() -> ApiV3OrdersStickersPost200Response {
