...
pub struct ApiMarketplaceV3SuppliesSupplyIdOrdersPatchRequest {
    /// ID сборочных заданий
    #[serde(rename = "orders", skip_serializing_if = "Option::is_none")]
    pub orders: Option<Vec<i32>>,
}

impl ApiMarketplaceV3SuppliesSupplyIdOrdersPatchRequest {
    pub fn new() -> ApiMarketplaceV3SuppliesSupplyIdOrdersPatchRequest {
