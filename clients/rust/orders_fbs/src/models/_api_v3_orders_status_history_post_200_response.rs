...
pub struct ApiV3OrdersStatusHistoryPost200Response {
    /// Список сборочных заданий
    #[serde(rename = "orders", skip_serializing_if = "Option::is_none")]
    pub orders: Option<Vec<models::ApiV3OrdersStatusHistoryPost200ResponseOrdersInner>>,
}

impl ApiV3OrdersStatusHistoryPost200Response {
    pub fn new() -> ApiV3OrdersStatusHistoryPost200Response {
