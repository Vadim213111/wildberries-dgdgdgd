...
pub struct ApiV3OrdersStatusPost200Response {
    #[serde(rename = "orders", skip_serializing_if = "Option::is_none")]
    pub orders: Option<Vec<models::ApiV3OrdersStatusPost200ResponseOrdersInner>>,
}

impl ApiV3OrdersStatusPost200Response {
    pub fn new() -> ApiV3OrdersStatusPost200Response {
