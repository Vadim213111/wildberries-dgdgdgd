...
pub struct ApiV3SuppliesSupplyIdTrbxGet200Response {
    #[serde(rename = "trbxes", skip_serializing_if = "Option::is_none")]
    pub trbxes: Option<Vec<models::SupplyTrbx>>,
}

impl ApiV3SuppliesSupplyIdTrbxGet200Response {
    pub fn new() -> ApiV3SuppliesSupplyIdTrbxGet200Response {
