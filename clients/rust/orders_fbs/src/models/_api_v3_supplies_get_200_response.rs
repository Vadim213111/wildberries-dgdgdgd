...
pub struct ApiV3SuppliesGet200Response {
    ...
    pub next: Option<i64>,
    /// Список поставок
    #[serde(rename = "supplies", skip_serializing_if = "Option::is_none")]
    pub supplies: Option<Vec<models::Supply>>,
}

impl ApiV3SuppliesGet200Response {
    pub fn new() -> ApiV3SuppliesGet200Response {
