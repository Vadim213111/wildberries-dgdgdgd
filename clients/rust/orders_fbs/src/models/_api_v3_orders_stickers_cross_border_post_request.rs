...
pub struct ApiV3OrdersStickersCrossBorderPostRequest {
    /// Список ID сборочных заданий
    #[serde(rename = "orders", skip_serializing_if = "Option::is_none")]
    pub orders: Option<Vec<i64>>,
}

impl ApiV3OrdersStickersCrossBorderPostRequest {
    pub fn new() -> ApiV3OrdersStickersCrossBorderPostRequest {
