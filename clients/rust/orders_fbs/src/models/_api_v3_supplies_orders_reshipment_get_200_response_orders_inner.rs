...
pub struct ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner {
    /// ID поставки
    #[serde(rename = "supplyID", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub supply_id: Option<Option<serde_json::Value>>,
...
impl ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner {
    pub fn new() -> ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner {
