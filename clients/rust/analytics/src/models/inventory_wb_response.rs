...
pub struct InventoryWbResponse {
    /// Остатки товаров на складах WB по размерам
    #[serde(rename = "items")]
    pub items: Vec<models::InventoryWbResponseItemsInner>,
}

impl InventoryWbResponse {
    /// Текущие остатки товаров на складах WB
    pub fn new(items: Vec<models::InventoryWbResponseItemsInner>) -> InventoryWbResponse {
        InventoryWbResponse {
            items,
        }
    }
