...
pub struct PostV1StocksReportWbWarehouses200Response {
    #[serde(rename = "data")]
    pub data: Box<models::InventoryWbResponse>,
}

impl PostV1StocksReportWbWarehouses200Response {
    pub fn new(data: models::InventoryWbResponse) -> PostV1StocksReportWbWarehouses200Response {
