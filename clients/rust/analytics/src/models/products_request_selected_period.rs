...
pub struct ProductsRequestSelectedPeriod {
    /// Начало периода
    #[serde(rename = "start")]
...
impl ProductsRequestSelectedPeriod {
    pub fn new(start: chrono::NaiveDate, end: chrono::NaiveDate) -> ProductsRequestSelectedPeriod {
