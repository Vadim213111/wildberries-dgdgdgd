...
pub struct ApiMarketplaceV3DbsOrdersStatusReceivePost200Response {
    /// Уникальный ID запроса
    #[serde(rename = "requestId", skip_serializing_if = "Option::is_none")]
    pub request_id: Option<String>,
    #[serde(rename = "results", skip_serializing_if = "Option::is_none")]
    pub results: Option<Vec<models::ApiMarketplaceV3DbsOrdersStatusReceivePost200ResponseResultsInner>>,
}

impl ApiMarketplaceV3DbsOrdersStatusReceivePost200Response {
    pub fn new() -> ApiMarketplaceV3DbsOrdersStatusReceivePost200Response {
