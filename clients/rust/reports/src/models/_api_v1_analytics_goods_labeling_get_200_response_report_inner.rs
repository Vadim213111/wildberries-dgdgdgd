...
pub struct ApiV1AnalyticsGoodsLabelingGet200ResponseReportInner {
    /// Сумма штрафа, руб
...
impl ApiV1AnalyticsGoodsLabelingGet200ResponseReportInner {
    pub fn new() -> ApiV1AnalyticsGoodsLabelingGet200ResponseReportInner {
