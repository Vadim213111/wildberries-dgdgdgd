...
#[serde(untagged)]
pub enum ApiV1QuestionsPatchRequest {
    ApiV1QuestionsPatchRequestOneOf(Box<models::ApiV1QuestionsPatchRequestOneOf>),
    ApiV1QuestionsPatchRequestOneOf1(Box<models::ApiV1QuestionsPatchRequestOneOf1>),
}

impl Default for ApiV1QuestionsPatchRequest {
    fn default() -> Self {
        Self::ApiV1QuestionsPatchRequestOneOf(Default::default())
    }
}
