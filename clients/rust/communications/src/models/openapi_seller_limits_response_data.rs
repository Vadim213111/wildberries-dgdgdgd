...
pub struct OpenapiSellerLimitsResponseData {
    ...
    pub tariff: Option<Option<Box<models::OpenapiSellerLimit>>>,
}

impl OpenapiSellerLimitsResponseData {
    pub fn new() -> OpenapiSellerLimitsResponseData {
