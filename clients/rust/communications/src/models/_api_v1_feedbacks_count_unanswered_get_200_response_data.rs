...
pub struct ApiV1FeedbacksCountUnansweredGet200ResponseData {
    /// Количество необработанных отзывов
    #[serde(rename = "countUnanswered", skip_serializing_if = "Option::is_none")]
    pub count_unanswered: Option<i32>,
    /// Количество необработанных отзывов за сегодня
    #[serde(rename = "countUnansweredToday", skip_serializing_if = "Option::is_none")]
    pub count_unanswered_today: Option<i32>,
}

impl ApiV1FeedbacksCountUnansweredGet200ResponseData {
    pub fn new() -> ApiV1FeedbacksCountUnansweredGet200ResponseData {
        ApiV1FeedbacksCountUnansweredGet200ResponseData {
            count_unanswered: None,
            count_unanswered_today: None,
        }
    }
}
