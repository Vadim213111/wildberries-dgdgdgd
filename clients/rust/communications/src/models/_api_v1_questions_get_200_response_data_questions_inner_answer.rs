...
pub struct ApiV1QuestionsGet200ResponseDataQuestionsInnerAnswer {
    /// Текст ответа
    ...
    pub create_date: Option<chrono::DateTime<chrono::FixedOffset>>,
}

impl ApiV1QuestionsGet200ResponseDataQuestionsInnerAnswer {
    /// Структура ответа
    pub fn new() -> ApiV1QuestionsGet200ResponseDataQuestionsInnerAnswer {
