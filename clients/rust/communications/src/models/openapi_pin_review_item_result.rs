...
pub struct OpenapiPinReviewItemResult {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::OpenapiPinReviewItemResultDataInner>>,
}

impl OpenapiPinReviewItemResult {
    pub fn new() -> OpenapiPinReviewItemResult {
