...
pub struct ApiV1FeedbacksOrderReturnPostRequest {
    /// ID отзыва
    #[serde(rename = "feedbackId", skip_serializing_if = "Option::is_none")]
    pub feedback_id: Option<String>,
}

impl ApiV1FeedbacksOrderReturnPostRequest {
    pub fn new() -> ApiV1FeedbacksOrderReturnPostRequest {
