...
pub struct ApiV1SellerDownloadIdGet202Response {
    /// Статус модерации
...
impl ApiV1SellerDownloadIdGet202Response {
    pub fn new(moderation_state: String, retry_seconds: i32) -> ApiV1SellerDownloadIdGet202Response {
