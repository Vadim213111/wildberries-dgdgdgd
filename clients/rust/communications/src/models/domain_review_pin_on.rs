...
impl std::fmt::Display for DomainReviewPinOn {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::PinOnIMT => write!(f, "imt"),
            Self::PinOnNM => write!(f, "nm"),
        }
    }
}

impl Default for DomainReviewPinOn {
    fn default() -> DomainReviewPinOn {
        Self::PinOnIMT
    }
}
