...
pub struct ApiFeedbacksV1PinsGet200Response {
    #[serde(rename = "data")]
    pub data: Vec<models::OpenapiPinnedReviewItemResult>,
...
impl ApiFeedbacksV1PinsGet200Response {
    pub fn new(data: Vec<models::OpenapiPinnedReviewItemResult>) -> ApiFeedbacksV1PinsGet200Response {
