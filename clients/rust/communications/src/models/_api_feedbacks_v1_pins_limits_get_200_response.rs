...
pub struct ApiFeedbacksV1PinsLimitsGet200Response {
    #[serde(rename = "data")]
    pub data: Box<models::OpenapiSellerLimitsResponseData>,
}

impl ApiFeedbacksV1PinsLimitsGet200Response {
    pub fn new(data: models::OpenapiSellerLimitsResponseData) -> ApiFeedbacksV1PinsLimitsGet200Response {
