...
impl std::fmt::Display for DomainReviewState {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::StatePinned => write!(f, "pinned"),
            Self::StateUnpinned => write!(f, "unpinned"),
        }
    }
}

impl Default for DomainReviewState {
    fn default() -> DomainReviewState {
        Self::StatePinned
    }
}
