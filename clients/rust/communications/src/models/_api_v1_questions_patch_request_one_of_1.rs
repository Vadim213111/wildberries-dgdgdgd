...
pub struct ApiV1QuestionsPatchRequestOneOf1 {
    /// Id вопроса
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "answer")]
    pub answer: Box<models::ApiV1QuestionsPatchRequestOneOf1Answer>,
...
impl ApiV1QuestionsPatchRequestOneOf1 {
    pub fn new(id: String, answer: models::ApiV1QuestionsPatchRequestOneOf1Answer, state: String) -> ApiV1QuestionsPatchRequestOneOf1 {
