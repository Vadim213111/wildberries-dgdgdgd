...
pub struct ApiV1QuestionsPatchRequestOneOf1Answer {
    /// Текст ответа
    #[serde(rename = "text")]
    pub text: String,
}

impl ApiV1QuestionsPatchRequestOneOf1Answer {
    pub fn new(text: String) -> ApiV1QuestionsPatchRequestOneOf1Answer {
