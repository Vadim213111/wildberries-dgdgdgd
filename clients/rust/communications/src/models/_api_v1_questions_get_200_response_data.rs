...
pub struct ApiV1QuestionsGet200ResponseData {
    ...
    #[serde(rename = "countArchive", skip_serializing_if = "Option::is_none")]
    pub count_archive: Option<i32>,
    /// Вопросы
    #[serde(rename = "questions", skip_serializing_if = "Option::is_none")]
    pub questions: Option<Vec<models::ApiV1QuestionsGet200ResponseDataQuestionsInner>>,
}

impl ApiV1QuestionsGet200ResponseData {
    pub fn new() -> ApiV1QuestionsGet200ResponseData {
