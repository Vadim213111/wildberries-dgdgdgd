...
pub struct ApiV1QuestionGet200ResponseData {
    /// ID вопроса
    ...
    pub answer: Option<Option<Box<models::ApiV1QuestionGet200ResponseDataAnswer>>>,
    #[serde(rename = "productDetails", skip_serializing_if = "Option::is_none")]
    pub product_details: Option<Box<models::ApiV1QuestionGet200ResponseDataProductDetails>>,
...
impl ApiV1QuestionGet200ResponseData {
    pub fn new() -> ApiV1QuestionGet200ResponseData {
