...
pub enum DomainReviewPinMethod {
...
impl std::fmt::Display for DomainReviewPinMethod {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::PinMethodSubscription => write!(f, "subscription"),
            Self::PinMethodTariff => write!(f, "tariff"),
        }
    }
}

impl Default for DomainReviewPinMethod {
    fn default() -> DomainReviewPinMethod {
        Self::PinMethodSubscription
    }
}
