...
pub struct OpenapiSellerLimitsResponse {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::OpenapiSellerLimitsResponseData>>,
}

impl OpenapiSellerLimitsResponse {
    pub fn new() -> OpenapiSellerLimitsResponse {
