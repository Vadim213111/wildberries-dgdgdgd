...
pub struct ApiFeedbacksV1PinsPost200Response {
    #[serde(rename = "data")]
    pub data: Vec<models::OpenapiPinReviewItemResultDataInner>,
}

impl ApiFeedbacksV1PinsPost200Response {
    pub fn new(data: Vec<models::OpenapiPinReviewItemResultDataInner>) -> ApiFeedbacksV1PinsPost200Response {
