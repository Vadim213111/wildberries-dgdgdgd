...
pub async fn api_feedbacks_v1_pins_count_get(configuration: &configuration::Configuration, state: Option<&str>, pin_on: Option<&str>, imt_id: Option<i32>, nm_id: Option<i32>, feedback_id: Option<i32>, date_from: Option<String>, date_to: Option<String>) -> Result<models::ApiFeedbacksV1PinsCountGet200Response, Error<ApiFeedbacksV1PinsCountGetError>> {
...
pub async fn api_feedbacks_v1_pins_get(configuration: &configuration::Configuration, state: Option<&str>, pin_on: Option<&str>, imt_id: Option<i32>, nm_id: Option<i32>, feedback_id: Option<i32>, date_from: Option<String>, date_to: Option<String>, next: Option<i32>, limit: Option<i32>) -> Result<models::ApiFeedbacksV1PinsGet200Response, Error<ApiFeedbacksV1PinsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_state = state;
    let p_query_pin_on = pin_on;
    let p_query_imt_id = imt_id;
