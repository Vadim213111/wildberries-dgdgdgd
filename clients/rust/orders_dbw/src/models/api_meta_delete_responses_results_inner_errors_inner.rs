...
pub struct ApiMetaDeleteResponsesResultsInnerErrorsInner {
    /// Код ошибки:   - `404`   - `409` 
    #[serde(rename = "code")]
    pub code: i32,
...
impl ApiMetaDeleteResponsesResultsInnerErrorsInner {
    pub fn new(code: i32, detail: String) -> ApiMetaDeleteResponsesResultsInnerErrorsInner {
