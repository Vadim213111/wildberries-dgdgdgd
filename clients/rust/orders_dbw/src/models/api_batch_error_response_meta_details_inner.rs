...
pub struct ApiBatchErrorResponseMetaDetailsInner {
    /// Метаданные
    #[serde(rename = "key")]
    pub key: String,
    /// Значение метаданных
...
impl ApiBatchErrorResponseMetaDetailsInner {
    pub fn new(key: String, decision: String) -> ApiBatchErrorResponseMetaDetailsInner {
