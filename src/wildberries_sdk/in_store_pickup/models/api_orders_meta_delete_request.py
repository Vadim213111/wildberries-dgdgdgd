...
class ApiOrdersMetaDeleteRequest(BaseModel):
    ...
    """ # noqa: E501
    key: StrictStr = Field(description="Тип метаданных для удаления (`imei`, `uin`, `gtin`, `sgtin`). Передаётся только одно значение", json_schema_extra={"examples": ["imei"]})
    orders_ids: Annotated[List[StrictInt], Field(max_length=1000)] = Field(description="Список ID сборочных заданий", alias="ordersIds", json_schema_extra={"examples": [[123456, 234567]]})
