...
class ApiMetaDeleteResponsesResultsInnerErrorsInner(BaseModel):
    """
    ApiMetaDeleteResponsesResultsInnerErrorsInner
    """ # noqa: E501
    code: StrictInt = Field(description="Код ошибки:   - `404`   - `409` ")
    detail: StrictStr = Field(description="- `NotFound` — сборочное задание не найдено - `StatusMismatch` — операция невозможна для этого статуса сборочного задания - `ImeiIsNotFilled` — не заполнен IMEI ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiMetaDeleteResponsesResultsInnerErrorsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiMetaDeleteResponsesResultsInnerErrorsInner from a dict"""
        if obj is None:
            return None
