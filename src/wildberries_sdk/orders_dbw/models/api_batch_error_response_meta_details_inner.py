...
class ApiBatchErrorResponseMetaDetailsInner(BaseModel):
    ...
    """ # noqa: E501
    key: StrictStr = Field(description="Метаданные", json_schema_extra={"examples": ["sgtin"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiBatchErrorResponseMetaDetailsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiBatchErrorResponseMetaDetailsInner from a dict"""
        if obj is None:
            return None
