...
class SalesReportsDetailedReq(BaseModel):
    """
    Параметры запроса
    """ # noqa: E501
    ...
    period: Optional[StrictStr] = Field(default='weekly', description="Периодичность отчётов:   - `weekly` — еженедельные   - `daily` — ежедневные ", json_schema_extra={"examples": ["daily"]})
    ...
    __properties: ClassVar[List[str]] = ["dateFrom", "dateTo", "limit", "rrdId", "period", "fields"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SalesReportsDetailedReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SalesReportsDetailedReq from a dict"""
        if obj is None:
            return None
