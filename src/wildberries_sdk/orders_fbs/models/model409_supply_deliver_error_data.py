...
class Model409SupplyDeliverErrorData(BaseModel):
    """
    Дополнительные данные ошибки
    """ # noqa: E501
    orders: Optional[List[Model409SupplyDeliverErrorDataOrdersInner]] = Field(default=None, description="Сборочные задания, метаданные которых не прошли или ещё не завершили валидацию")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Model409SupplyDeliverErrorData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Model409SupplyDeliverErrorData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "orders": [Model409SupplyDeliverErrorDataOrdersInner.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None
        })
        return _obj
