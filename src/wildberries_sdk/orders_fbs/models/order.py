...
class Order(BaseModel):
    ...
    scan_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Цена приёмки в копейках. Отображается после фактической приёмки заказа", alias="scanPrice", json_schema_extra={"examples": [1500]})
    ...
    supply_id: Optional[StrictStr] = Field(default=None, description="ID поставки. Возвращается, если заказ закреплён за поставкой", alias="supplyId", json_schema_extra={"examples": ["WB-GI-92937123"]})
    ...
    created_at: Optional[datetime] = Field(default=None, description="Дата создания сборочного задания (RFC3339). Часовой пояс — UTC", alias="createdAt", json_schema_extra={"examples": ["2022-05-04T07:56:29Z"]})
