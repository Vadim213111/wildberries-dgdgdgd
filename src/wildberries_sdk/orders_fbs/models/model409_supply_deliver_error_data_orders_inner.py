...
class Model409SupplyDeliverErrorDataOrdersInner(BaseModel):
    """
    Model409SupplyDeliverErrorDataOrdersInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID сборочного задания")
    meta_details: Optional[List[Model409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner]] = Field(default=None, description="Информация об ошибках", alias="metaDetails")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Model409SupplyDeliverErrorDataOrdersInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Model409SupplyDeliverErrorDataOrdersInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "metaDetails": [Model409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner.from_dict(_item) for _item in obj["metaDetails"]] if obj.get("metaDetails") is not None else None
        })
        return _obj
