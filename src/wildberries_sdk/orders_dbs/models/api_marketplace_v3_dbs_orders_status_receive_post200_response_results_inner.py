...
class ApiMarketplaceV3DbsOrdersStatusReceivePost200ResponseResultsInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiMarketplaceV3DbsOrdersStatusReceivePost200ResponseResultsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiMarketplaceV3DbsOrdersStatusReceivePost200ResponseResultsInner from a dict"""
        if obj is None:
            return None
