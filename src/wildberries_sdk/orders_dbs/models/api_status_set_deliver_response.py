...
class ApiStatusSetDeliverResponse(BaseModel):
    """
    ApiStatusSetDeliverResponse
    """ # noqa: E501
    errors: Optional[List[ApiBatchErrorDeliverResponse]] = Field(default=None, description="Детали ошибки")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiStatusSetDeliverResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiStatusSetDeliverResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "errors": [ApiBatchErrorDeliverResponse.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
