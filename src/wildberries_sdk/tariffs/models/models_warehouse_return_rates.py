...
class ModelsWarehouseReturnRates(BaseModel):
    ...
    """ # noqa: E501
    delivery_dump_kgt_office_base: Optional[StrictStr] = Field(default=None, description="**Стоимость возврата при грузовой доставке, доставка на ПВЗ (базовая цена за 1 л), ₽** Применяется для крупногабаритных товаров, когда:   - продавец хочет вывезти товары со склада WB;   - на складе обнаружили бракованные товары;   - покупатель возвращает товар, но его нельзя вернуть в продажу. ", alias="deliveryDumpKgtOfficeBase", json_schema_extra={"examples": ["1 039"]})
    delivery_dump_kgt_office_liter: Optional[StrictStr] = Field(default=None, description="**Стоимость возврата при грузовой доставке, доставка на ПВЗ (доп. литр), ₽**<br> Стоимость за каждый дополнительный литр. ", alias="deliveryDumpKgtOfficeLiter", json_schema_extra={"examples": ["9,1"]})
    delivery_dump_kgt_return_expr: Optional[StrictStr] = Field(default=None, description="**Стоимость возврата при грузовой доставке, обратная логистика невостребованного возврата, ₽**<br> Грузовая доставка невостребованного возврата обратно на склад WB. За единицу товара. ", alias="deliveryDumpKgtReturnExpr", json_schema_extra={"examples": ["1 050"]})
    delivery_dump_srg_office_expr: Optional[StrictStr] = Field(default=None, description="**Стоимость возврата неопознанного складом товара за каждую единицу, доставка на ПВЗ, ₽**<br> Применяется для товаров, которые не смогли принять на складе. ", alias="deliveryDumpSrgOfficeExpr", json_schema_extra={"examples": ["170"]})
    delivery_dump_srg_return_expr: Optional[StrictStr] = Field(default=None, description="**Стоимость возврата неопознанного складом товара за каждую единицу, обратная логистика невостребованного возврата, ₽** <br>Доставка невостребованного возврата обратно на склад WB. ", alias="deliveryDumpSrgReturnExpr", json_schema_extra={"examples": ["170"]})
    delivery_dump_sup_courier_base: Optional[StrictStr] = Field(default=None, description="**Стоимость возврата, доставка курьером (базовая цена за 1 л), ₽**  Применяется, когда:   - продавец хочет вывезти товары со склада Wildberries   - на складе обнаружили бракованные товары   - покупатель возвращает товар, но его нельзя вернуть в продажу   - подключён автовозврат товаров, продаваемых по схеме Маркетплейс ", alias="deliveryDumpSupCourierBase", json_schema_extra={"examples": ["229"]})
    delivery_dump_sup_courier_liter: Optional[StrictStr] = Field(default=None, description="**Стоимость возврата, доставка курьером (доп. л), ₽** <br>Стоимость за каждый дополнительный литр. ", alias="deliveryDumpSupCourierLiter", json_schema_extra={"examples": ["9,1"]})
    delivery_dump_sup_office_base: Optional[StrictStr] = Field(default=None, description="**Стоимость возврата, доставка на ПВЗ (базовая цена за 1 л), ₽**  Применяется, когда:   - продавец хочет вывезти товары со склада Wildberries   - на складе обнаружили бракованные товары   - покупатель возвращает товар, но его нельзя вернуть в продажу   - подключён автовозврат товаров, продаваемых по схеме Маркетплейс ", alias="deliveryDumpSupOfficeBase", json_schema_extra={"examples": ["129"]})
    delivery_dump_sup_office_liter: Optional[StrictStr] = Field(default=None, description="**Стоимость возврата, доставка на ПВЗ (доп. литр), ₽** <br>Стоимость за каждый дополнительный литр ", alias="deliveryDumpSupOfficeLiter", json_schema_extra={"examples": ["9,1"]})
    delivery_dump_sup_return_expr: Optional[StrictStr] = Field(default=None, description="**Стоимость возврата, обратная логистика невостребованного возврата, за единицу товара, ₽**<br> Доставка невостребованного возврата обратно на склад Wildberries.  Применяется, когда:   - продавец хочет вывезти товары со склада Wildberries   - на складе обнаружили бракованные товары   - покупатель возвращает товар, но его нельзя вернуть в продажу   - подключён автовозврат товаров, продаваемых по схеме Маркетплейс ", alias="deliveryDumpSupReturnExpr", json_schema_extra={"examples": ["250"]})
    warehouse_name: Optional[StrictStr] = Field(default=None, description="Название склада", alias="warehouseName", json_schema_extra={"examples": ["Электросталь"]})
